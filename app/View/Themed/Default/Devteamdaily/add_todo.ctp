	...
	<div class="widget">
		...
		<div class="wizard">
			<div class="widget-head bg-primary">
				<div class="pull-left"> <span class="heading strong-text-white "><i class="fa fa-tasks "  style="font-size:20px;"></i>&nbsp;Add New To-do</span> </div>
<!--				<div class="pull-right"> <span class="strong innerLR"> <?php //echo $datetime; ?>&nbsp;
			...
			<div class="widget-body">
				<div class="innerLR">
					...
					<?php echo $this->Form->create('DevteamDaily',array('url' => array('controller' => 'devteamdaily','action' => 'add_todo',$pinfo['Project']['id']),'class'=>'form-horizontal apply-nolazy','role'=>"form",'type'=>'file' )); ?>
...
<!--                                    <i class="fa fa-fw fa-square-o"></i>-->
					...
					<div class="form-group">
					<?php echo $this->Form->label('sevarity', 'Severity of To-do:',array('class'=>"col-sm-2 control-label")); ?>
					...
					<div class="form-group"> <?php echo $this->Form->label('title', 'To-do Name:',array('class'=>"col-sm-2 control-label")); ?>
					...
					<div class="form-group"> <?php echo $this->Form->label('description', 'To-do Description:',array('class'=>"col-sm-2 control-label")); ?>
...
$script.ready('bundle', function() {
	...
	$("#DevteamDailyAddForm").submit(function(){
