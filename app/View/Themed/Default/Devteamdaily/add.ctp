...
<!--				<div class="pull-right"> <span class="strong innerLR"> <?php //echo $datetime; ?>&nbsp;
			...
			<div class="widget-body">
				<div class="innerLR">
					...
					<?php echo $this->Form->create('DevteamDaily',array('url' => array('controller' => 'devteamdaily','action' => 'add',$pinfo['Project']['id']),'class'=>'form-horizontal apply-nolazy','role'=>"form" ,'type'=>'file')); ?>
