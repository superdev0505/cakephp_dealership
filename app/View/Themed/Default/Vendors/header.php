	...
	<div class="twelve columns">
        <ul class="nav-bar">
          ...
          <li class="has-flyout">
            ...
            <ul class="flyout">
            	<li><a href="<?php url('page'); ?>/input-output/input-output.php?input"><?php lang('Product Input'); ?></a></li>
                <li><a href="<?php url('page'); ?>/input-output/input-output.php?output"><?php lang('Product Output'); ?></a></li>
            </ul>
          </li>
          <li class="has-flyout">
...
<div class="row">
	<div class="twelve columns">
		...
		if(strpos($page_name, '?'))	{ $page_name = explode('?', $page_name); $page_name = $page_name[0];	}
