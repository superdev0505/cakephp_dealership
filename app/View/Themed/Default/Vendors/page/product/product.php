...
if(isset($_POST['btn_update_product']))
{
	...
	if(update_product(get_the_product('id'), $status, $code, $name, $purchase_price, $sale_price))
	{
	...
	<div class="four columns">
    	<fieldset>
            ...
            <select name="status" id="status">
            	<option value="publish" <?php if(get_the_product('status') == 'publish') {echo 'selected';} ?>><?php lang('Publish'); ?></option>
                <option value="delete" <?php if(get_the_product('status') == 'delete') {echo 'selected';} ?>><?php lang('Delete'); ?></option>
            </select>
    ...
    <div class="eight columns">
        <div style="float:right;">
            ...
            <ul class="button-group">
              ...
              <li><a href="#" onClick="popup_barcode_print();" class="button secondary"><?php lang('Barcode Print'); ?></a></li>
            </ul>
    	</div>
    </div>
</div> <!-- /.row -->
