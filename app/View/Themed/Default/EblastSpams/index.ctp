				...
				<div class="widget-body">
					...
					<table class="table table-condensed table-striped table-primary table-vertical-center checkboxs js-table-sortable ui-sortable">
						...
						<tbody>
                            ...
                            foreach($eblastspams as $eblastUnsubscribe) { 
							?>
							<tr class="selectable" >
								<td ><?php echo $eblastUnsubscribe['EblastSpam']['contact_id']; ?></td>
								<td ><?php echo $eblastUnsubscribe['Contact']['first_name'] . "&nbsp;" . $eblastUnsubscribe['Contact']['last_name'];  ?></td>
								<td ><?php echo $eblastUnsubscribe['EblastSpam']['email']; ?></td>
					...
					echo $cleaned;?></td>
								...
								<td ><?php echo $eblastUnsubscribe['EblastSpam']['ip']; ?></td>
