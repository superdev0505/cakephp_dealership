			...
			<tr class="gradeA">
				...
				<td>
					<input type="hidden" name="attachment_files[]" value="<?php echo $file['Key']; ?>" >
					 ...
					 array('controller'=>'contact_s3', 'action'=> 'delete_attachment',"?"=>array('message_key'=> $message_key, 'filename'=> $file['Key'] )), array('escape'=>false, 'class'=>"btn btn-danger btn-xs no-ajaxify delete_s3_attachment")); ?>
