                ...
                <div class="col-lg-10">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <ul class="breadcrumb">
<li><a href="/eblasts">Dashboard</a><span class="divider"></span></li><li><a href="/eblasts/template">Template</a>  <span class="divider"></span></li><li class="active">View all </li></ul>                            <div class="page-content">
    ...
    <div class="panel-heading">
        <div class="pull-left">
            <h3 class="panel-title">
                <span class="glyphicon glyphicon-envelope"></span> Dealer E-Blasts            </h3>
        </div>
        <div class="pull-right">
            <a class="btn btn-default btn-xs" title="New" href="/eblasts/templates_create">Create New Template</a><a class="btn btn-default btn-xs" title="Refresh" href="/customer/campaigns/index">Refresh</a>        </div>
...
<thead>
<tr>
<th id="Campaign-grid_c0">E-Blast Name</th><th id="Campaign-grid_c1">Status</th><th id="Campaign-grid_c2">Date added</th><th id="Campaign-grid_c3">Schedule sending</th><th class="button-column" id="Campaign-grid_c4">Options</th></tr>
</thead>
<tbody>
<tr class="odd">
