...
@media print { body {font-family: Georgia, ‘Times New Roman’, serif;} h2 {font-size:12px!important;fontweight:bolder;} h4,h3 {font-size:9px!important;font-weight:bold;padding-top:0px!important;padding:0px!important;} table.set_padding td{padding:1px 2px 0px 6px!important;}
	...
	input[type=checkbox] 
	{
		...
		<div class="wraper header"> 
			...
			<table cellpadding="0" style="width:100%; border:2px solid #4c4c4c; margin:0 auto; font-family:arial;">
			<tbody>
			<tr>
				<td>
					<table style="font-family:arial;">
						<thead>
							<tr>
								<td><img  src="<?php echo FULL_BASE_URL; ?>/app/webroot/img/logo-retain.jpg" style="width:520px" alt="logo" border="0" ></td>

								<td>
									<p style="text-align:center;"><strong style="">McCoy Freightliner</strong><br>
								...
								<td>
									<table>
										<tr>
											...
											<td style="width:70%;"><input name="submit_date" value="<?php echo isset($info['submit_date'])?$info['submit_date']:date('Y-m-d'); ?>" style="width:100%; border:0; border-bottom:1px solid #ccc;" type="text"></td>
										</tr>
									</table>
								</td>
								<td></td>
								...
								<td style="width:50%;">
									<table style="width:100%;">
										<tr>
											...
											<td style="width:70%;"><input name="street_address" value="<?php echo isset($info['street_address'])?$info['street_address']:$info['address']; ?>" style="width:100%; border:0; border-bottom:1px solid #ccc;" type="text"></td>
										</tr>
									</table>
								</td>
							</tr>
								...
								<td style="width:50%;">
									<table style="width:100%;">
										<tr>
											...
											<td style="width:70%;"><input  name="email" value="<?php echo $info['email']; ?>"    style="width:100%; border:0; border-bottom:1px solid #ccc;" type="text"></td>
										</tr>
									</table>
								</td>
								<td style="width:50%;">
									<table style="width:100%;">
										<tr>
											...
											<td style="width:30%;"><input   name="res_phone" value="<?php echo isset($info['res_phone'])?$info['res_phone']:$info['phone']; ?>"     style="width:100%; border:0; border-bottom:1px solid #ccc;" type="text"></td>
											<td style="width:20%;">Bus. Phone:</td>
											<td style="width:30%;"><input   name="bus_phone" value="<?php echo isset($info['bus_phone'])?$info['bus_phone']:$info['mobile']; ?>"     style="width:100%; border:0; border-bottom:1px solid #ccc;" type="text"></td>
										</tr>
									</table>
								</td>
							</tr>
			...
			<tr>
				<td>
					<table style="font-family:arial; width:100%; border-top:1px solid #4c4c4c; border-bottom:1px solid #4c4c4c;">
						<tbody>
							<tr>
								<td><h5 style="margin:0; padding:0px 0;">PLEASE ENTER MY ORDER FOR THE FOLLOWING:</h5></td>
							</tr>
							<tr>
								<td style="width:100%;">
									<table style="width:100%;">
										<tr>
											<td><input style="border:1px solid #ccc;" <?php echo ($info['condition'] == "New") ? "checked" : "";?>  name="condition" value="new" type="radio"></td>
											<td>New:</td>
											<td><input style="border:1px solid #ccc;" <?php echo ($info['condition'] == "Used") ? "checked" : "";?>  name="condition" value="used" type="radio"></td>
											<td>Used:</td>
											...
											<td style="width:15%;"><input  name="make" value="<?php echo $info['make']; ?>" style="width:100%; border:0; border-bottom:1px solid #ccc;" type="text"></td>
											<td style="width:5%;">Model:</td>
											<td style="width:15%;"><input name="model" value="<?php echo isset($info['model'])?$info['model']:$info['model']; ?>" style="width:100%; border:0; border-bottom:1px solid #ccc;" type="text"></td>
											<td style="width:5%;">Color:</td>
											<td style="width:25%;"><input name="unit_color" value="<?php echo $info['unit_color']; ?>" style="width:100%; border:0; border-bottom:1px solid #ccc;" type="text"></td>
										</tr>
									</table>
									...
									<table style="width:100%;">
										<tr>
											...
											<td style="width:15%;"><input name="category" value="<?php echo $info['category']; ?>"  style="width:100%; border:0; border-bottom:1px solid #ccc;" type="text"></td>
											<td style="width:10%;"># of Axles:</td>
											<td style="width:15%;"><input name="axles" value="<?php echo isset($info['axles'])?$info['axles']:$info['axles']; ?>"  style="width:100%; border:0; border-bottom:1px solid #ccc;" type="text"></td>
											<td style="width:10%;">Stock #:</td>
											<td style="width:15%;"><input name="stock_num" value="<?php echo isset($info['stock_num'])?$info['stock_num']:$info['stock_num']; ?>"  style="width:100%; border:0; border-bottom:1px solid #ccc;" type="text"></td>
											<td style="width:10%;">Serial #:</td>
											<td style="width:15%;"><input name="vin" value="<?php echo $info['vin']; ?>"  style="width:100%; border:0; border-bottom:1px solid #ccc;" type="text"></td>
										</tr>
									</table>
								</td>
							</tr>
						...
						<td style="width:50%;">
							<table style="width:100%;">
								<tbody><tr>
									...
									<td style="width:80%;"><input type="text" name="sperson" value="<?php echo $info['sperson']; ?>"   style="width:100%; border:0; border-bottom:1px solid #ccc;"></td>
								</tr>
							</tbody></table>
						</td></tr>
						</tbody>
				...
				<td>
					<table style="width:100%;">
						...
						<tr>
							...
							<table style="width:100%; border-collapse:collapse" border="1" cellpadding="0" cellspacing="0">
								<tbody>
									<tr>
										...
										<td style="width:50%; padding:5px;"><input type="text" id="base_price_unit" class="total_price currency"  name="base_price_unit" value="<?php echo isset($info['base_price_unit'])?$info['base_price_unit']:$info['unit_value']; ?>"    style="width:100%; border:0; text-align:right;"></td>
									</tr>
									<tr>
										<td style="width:50%; padding:5px;"><strong>F.E.T. Per Unit:</strong></td>
										<td style="width:50%; padding:5px;"><input type="text" class="total_price currency"  name="fet_unit" value="<?php echo isset($info['fet_unit'])?$info['fet_unit']:''; ?>" style="width:100%; border:0; text-align:right;"></td>
									</tr>
									<tr>
										<td style="width:50%; padding:5px;"><strong>Price Includes:</strong></td>
										<td style="width:50%; padding:5px;"><input type="text" class="currency" name="price_include" value="<?php echo isset($info['price_include'])?$info['price_include']:''; ?>" style="width:100%; border:0; text-align:right;"></td>
									</tr>
									<tr>
										<td style="width:50%; padding:5px;"><input type="text" name="price2" value="<?php echo isset($info['price2'])?$info['price2']:''; ?>" style="width:100%; border:0; text-align:right;"></td>
										<td style="width:50%; padding:5px;"><input type="text" name="price3" value="<?php echo isset($info['price3'])?$info['price3']:''; ?>" style="width:100%; border:0; text-align:right;"></td>
									</tr>
									<tr>
										<td style="width:50%; padding:5px;"><input type="text" name="price4" value="<?php echo isset($info['price4'])?$info['price4']:''; ?>" style="width:100%; border:0; text-align:right;"></td>
										<td style="width:50%; padding:5px;"><input type="text" name="price5" value="<?php echo isset($info['price5'])?$info['price5']:''; ?>" style="width:100%; border:0; text-align:right;"></td>
									</tr>
									<tr>
										...
										<td style="width:60%; padding:5px;"><input id="flooring_days_cal" name="flooring_days_cal" type="text" style="width:100%; border:0; text-align:right;"></td>
									</tr>
								</tbody>
							</table>
								...
								<tr><td style="width:100%; border:0">
										<table style="width:100%;">
												<tbody>
													<tr>
														<td style="width:100%;">
															<h5 style="margin:0; padding:0px 0;">USED TRADE-IN AND/OR OTHER CREDITS</h5>
														</td>
													</tr>
											</tbody>
										</table>
							...
							<table style="width:100%; border-collapse:collapse; border-top:0;" border="1" cellpadding="0" cellspacing="0">
								<tr>
									<td style="width:50%; padding:5px; border-top:0;"><strong>Dealer Prep</strong></td>
									<td style="width:50%; padding:5px; border-top:0;"><input class="total_price currency" type="text" style="width:100%; border:0; text-align:right;"   name="dealer_prep" value="<?php echo isset($info['dealer_prep'])?$info['dealer_prep']:'250'; ?>"  ></td>
								</tr>
								<tr>
									<td style="width:50%; padding:5px;"><strong>Title Fee</strong></td>
									<td style="width:50%; padding:5px;"><input type="text" class="total_price currency"  name="title_fee" value="<?php echo isset($info['title_fee'])?$info['title_fee']:''; ?>" style="width:100%; border:0; text-align:right;"></td>
								</tr>
								<tr>
									<td style="width:50%; padding:0 5px;">
										<table style="width:100%;">
											<tbody>
												<tr>
													...
													<td style="border:1px solid #000; float:right;"><input type="text" class="additional_floor_day"  name="additional_floor_day" value="<?php echo isset($info['additional_floor_day'])?$info['additional_floor_day']:''; ?>"  style="width:50px; border:0; text-align:right;"></td>
												</tr>
											</tbody>
										</table>
									</td>
									<td style="width:60%; padding:5px;">$<input type="text" class="total_price currency" name="additional_floor_day2" id="additional_floor_day2"  value="<?php echo isset($info['additional_floor_day2'])?$info['additional_floor_day2']:''; ?>" style="width:90%; border:0; text-align:right;"></td>
								</tr>
								<tr>
								...
								<tr>
									<td style="width:50%; padding:5px;">
										<h5 style="margin:0; padding:0;">UNPAID BALANCE DUE ON DELIVERY</h5>
										<span style="">(difference between items 1 and 5)</span>
									</td>
						...
						<td style="width:50%; vertical-align:top;">
							<table style="width:100%; border-collapse:collapse" border="1" cellpadding="0" cellspacing="0">
								<tbody>
								<tr>
									<td style="width:100%; padding:7px 5px 6px;"><strong>USED TRADE-IN AND/OR OTHER CREDITS</strong></td>
									
								</tr>
								<tr>
									<td>
										<ol style="margin:0; padding:14px 0 45px 30px;">
											...
											<li>SUBJECT TO DYNO PER McCOY FREIGHTLINER’S</li>
										</ol>
										<h5 style="margin:0; padding:5px 5px 6px;">PURCHASER’S INITIALS:</h5>
									</td>
								</tr>
								<tr>
									<td><table style="width:100%; border-collapse:collapse;" border="1" cellpadding="0" cellspacing="0">
										...
										<tr style="border-top:0;">
											<td style="padding:5px; border:0;"><strong>Trade-In:</strong> <input type="text"  name="trade_in" value="<?php echo isset($info['trade_in'])?$info['trade_in']:''; ?>"  style=" border:0; text-align:left;"></td>
										</tr>
										<tr>
										...
										<tr><td style="padding:5px;"><strong>VIN:</strong> <input   name="trade_vin" value="<?php echo isset($info['trade_vin'])?$info['trade_vin']:''; ?>"  type="text" style=" border:0; text-align:left;"></td></tr>
										...
										<tr><td style="padding:5px;"><strong>Address:</strong> <input   name="purchase_address" value="<?php echo isset($info['purchase_address'])?$info['purchase_address']:''; ?>"  type="text" style=" border:0; text-align:left;"></td></tr>
										<tr><td style="padding:5px;"><input type="text" style=" border:0; text-align:left;" name="field6" value="<?php echo isset($info['field6'])?$info['field6']:''; ?>" ></td></tr>
										<tr><td style="padding:5px;"><input type="text" name="field6" value="<?php echo isset($info['field6'])?$info['field6']:''; ?>" style=" border:0; text-align:left;"></td></tr>
										<tr>
										...
										<tbody>
											<tr>
												<td style="width:100%;">
													...
													<hr><p style="text-align:center; margin:0; padding:0;">Purchaser’s Signature</p>
												</td>
											</tr>
										</tbody>
									</table>
								...
								<tbody>
									...
									<td style="width:40%; padding:5px;">
										<table cellspacing="0" cellpadding="0" border="0" style="width:100%; border-collapse:collapse; ">
											<tbody>
												<tr><td>Accept <input name="warranty_term_condition" value="Accept" <?php echo (isset($info['warranty_term_condition'])&& $info['warranty_term_condition'] == "Accept")?"checked":""; ?>  type="radio"></td></tr>
												<tr><td>Decline <input name="warranty_term_condition" type="radio" value="Decline" <?php echo (isset($info['warranty_term_condition']) && $info['warranty_term_condition'] == "Decline")?"checked":""; ?> ></td></tr>
												<tr><td>Initial <input name="warranty_term_condition" type="radio" value="Initial" <?php echo (isset($info['warranty_term_condition']) && $info['warranty_term_condition'] == "Initial")?"checked":""; ?> ></td></tr>
											</tbody>
										</table>
									</td>
								</tr>
							...
							<table cellspacing="0" cellpadding="0" border="1" style="width:100%; border-collapse:collapse; ">
								<tbody>
									...
									<td style="width:40%; padding:5px;">
										<table cellspacing="0" cellpadding="0" border="0" style="width:100%; border-collapse:collapse; ">
											<tbody>
												<tr><td>Accept <input name="financeterm_condition" type="radio" value="Accept" <?php echo (isset($info['financeterm_condition'])&& $info['financeterm_condition'] == "Accept")?"checked":""; ?>  ></td></tr>
												<tr><td>Decline <input name="financeterm_condition" type="radio" value="Decline" <?php echo (isset($info['financeterm_condition']) && $info['financeterm_condition'] == "Decline")?"checked":""; ?>  ></td></tr>
												<tr><td>Initial <input name="financeterm_condition" type="radio" value="Initial" <?php echo (isset($info['financeterm_condition']) && $info['financeterm_condition'] == "Initial")?"checked":""; ?>  ></td></tr>
								</tbody>
										</table>
									</td>
								</tr>
						...
						<tbody>
							<tr>
								<td>
									...
									<p style="margin:0; padding:0;">Purchaser’s Signature</p>
								</td>
							</tr>
						</tbody>
					</table>
				...
				<td style="width:50%;">
					<table cellspacing="0" cellpadding="0" border="0" style="width:100%; border-collapse:collapse;">
						<tbody>
							<tr>
								<td>
									<p style="margin:0; padding:0;">ACCEPTED BY</p>
									<hr style="margin:0; padding:0;">
									<p style="margin:0; padding:0;">Purchaser’s Signature</p>
								</td>
							</tr>
