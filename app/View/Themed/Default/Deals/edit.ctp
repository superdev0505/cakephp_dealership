<?php
    $this->Html->scriptBlock("
        jQuery(function($){
            $('#DealEditForm').submit(function(event){
...
<?php echo $this->Form->input('sperson', array('type' => 'hidden', 'class' => 'input-medium')); ?>
<?php echo $this->Form->input('status', array('type' => 'hidden', 'class' => 'input-medium')); ?>
<?php echo $this->Form->input('source', array('type' => 'hidden', 'class' => 'input-medium')); ?>
<?php echo $this->Form->input('deal_status_id', array('type' => 'hidden', 'class' => 'input-medium')); ?>
<?php echo $this->Form->input('date', array('type' => 'hidden', 'class' => 'input-medium')); ?>
<?php echo $this->Form->input('modified', array('type' => 'hidden', 'value' => $expectedt)); ?>
<?php echo $this->Form->input('modified_long', array('type' => 'hidden', 'value' => $expectedt2)); ?>
</tr>
...
'III' => 'III',
'IV' => 'IV'
), 'empty' => 'Select', 'selected' => $this->request->input['deal']['suffix'],'class' => 'span1'));
?>
&nbsp;&nbsp;First:&nbsp; <?php echo $this->Form->input('first_name', array('type' => 'text', 'class' => 'input-small')); ?>
&nbsp; &nbsp;Middle:&nbsp; <?php echo $this->Form->input('middle_name', array('type' => 'text', 'class' => 'input-small')); ?>
&nbsp; Last:&nbsp;<?php echo $this->Form->input('last_name', array('type' => 'text', 'class' => 'input-medium')); ?>
&nbsp;Gender:&nbsp; <?php
echo $this->Form->input('gender', array('type' => 'select', 'options' => array(
'Male' => 'Male',
'Female' => 'Female'
), 'empty' => 'Select', 'selected' => $this->request->input['deal']['gender'], 'class' => 'input-small'));
?></br></br>
&nbsp; Address:&nbsp; <?php echo $this->Form->input('address', array('type' => 'text', 'class' => 'input-medium')); ?>
&nbsp; City:&nbsp; <?php echo $this->Form->input('city', array('type' => 'text', 'class' => 'input-medium')); ?>
&nbsp; State:&nbsp; <?php
...
&nbsp;Cell:&nbsp; <?php echo $this->Form->input('mobile', array('type' => 'text', 'class' => 'input-small')); ?>
...
<p><strong>&nbsp;If address less than 6 years please fill the address info (below).</strong></p>
...
<p><strong>&nbsp;If you are filling out a CREDIT APP please fill in info below (All Required for Credit).</strong></p>
...
'Relatives' => 'Relatives',
'Other' => 'Other'
), 'empty' => 'Select','selected' => $this->request->input['deal']['residence_status'], 'class' => 'input-small'));
?>
...
'1' => '1',
'2' => '2'
), 'empty' => 'Select', 'selected' => $this->request->input['deal']['residence_length'], 'class' => 'input-small'));
?>
</br></br>
&nbsp;Are you retired?&nbsp; <?php
...
'Yes' => 'Yes',
'No' => 'No'
), 'empty' => 'Select', 'selected' => $this->request->input['deal']['retired_status'], 'class' => 'input-small'));
?>
...
'1' => '1',
'2' => '2'
), 'empty' => 'Select', 'selected' => '', 'selected' => $this->request->input['deal']['job_length'], 'class' => 'input-small'));
?>
...
'1' => '1',
'2' => '2'
), 'empty' => 'Select', 'selected' => $this->request->input['deal']['previous_employer_length'], 'class' => 'input-small'));
?>
...
'Yes' => 'Yes',
'No' => 'No'
), 'empty' => 'Select', 'selected' => $this->request->input['deal']['other_income'], 'class' => 'input-small'));
?>
...
'III' => 'III',
'IV' => 'IV'
), 'empty' => 'Select', 'selected' => $this->request->input['deal']['co_suffix'],'class' => 'span1'));
?>
&nbsp;&nbsp;Co-First:&nbsp; <?php echo $this->Form->input('cobuyer_fname', array('type' => 'text', 'class' => 'input-small')); ?>
&nbsp; Co-Middle:&nbsp; <?php echo $this->Form->input('cobuyer_mname', array('type' => 'text', 'class' => 'input-small')); ?>
...
'Male' => 'Male',
'Female' => 'Female'
), 'empty' => 'Select', 'selected' => $this->request->input['deal']['cobuyer_gender'], 'class' => 'input-small'));
?></br></br>
...
'Relatives' => 'Relatives',
'Other' => 'Other'
), 'empty' => 'Select', 'selected' => $this->request->input['deal']['cobuyer_residence_status'], 'class' => 'input-small'));
?>
...
&nbsp;Co-Residence Length?&nbsp; <?php
echo $this->Form->input('cobuyer_residence_length', array('type' => 'select', 'options' => array(
'1' => '1',
'2' => '2'
), 'empty' => 'Select', 'selected' => $this->request->input['deal']['cobuyer_residence_length'], 'class' => 'input-small'));
?>
</br></br>
&nbsp;Co-Are you retired?&nbsp; <?php
echo $this->Form->input('cobuyer_retired', array('type' => 'select', 'options' => array(
'Yes' => 'Yes',
'No' => 'No'
), 'empty' => 'Select', 'selected' => $this->request->input['deal']['cobuyer_retired'], 'class' => 'input-small'));
?>
&nbsp;Co-Realtionship?&nbsp; <?php
...
'Co-Worker' => 'Co-Worker',
'Other' => 'Other'
), 'empty' => 'Select', 'selected' => $this->request->input['deal']['cobuyer_relationship'], 'class' => 'input-small'));
?>
...
'1' => '1',
'2' => '2'
), 'empty' => 'Select', 'selected' => $this->request->input['deal']['cobuyer_job_length'], 'class' => 'input-small'));
?>
...
'1' => '1',
'2' => '2'
), 'empty' => 'Select', 'selected' => $this->request->input['deal']['co_previous_employer_length'], 'class' => 'input-small'));
?>
...
'Yes' => 'Yes',
'No' => 'No'
), 'empty' => 'Select', 'selected' => $this->request->input['deal']['cobuyer_other_income'], 'class' => 'input-small'));
?>
...
<p><strong> &nbsp;If you are filling out a CREDIT APP please fill in the References below. (All Required for Credit).</strong></p>
...
'Co-Worker' => 'Co-Worker',
'Other' => 'Other'
), 'empty' => 'Select', 'selected' => $this->request->input['deal']['ref1_type'], 'class' => 'input-small'));
?>
</br></br>
...
'Co-Worker' => 'Co-Worker',
'Other' => 'Other'
), 'empty' => 'Select', 'selected' => $this->request->input['deal']['ref2_type'], 'class' => 'input-small'));
?>
</br></br>

&nbsp;Ref #3 Name:&nbsp;<?php echo $this->Form->input('ref3_name', array('type' => 'text', 'class' => 'input-small')); ?>&nbsp;
&nbsp;Ref #3 Phone:&nbsp;<?php echo $this->Form->input('ref3_phone', array('type' => 'text', 'class' => 'input-small')); ?>&nbsp;
&nbsp;Ref #3 City:&nbsp;<?php echo $this->Form->input('ref3_city', array('type' => 'text', 'class' => 'input-small')); ?>&nbsp;
&nbsp;Ref #3 State:&nbsp; <?php
...
'Co-Worker' => 'Co-Worker',
'Other' => 'Other'
), 'empty' => 'Select', 'selected' => $this->request->input['deal']['ref3_type'], 'class' => 'input-small'));
?>
</div>
</br></br><hr style="height:3px; border:none; color:#000; background-color:#000; width:100%; text-align:left; margin: 0 0 0 auto;"></br>
...
?>
</br></br>&nbsp; Model:&nbsp; <?php echo $this->Form->input('model', array('type' => 'text', 'class' => 'input-small')); ?>
&nbsp; Unit Type:&nbsp; <?php
...
&nbsp; Vin#:&nbsp; <?php echo $this->Form->input('vin', array('type' => 'text', 'class' => 'input-medium')); ?>
...
<hr style="height:3px; border:none; color:#000; background-color:#000; width:100%; text-align:left; margin: 0 0 0 auto;"></br>
<p id="fee-toggle" style="cursor:pointer"><strong>FIXED FEE / PAYMENT<span style="font-size:11px;margin-left:10px;color:#555555">(click to expand)</span></strong></p>
...
&nbsp; Unit Amount:$&nbsp; <?php echo $this->Form->input('unit_value', array('type' => 'text','id' => 'DealerUnitValue','class' => 'input-mini')); ?>
...
<br>
<br>
&nbsp;&nbsp;Deal Notes:&nbsp;<?php echo $this->Form->input('notes', array('type' => 'text', 'class' => 'span6','required'=>'required')); ?>

</br>
</br>

<p>&nbsp;<strong>Please Note: <u>ESTIMATE ONLY</u> real payment is based on customer credit.&nbsp;&nbsp;Monthly Payment:&nbsp;</strong></p>
 <hr size="2" width="70%">
<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;Deal Status: &nbsp;<?php echo $this->Form->input('deal_status_id', array('type' => 'select', 'options' => array(
'4' => 'In Process',
'5' => 'Accepted',
'6' => 'Rejected'
...
<script>
	...
	jQuery("p#fee-toggle").click(function(){
		jQuery("#fee").toggle("fast");
	});
...
th, td { vertical-align: top; }          / Don't center table/
</style>
<script>
...
function add() {
	...
	var inputs = $("div[id='fee']").find(".input-mini");
...
function validateFields(){
	var inputs = $("div[id='fee']").find(".input-mini").add("#DealTaxFee");
	var missing = false;
	inputs.each(function() 
		{
			var val = $(this).val();
