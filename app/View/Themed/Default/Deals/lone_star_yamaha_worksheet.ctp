...
?>
		<div class="wraper header"> 
			...
			<div class="right"> 
				<span style="width: 8%;">Salesperson</span>:
				<input name="sperson" type="text" class="input25" value="<?php echo $contact['Contact']['sperson']; ?>" placeholder=""/>
			</div>
            ...
            <span class="span24">Selling Price</span>$
				...
				<input name="subtotal" id="subtotal" type="text" class="input71 priceChange" value="<?php echo $contact['Contact']['subtotal']; ?>" placeholder=""/>
...
$(document).ready(function(){
	...
	$(".tradeDiff").on('change keyup paste',function(){
											...
											subtotal=parseFloat(actual_value-allowance);	
