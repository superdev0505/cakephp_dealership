	...
	<div class="wraper header"> 
		...
		<div class="container" style="width: 960px; margin: 0 auto;">
			...
			<div class="logo" style="width: 200px; margin: 0 auto;">
				<img src="<?php echo ('/app/webroot/files/dealer_name/dealer_logo/'.$cid.'/logo1.jpg'); ?>" alt="" style="width: 100%; margin-bottom: 20px;">
			</div>
		...
		<div class="row" style="border-bottom: 1px solid #f58220; float: left; margin: 0 0 2px 0; padding: 0 0 8px; position: relative; text-align: center; width: 100%;">
			...
			<p style="margin: 0;">HARLEY-DAVIDSON OF SCOTTSDALE</p>
			<p style="margin: 0;">15656 N Hayden Rd</p>
			<p style="margin: 0;">Scottsdale, AZ 85260</p>
			<p style="margin: 0;">Phone: (888) 370-1285</p>
		</div>
		...
		<div class="row" style="float: left; width: 100%; margin: 2px 0; border-top: 1px solid #f58220;">
			<p style="width: 90%; margin: 22px auto;">My signature below authorizes lienholder to accept loan payoﬀ from HARLEY-DAVIDSON OF Scottsdale
and authorizes the title to be mailed directly to HARLEY-DAVIDSON OF Scottsdale. Should the payoﬀ be
