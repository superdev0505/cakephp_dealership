	...
	<div id="worksheet_container">
		<style>
			...
			@media print {
				...
				.wrk_frm31{ width:80%; font-size:9px !important;background:none; border-bottom:solid 1px #646464; border-top:none;border:2px solid #646464; border-right:none; border-left:none;}
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border:solid 1px #000;">
		  <tr style="background:#2E3069; padding-left:5px; font-size:14px; color:#fff;">
			<td colspan="7" >UNIT INFO</td>
		   	</tr>
            <tr>
                <td style="width:8%;">               
              ...
              <td style="width:10%;">
                <input name="make1" id="make1"   value="<?php echo (isset($info['make1'])&& !empty($info['make1'])) ? $info['make1'] : $info['make']; ?>"  type="text" style="width:100%" class="wrk_frm4 quality" />
                </td>
              <td style="width:14%;">
                ...
                <td style="width:15%;">
                	<input name="stockdata1" id="stockdata1" value="<?php echo isset($info['stockdata1']) ? $info['stockdata1'] : $info['stock_num']; ?>"  type="text" class="wrk_frm4" />
                </td>
                
               <td style="width:10%;" rowspan="2" valign="middle">
               <input name="unit_value1" id="unit_value1"   value="<?php echo isset($info['unit_value1']) ? $info['unit_value1'] : $info['unit_value']; ?>" style="width:100%" type="text" class="wrk_frm4 quantity currency" />		   	
               </td>
                <td style="width:10%;" valign="middle" rowspan="2">
            ...
            <tr>
                ...
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td><input name="unit_color1" value="<?php echo (isset($info['unit_color1'])&& !empty($info['unit_color1'])) ? $info['unit_color1'] : $info['unit_color']; ?>" style="width:100%"  type="text" class="wrk_frm41 quality" /></td>
                <td><input name="vin1" id="vin1"   value="<?php echo (isset($info['vin1'])&& !empty($info['vin1'])) ? $info['vin1'] : $info['vin']; ?>" style="width:100%" type="text" class="wrk_frm41 quality" /></td>
            </tr>
            <!-- row2 -->
            <tr>
                <td style="width:8%;">               
                <input name="condition2" id="condition2"   value="<?php echo (isset($info['condition2']) && !empty($info['condition2'])) ? $info['condition2'] : $addonVehicles[0]['AddonVehicle']['condition']; ?>" type="text" style="width:100%;" class="wrk_frm4" />
                </td>
              <td style="width:8%;">
                 <input name="year2_data" id="year2"   value="<?php echo (isset($info['year2_data']) && !empty($info['year2_data'])) ? $info['year2_data'] : $addonVehicles[0]['AddonVehicle']['year']; ?>" type="text" class="wrk_frm4 quality" style="width:100%;" />
              </td>
              <td style="width:10%;">
                <input name="make2_data" id="make2" value="<?php echo (isset($info['make2_data'])&& !empty($info['make2_data'])) ? $info['make2_data'] : $addonVehicles[0]['AddonVehicle']['make']; ?>"  type="text" class="wrk_frm4 quality" style="width:100%;" />
                </td>
              <td style="width:14%;">
                <input name="model2_data" id="model2" value="<?php echo (isset($info['model2_data'])&& !empty($info['model2_data'])) ? $info['model2_data'] : $addonVehicles[0]['AddonVehicle']['model']; ?>"  type="text" class="wrk_frm41 quality" />	   
        
               </td>
                <td style="width:15%;">
                	<input name="stockdata2" id="stockdata2" value="<?php echo (isset($info['stockdata2'])&& !empty($info['stockdata2'])) ? $info['stockdata2'] : $addonVehicles[0]['AddonVehicle']['stock_num']; ?>"  type="text" class="wrk_frm4" />		
                </td>
                
               <td style="width:10%;" rowspan="2" valign="middle">
              <input name="unit_value2" id="unit_value2"   value="<?php echo (isset($info['unit_value2'])&& !empty($info['unit_value2'])) ? $info['unit_value2'] : $addonVehicles[0]['AddonVehicle']['unit_value']; ?>"  type="text" class="wrk_frm4 quality currency" />	
               </td>
                <td style="width:10%;" valign="middle" rowspan="2">
                <input name="sales_price2" id="2" value="<?php echo isset($info['sales_price2']) ? $info['sales_price2'] : ''; ?>"  type="text" class="wrk_frm31 sales_price currency" /></td>
			</tr>
            <tr>
            	<td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>
                	<input name="unit_color2" id="unit_color2"   value="<?php echo (isset($info['unit_color2'])&& !empty($info['unit_color2'])) ? $info['unit_color2'] : $addonVehicles[0]['AddonVehicle']['unit_color']; ?>" type="text" class="wrk_frm4 quality" />
                </td>
                <td>
                	<input name="vin2_data" id="vin2"   value="<?php echo (isset($info['vin2_data'])&& !empty($info['vin2_data'])) ? $info['vin2_data'] : $addonVehicles[0]['AddonVehicle']['vin']; ?>" type="text" class="wrk_frm4 quality" />		   	
               </td>
            </tr>
            <tr>
                <td style="width:8%;">               
                <input name="condition4" id="condition4"   value="<?php echo (isset($info['condition4']) && !empty($info['condition4'])) ? $info['condition4'] : $addonVehicles[1]['AddonVehicle']['condition']; ?>" type="text" style="width:100%;" class="wrk_frm4" />
                </td>
              <td style="width:8%;">
                 <input name="year4_data" id="year4"   value="<?php echo (isset($info['year4_data']) && !empty($info['year4_data'])) ? $info['year4_data'] : $addonVehicles[1]['AddonVehicle']['year']; ?>" type="text" class="wrk_frm4 quality" style="width:100%;" />
              </td>
              <td style="width:10%;">
                <input name="make4_data" id="make4" value="<?php echo (isset($info['make4_data'])&& !empty($info['make4_data'])) ? $info['make4_data'] : $addonVehicles[1]['AddonVehicle']['make']; ?>"  type="text" class="wrk_frm4 quality" style="width:100%;" />
                </td>
              <td style="width:14%;">
                <input name="model4_data" id="model4" value="<?php echo (isset($info['model4_data'])&& !empty($info['model4_data'])) ? $info['model4_data'] : $addonVehicles[1]['AddonVehicle']['model']; ?>"  type="text" class="wrk_frm41 quality" />	   
        
               </td>
                <td style="width:15%;">
                	<input name="stockdata4" id="stockdata4" value="<?php echo (isset($info['stockdata4'])&& !empty($info['stockdata4'])) ? $info['stockdata4'] : $addonVehicles[1]['AddonVehicle']['stock_num']; ?>"  type="text" class="wrk_frm4" />		
                </td>
                
               <td style="width:10%;" rowspan="2" valign="middle">
              <input name="unit_value4" id="unit_value4"   value="<?php echo (isset($info['unit_value4'])&& !empty($info['unit_value4'])) ? $info['unit_value4'] : $addonVehicles[1]['AddonVehicle']['unit_value']; ?>"  type="text" class="wrk_frm4 quality currency" />	
               </td>
                <td style="width:10%;" valign="middle" rowspan="2">
                <input name="sales_price4" id="4" value="<?php echo isset($info['sales_price4']) ? $info['sales_price4'] : ''; ?>"  type="text" class="wrk_frm31 sales_price currency" /></td>
			</tr>
            <tr>
            	<td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>
                	<input name="unit_color4" id="unit_color4"   value="<?php echo (isset($info['unit_color4'])&& !empty($info['unit_color4'])) ? $info['unit_color4'] : $addonVehicles[1]['AddonVehicle']['unit_color']; ?>" type="text" class="wrk_frm4 quality" />
                </td>
                <td>
                	<input name="vin4_data" id="vin4"   value="<?php echo (isset($info['vin4_data'])&& !empty($info['vin4_data'])) ? $info['vin4_data'] : $addonVehicles[1]['AddonVehicle']['vin']; ?>" type="text" class="wrk_frm4 quality" />		   	
               </td>
            </tr>

             <tr>
				<td colspan="6" align="right">RIVER VALLEY DISCOUNT</td>
                <td style="width:15%;" >
            ...
            <tr>
                <td colspan="6" align="right">FREIGHT & SET UP</td>
                <td id="fright_set_up"> <input id="fright_set_up_val" name="fright_set_up" value="<?php echo isset($info['fright_set_up']) ? $info['fright_set_up'] : ''; ?>"  type="text" class="wrk_frm31 subtotalval currency" /></td>		  
			</tr>
		</table>
		...
		<table width="70%" class="unit_info_left" border="2" cellspacing="0" cellpadding="0" style="border-top:none; border-bottom:solid 1px #000; border-right:solid 1px #000; border-left:solid 1px #000; float:left;">
			<tr>
				<td style="background:#2E3069; width:92.4%; border-right:solid 1px #000; font-size:14px; height:25px; color:#fff;">TRADE INFO:</td>
				...
				<td style="width:10%; border-right:solid 1px #000; color:#000;"></td>-->
			</tr>
			...
			<tr>
				<td style="width:92.4%;">
					...
					<td style="font-size:14px; color:#000;">
						<div class="form-field" style="width: 100%; border-bottom: 1px solid #000; height:25px"></div>
						<div class="form-field" style="width: 100%; border-bottom: 1px solid #000; height:25px"></div>
						<div class="form-field" style="width: 100%; border-bottom: 1px solid #000; height:25px"></div>
						<div class="form-field" style="width: 100%; border-bottom: 1px solid #000; height:25px"></div>
						<div class="form-field" style="width: 100%; border-bottom: 1px solid #000; height:25px"></div>
						<div class="form-field" style="width: 100%; border-bottom: 1px solid #000; height:25px"></div>
						<div class="form-field" style="width: 100%; height:25px"></div>
					</td>
				</td>
			</tr>
		...
		<table class="unit_right" border="0" cellspacing="0" cellpadding="0" style="border-top:none; border-bottom:solid 1px #000; border-right:solid 1px #000; border-left:solid 1px #000; float:left;">
			...
			<tr>
				...
				<td style="width:40%; border-right:solid 1px #000;  border-top:solid 1px #000;background:#ccc; padding-left:5px; font-size:14px; color:#000;">
					<input name="sales_tax"   value="<?php echo isset($info['sales_tax']) ? $info['sales_tax'] : ''; ?>"  type="text" class="wrk_frm31 currency_value" />
				</td>
			</tr>
			...
			<tr>
				...
				<td style="width:40%; border-right:solid 1px #000;  border-top:solid 1px #000;background:#ccc; padding-left:5px; font-size:14px; color:#000;">
					<input name="ext_services"   value="<?php echo isset($info['ext_services']) ? $info['ext_services'] : ''; ?>"  type="text" class="wrk_frm31 currency_value" />
				</td>
			</tr>
...
function calculate_subBalance()
{
	...
	$(".sales_price").on('change keyup paste',function(){
        calculate_subBalance();
     });
...
function calculate() 
{
	...
	function calculate_total() {
        var cal_total = 0.00;
        $( ".currency_value" ).each(function( index ) {
