...
.title {
	...
	<div class="wraper header">
		...
		<div class="row" style="float: left; width: 100%; margin-left: 7px;">
			<b>SALES REP</b>
			<input type="text" name="sales_rep" value="<?php echo isset($info['sales_rep'])?$info['sales_rep']:''; ?>" style="width: 100%;">
		</div>
		...
		<table class="activity" style="float: left; width: 100%; margin: 10px 0; text-align: right;" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td style="text-align: left;"><b>LIC</b><input type="checkbox" name="lic_status" style="margin-left: 5px;" <?php echo ($info['lic_status'] == "lic_status") ? "checked" : ""; ?> value="lic_status"/> <br>
				<input type="text" name="lic" value="<?php echo isset($info['lic'])?$info['lic']:''; ?>" style="width: 50%;"></td>
			...
			<tr>
				<td style="text-align: left;"><b>Property Tax</b><input type="checkbox" name="property_status" style="margin-left: 5px;" <?php echo ($info['property_status'] == "property_status") ? "checked" : ""; ?> value="property_status"/> <br>
				<input type="text" name="property_tax" value="<?php echo isset($info['property_tax'])?$info['property_tax']:''; ?>" style="width: 50%;"></td>
			...
			<tr>
				...
				<td><input type="text" name="rate5" value="<?php echo isset($info['rate5'])?$info['rate5']:''; ?>" style="width: 100%;"></td>
				<td><input type="text" name="amont5" value="<?php echo isset($info['amont5'])?$info['amont5']:''; ?>" style="width: 100%;"></td>
			</tr>
			<tr>
				...
				<td><input type="text" name="rate6" value="<?php echo isset($info['rate6'])?$info['rate6']:''; ?>" style="width: 100%;"></td>
				<td><input type="text" name="amont6" value="<?php echo isset($info['amont6'])?$info['amont6']:''; ?>" style="width: 100%;"></td>
			</tr>
		</table>
