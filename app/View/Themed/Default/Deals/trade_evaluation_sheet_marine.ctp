...
this is necessary to process the payoff of the vehicle described above.</p>
		...
		<div class="row table-section" style="float: left; width: 100%; margin: 0;">
			<table cellpadding="0" cellspacing="0" style="float: left; width: 100%;">
				...
				<tr>
					<td>Cleats, Grab Rails/Handles</td>
				...
				<tr>
					<td>Storage Compartment Condition</td>
				...
				<tr>
					<td>Starter Operation / Battery Condition</td>
				...
				<tr>
					<td>Drive System / Prop Inspection</td>
				...
				<tr>
					<td>Engine Compartment Condition</td>
				...
				<tr>
					<td>Shifting / Throttle Operation</td>
				...
				<tr>
					...
					<td><input type="text" name="attn26" value="<?php echo isset($info['attn26']) ? $info['attn26'] : ''; ?>" style="width: 100%;"></td>
					<td><input type="text" name="note26" value="<?php echo isset($info['note26']) ? $info['note26'] : ''; ?>" style="width: 100%;"></td>
					<td><input type="text" name="part26" value="<?php echo isset($info['part26']) ? $info['part26'] : ''; ?>" style="width: 100%;"></td>
					<td><input type="text" name="labor26" value="<?php echo isset($info['labor26']) ? $info['labor26'] : ''; ?>" style="width: 100%;"></td>
				</tr>
				
				<tr>
					<td>Additional Bodywork / Bumpers</td>
					<td><input type="text" name="attn27" value="<?php echo isset($info['attn27']) ? $info['attn27'] : ''; ?>" style="width: 100%;"></td>
					<td><input type="text" name="note27" value="<?php echo isset($info['note27']) ? $info['note27'] : ''; ?>" style="width: 100%;"></td>
					<td><input type="text" name="part27" value="<?php echo isset($info['part27']) ? $info['part27'] : ''; ?>" style="width: 100%;"></td>
					<td><input type="text" name="labor27" value="<?php echo isset($info['labor27']) ? $info['labor27'] : ''; ?>" style="width: 100%;"></td>
				</tr>
				...
				<tr>
					<td>Tire(s) & Wheel(s) / Wheel Bearings / Spare Tire</td>
					<td><input type="text" name="attn28" value="<?php echo isset($info['attn28']) ? $info['attn28'] : ''; ?>" style="width: 100%;"></td>
					<td><input type="text" name="note28" value="<?php echo isset($info['note28']) ? $info['note28'] : ''; ?>" style="width: 100%;"></td>
					<td><input type="text" name="part28" value="<?php echo isset($info['part28']) ? $info['part28'] : ''; ?>" style="width: 100%;"></td>
					<td><input type="text" name="labor28" value="<?php echo isset($info['labor28']) ? $info['labor28'] : ''; ?>" style="width: 100%;"></td>
				</tr>
				
				<tr>
					<td>Running Board Condition</td>
					<td><input type="text" name="attn29" value="<?php echo isset($info['attn29']) ? $info['attn29'] : ''; ?>" style="width: 100%;"></td>
					<td><input type="text" name="note29" value="<?php echo isset($info['note29']) ? $info['note29'] : ''; ?>" style="width: 100%;"></td>
					<td><input type="text" name="part29" value="<?php echo isset($info['part29']) ? $info['part29'] : ''; ?>" style="width: 100%;"></td>
					<td><input type="text" name="labor29" value="<?php echo isset($info['labor29']) ? $info['labor29'] : ''; ?>" style="width: 100%;"></td>
				</tr>
				
				<tr>
					<td>Trailer Jack / Bow Crank Condition</td>
					<td><input type="text" name="attn30" value="<?php echo isset($info['attn30']) ? $info['attn30'] : ''; ?>" style="width: 100%;"></td>
					<td><input type="text" name="note30" value="<?php echo isset($info['note30']) ? $info['note30'] : ''; ?>" style="width: 100%;"></td>
					<td><input type="text" name="part30" value="<?php echo isset($info['part30']) ? $info['part30'] : ''; ?>" style="width: 100%;"></td>
					<td><input type="text" name="labor30" value="<?php echo isset($info['labor30']) ? $info['labor30'] : ''; ?>" style="width: 100%;"></td>
				</tr>
				
				<tr>
					<td>Rust / Appearance</td>
					<td><input type="text" name="attn31" value="<?php echo isset($info['attn31']) ? $info['attn31'] : ''; ?>" style="width: 100%;"></td>
					<td><input type="text" name="note31" value="<?php echo isset($info['note31']) ? $info['note31'] : ''; ?>" style="width: 100%;"></td>
					<td><input type="text" name="part31" value="<?php echo isset($info['part31']) ? $info['part31'] : ''; ?>" style="width: 100%;"></td>
					<td><input type="text" name="labor31" value="<?php echo isset($info['labor31']) ? $info['labor31'] : ''; ?>" style="width: 100%;"></td>
				</tr>
				
				<tr>
					<td>Rust / Appearance</td>
					<td><input type="text" name="attn32" value="<?php echo isset($info['attn32']) ? $info['attn32'] : ''; ?>" style="width: 100%;"></td>
					<td><input type="text" name="note32" value="<?php echo isset($info['note32']) ? $info['note32'] : ''; ?>" style="width: 100%;"></td>
					<td><input type="text" name="part32" value="<?php echo isset($info['part32']) ? $info['part32'] : ''; ?>" style="width: 100%;"></td>
					<td><input type="text" name="labor32" value="<?php echo isset($info['labor32']) ? $info['labor32'] : ''; ?>" style="width: 100%;"></td>
				</tr>
				
				<tr>
					<td>Light Function</td>
					<td><input type="text" name="attn33" value="<?php echo isset($info['attn33']) ? $info['attn33'] : ''; ?>" style="width: 100%;"></td>
					<td><input type="text" name="note33" value="<?php echo isset($info['note33']) ? $info['note33'] : ''; ?>" style="width: 100%;"></td>
					<td><input type="text" name="part33" value="<?php echo isset($info['part33']) ? $info['part33'] : ''; ?>" style="width: 100%;"></td>
					<td><input type="text" name="labor33" value="<?php echo isset($info['labor33']) ? $info['labor33'] : ''; ?>" style="width: 100%;"></td>
				</tr>
			</table>
		</div>
