...
<div class="wraper main" id="worksheet_wraper"  style=" overflow: auto;"> 
	...
	<div class="wraper header"> 
		...
		<div class="container" style="width: 960px; margin: 0 auto;">
			...
			<h2 style="float: left; width: 100%; text-align: center; margin: 7px 0 26px 0px;">Customer Delivery Path: MOTORCLOTHES</h2>
			...
			<div class="row" style="width: 100%; margin: 10px 0; float: left; ">
				<label>Date:</label>
				<input type="text" name="submit_dt" value="<?php echo isset($info['submit_dt'])?$info['submit_dt']:$expectedt; ?>" style="text-align: center">
			</div>
			<div class="row" style="width: 100%; margin: 10px 0; float: left;">
			...
			<div class="row" style="width: 100%; margin: 10px 0; float: left; ">
				<label>Phone #:</label>
				<input type="text" name="phone" value="<?php echo isset($info['mobile'])?$info['mobile']:''; ?>" style="float: right; width: 88%;">
			</div>
			<div class="row" style="width: 100%; margin: 10px 0; float: left; ">
				<div class="foem-field" style="float: left; width: 25%;">
					<label>New Rider:</label>
					<input type="text" name="new_rider" value="<?php echo isset($info['new_rider'])?$info['new_rider']:''; ?>" style="width: 63%;">
				</div>
				<div class="foem-field" style="float: left; width: 30%;">
					<label>Returning Rider:</label>
					<input type="text" name="returning_rider" value="<?php echo isset($info['returning_rider'])?$info['returning_rider']:''; ?>" style="width: 56%;">
				</div>
				<div class="foem-field" style="float: left; width: 45%;">
					<label>Trading Rider:</label>
					<input type="text" name="trading_rider" value="<?php echo isset($info['trading_rider'])?$info['trading_rider']:''; ?>" style="width: 75%;">
				</div>
			</div>
			<div class="row" style="width: 100%; margin: 10px 0; float: left;">
			...
			<div class="row" style="width: 100%; margin: 10px 0; float: left; ">
				...
				<input type="text" name="cloth_associate" value="<?php echo isset($info['cloth_associate'])?$info['cloth_associate']:''; ?>" style="float: right; width: 81%;">
			</div>
			<div class="row" style="width: 100%; margin: 10px 0; float: left; ">
				<label>Accessories Ordered/Pulled:</label>
				<span><input type="radio" name="accessories_ordered" value="yes" <?php echo (isset($info['accessories_ordered']) && $info['accessories_ordered'] =='yes')?'checked':''; ?> />&nbsp;Yes &nbsp;&nbsp;<input type="radio" name="accessories_ordered" value="no" <?php echo (isset($info['accessories_ordered']) && $info['accessories_ordered'] =='no')?'checked':''; ?> />&nbsp; No</span>
			</div>
