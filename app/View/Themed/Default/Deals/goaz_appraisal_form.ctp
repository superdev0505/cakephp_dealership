...
<div class="wraper main" id="worksheet_wraper"  style=" overflow: auto;"> 
	...
	<div class="wraper header"> 
			...
			<div class="row">
                ...
                <img  src="<?php echo ('/app/webroot/files/goaz_images/gsa_logo.png'); ?>" alt=""><br/>
                <span style="color:blue;font-size:10px;"><i>The industry’s #1 authority on dealer profitability!</i></span><br/>
                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <label style="width:55%;float:left;display:inline;" >Make & Model <input type="text" name="make_model_trade" style="width:65%;"  value="<?php echo isset($info['make_model_trade'])?$info['make_model_trade']:$info['make_trade'].' '.$info['model_trade']; ?>"  /></label>
               ...
               <p style="text-align:center;"><strong>THIS TRADE-IN OFFER EXPIRES <input type="text" name="expiry_date" value="<?php echo isset($info['expiry_date'])?$info['expiry_date']:''; ?>"  /> AND IS EFFECTIVE ONLY IF THE MOTORCYCLE IS IN THE SAME CONDITION AS WHEN IT WAS INSPECTED.</strong></p> 
                <p style="text-align:center;font-size:10px;">© 2011, Gart Sutton & Associates, Inc.</p>       
