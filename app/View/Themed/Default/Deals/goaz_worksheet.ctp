		...
		<div class="wraper header"> 
                	...
                	<table width="100%">
                        ...
                        <span>
                         16844 N. Arrowhead Fountain Center Dr.<br/>
                          Peoria, Arizona 85382<br/>
                          Phone: &nbsp;&nbsp; 623-322-6700<br/>
                          Fax: &nbsp;&nbsp;  623-322-6701<br/>
                          www.goazwest.com
            ...
            <tr>
    	        <td  class="grey_bg"><label>Home #</label></td>
  	            <td ><input type="text" name="mobile" value="<?php echo isset($info['mobile'])?$info['mobile']:$info['phone']; ?>" style="width:90%;" /></td>
            ...
            <tr>
              ...
              <table width="100%" border="1">
                ...
                <tr>
                    ...
                    <td  rowspan="5" valign="middle" align="center"><input type="text" name="trade_value" value="<?php echo isset($info['trade_value'])?$info['trade_value']:''; ?>" style="width:75%;" /></td>
              	</tr>
                 <tr>
            ...
            <input type="radio" name="down_option" value="1" <?php echo (isset($info['down_option'] )&& $info['down_option'] == 1)?'checked':''; ?> /> &nbsp;$1,000 - $2,000</h3><br/>
             <h3 style="display:inline;">
            <input type="radio" name="down_option" value="2" <?php echo (isset($info['down_option'] )&& $info['down_option'] == 2)?'checked':''; ?> /> &nbsp;$2,000 - $3,000</h3><br/>
            <h3 style="display:inline;">
            <input type="radio" name="down_option" value="3" <?php echo (isset($info['down_option'] )&& $info['down_option'] == 3)?'checked':''; ?> /> &nbsp;$3,000 - $4,000</h3>
            
            </td>
             <td colspan="2" align="center">
            <h3 style="display:inline;">
            <input type="radio" name="payment_option" value="1" <?php echo (isset($info['payment_option'] )&& $info['payment_option'] == 1)?'checked':''; ?> /> &nbsp;$250 - $300</h3><br/>
             <h3 style="display:inline;">
            <input type="radio" name="payment_option" value="2" <?php echo (isset($info['payment_option'] )&& $info['payment_option'] == 2)?'checked':''; ?> /> &nbsp;$350 - $400</h3><br/>
            <h3 style="display:inline;">
            <input type="radio" name="payment_option" value="3" <?php echo (isset($info['payment_option'] )&& $info['payment_option'] == 3)?'checked':''; ?> /> &nbsp;$450 - $500</h3><br/>
            <br/>
            <br/>
