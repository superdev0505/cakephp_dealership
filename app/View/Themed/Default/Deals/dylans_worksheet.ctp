...
?>
		<div class="wraper header"> 
			...
			<!---right1-->
			<div style="border-top: solid 30px black; width: 49.7%; float: left; margin-right: 5px;">
				<label class="box-title" style="margin: -23px 21%;">STOCK #</label>
			</div><img class="border-none"  src="https://dpcrm.s3.amazonaws.com/assets/images/current_market_value_black_image.JPG" width="49.1%">
			<div class="left1" style="height: 200px; ">
				<div>
					<span class="span24">Stock #</span>
					<input name="stock_num"  id="stock_num" type="text" class="input71 tradeDiff" value="<?php echo (!empty($contact['Contact']['stock_num']))? $contact['Contact']['stock_num']  : "0.00" ;   ?>" placeholder=""/>
				</div> 
			</div>
			<!---left1-->
			<div class="right1"">
				<div><span class="span24">TRADE VALUE</span>$
					<input name="trade_value" id="trade_value" style="width: 50%;" type="text" class="input17 tradeDiff" value="<?php echo $contact['Contact']['trade_value']; ?>" placeholder=""/>
				</div>

				<div class="payoff" style="margin: 15% 1px 10%;">
					<span class="span24">PAY OFF</span>$
					<input name="payoff" id="payoff" style="width: 50%;" type="text" class="input17 tradeDiff" value="<?php echo $contact['Contact']['payoff']; ?>" placeholder=""/>
				</div>
			</div>
			<!---left1-->
			<div style="border-top: solid 30px black; width: 49%; float: left; margin-left: 50.3%;">
				<label class="box-title" style="margin: -23px 17%;">MONTHLY PAYMENTS</label>
			</div>

			<div style="border-top: solid 30px black; width: 50%;">
				<label class="box-title" style="margin: -23px 19%;">DOWN PAYMENT</label>
			</div>
			<div class="left1">
