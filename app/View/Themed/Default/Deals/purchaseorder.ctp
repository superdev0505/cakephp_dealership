...
<div class="wraper main" id="worksheet_wraper"  style=" overflow: auto;"> 
	...
	table th, table td{border-right: 1px solid #000; border-bottom: 1px solid #000; padding: 3px; font-size: 14px; text-align: center;}
	table input[type="text"]{border-bottom: 0px;}
	.no-border td, .no-border th{border: 0px; text-align: center;}
	.no-border{border: 0px;}
	.no-border input[type="text"]{border-bottom: 1px solid #000;}
@media print {
