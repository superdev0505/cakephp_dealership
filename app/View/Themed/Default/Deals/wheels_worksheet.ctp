...
@media print { body {font-family: Georgia, ‘Times New Roman’, serif; font-size: 18;} h2 {font-size:18px!important;fontweight:bolder;} h4,h3 {font-size:14px!important;font-weight:bold;padding-top:0px!important;padding:0px!important;} table.set_padding td{padding:1px 2px 0px 6px!important;}
...
?>
		<div class="wraper header">
			...
			<!---left1-->
			<div class="right1"> <span class="span24">County</span>:
				<input name="county" type="text" class="input71" value="<?php echo $contact['Contact']['county']; ?>" placeholder=""/>
				<hr/>
	    ...
	    <span class="span24">MSRP</span>$
				<input name="MSRP"  id="MSRP" type="text" class="input71" value="<?php echo $deal['Deal']['MSRP']; ?>" placeholder=""/>

		<span class="span24">Discount</span>$
				<input name="Discount"  id="Discount" type="text" class="input71" value="<?php echo $deal['Deal']['Discount']; ?>" placeholder=""/>
            ...
            <span class="span24">Selling Price</span>$
				...
				<input name="trade_allowance" id="trade_allowance" type="text" class="input71 tradeDiff" value="<?php echo (!empty($contact['Contact']['trade_allowance']))? $contact['Contact']['trade_allowance']  : $contact['Contact']['trade_value'] ;   ?>" placeholder=""/>
				  <span class="span24">Difference</span>$

				<input name="tag_fee" id="tag_tit"type="text" class="input71 priceChange" value="<?php echo (!empty($contact['Contact']['tag_fee']))? $contact['Contact']['tag_fee']  : "0.00" ;   ?>" placeholder=""/><?php ?>

				<!--<span class="span24 noprint">Sales Tax</span>%-->
				<input name="tax_fee" id="tax"type="hidden" class="input70 noprint priceChange" value="<?php echo $contact['Contact']['tax_fee']; ?>" placeholder=""/>

				<span class="span24">Accessories</span>$
				<input name="Accessories" id="Accessories" type="text" class="input70 priceChange" value="<?php echo (!empty($deal['Deal']['Accessories']))? $deal['Deal']['Accessories']  : "0.00" ;   ?>" placeholder=""/>
			...
			<div class="left1" style="height: 266px;">
			...
			<!---left1-->
			<div class="right1" style=" top: -25px; position: relative;height: 266px;">
				<table style="width: 90%;">
					<thead>
						<tr>
							<th width="33%" class="noprint" align="center">APR:</th>
					...
					<tbody>
						<tr id="payment_row_1" class="noprint">
							<td width="33%" align="center" class="noprint"><input name="loan_apr" type="text" id="apr" class="input12" value="" placeholder="" style="width: 83px;"/>
								%</td>
			...
			<?php } ?></select><span id="option1_price_span" class="print_month"><?php echo $selected_months[1]; ?></span> months</td>
							<td width="33%" align="center">$&nbsp;
								...
								<td width="33%" align="center">$&nbsp;
								<input name="option1_additional" id="addtional-1" type="text" class="input20" value="<?php echo $deal['Deal']['option1_additional']; ?>" style="width: 50px;"/>
							</td>
			...
			<?php } ?></select><span id="option2_price_span" class="print_month"><?php echo $selected_months[2]; ?></span> months</td>
							<td width="33%" align="center">$&nbsp;
								...
								<td width="33%" align="center">$&nbsp;
								<input name="option2_additional" id="addtional-2" type="text" class="input20" value="<?php echo $deal['Deal']['option2_additional']; ?>" style="width: 50px;"/>
							</td>
			...
			<?php } ?></select><span id="option3_price_span" class="print_month"><?php echo $selected_months[3]; ?></span> months</td>
							<td width="33%" align="center">$&nbsp;
								...
								<td width="33%" align="center">$&nbsp;
								<input name="option3_additional" id="addtional-3" type="text" class="input20" value="<?php echo $deal['Deal']['option3_additional']; ?>" style="width: 50px;"/>
							</td>
			...
			<?php } ?></select><span id="option4_price_span" class="print_month"><?php echo $selected_months[4]; ?></span> months</td>
							<td width="33%" align="center">$&nbsp;
								...
								<td width="33%" align="center">$&nbsp;
								<input name="option4_additional" id="addtional-4" type="text" class="input20" value="<?php echo $deal['Deal']['option4_additional']; ?>" style="width: 50px;"/>
							</td>
...
$(document).ready(function(){
	...
	function calculate_tax(tax_value){
		...
		var Accessories = parseFloat( $("#Accessories").val() );
		...
		actual_balance = amount + parseFloat(amountIncludingTax) + Accessories + freight+prep+doc+part_serv+tag_tit;
	 ...
	 function calculateMonthWisePayments(){
		...
		$(".price_options").each(function(i){
										index = i+1;
										  ...
										  addval = parseFloat(pay_monthly) + 10;
										  $("#addtional-"+index).val(addval);
										  });
	 	}
