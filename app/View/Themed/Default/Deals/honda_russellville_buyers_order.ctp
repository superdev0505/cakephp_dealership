		...
		<div class="left-right" style="float: left; width: 100% margin: 7px 0;">
			...
			<div class="right" style="float: right; width: 36%;">
				<div class="row" style="float: left; width: 100%; margin: 0;">
					...
					<div class="form-field" style="width: 100%; float: left;">
						<label style="float: left; width: 50%; text-align: right;">Estimated Tax</label>
						<input type="text" name="estimated_tax" class="total_cal blue" id="esp_fee" value="<?php echo isset($info['estimated_tax']) ? $info['estimated_tax'] : ''; ?>" >
					</div>
					<div class="form-field" style="width: 100%; float: left;">
				...
				<div class="row" style="float: left; width: 100%; margin: 7px 0;">
					<div class="form-field" style="width: 100%; float: left;">
						...
						<input type="text" class="red" id="cal_total_credits" class="total_cal" name="total_credits" value="<?php echo isset($info['total_credits']) ? $info['total_credits'] : ''; ?>" style="border-bottom: 1px solid #000; color:red;">
					</div>
				</div>
				<div class="row" style="float: left; width: 100%; margin: 7px 0;">
					<div class="form-field" style="width: 100%; float: left;">
