...
<table><tr><td>
 ...
 <td>INITIAL<br/><input type="text" style="width:70px;" name="suffix" value="<?php echo $info['suffix']; ?>" /></td>
  <td>DOB<br/><input style="font-size:12px; width:80px;" class="dob" type="text" name="dob_data" value="<?php echo isset($info['dob_data']) ? $info['dob_data'] : $info['dob']; ?>" maxlength="8" /></td>
   ...
   <td>SSN / TAX ID<br/><input type="text" style="width:120px;" name="ss_num" value="<?php echo $info['ss_num']; ?>" class="ssn-num" maxlength="11"/></td>
...
<td>Home Phone<br/><input type="text" style="width:120px;" name="mobile" value="<?php $phone = $info['mobile']; $phone_number = preg_replace('/[^0-9]+/', '', $phone); $cleaned = preg_replace("/([0-9]{3})([0-9]{3})([0-9]{4})/", "($1)-$2-$3", $phone_number); echo $cleaned;  ?>" /></td>
...
<td>Relationship<br/><input type="text" style="width:120px;" name="ref1_type" value="<?php echo $info['ref1_type']; ?>"  /></td>
 ...
 <span class="span60 print_month" style="width:48%;float:left;">
