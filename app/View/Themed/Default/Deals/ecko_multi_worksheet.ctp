 ...
 ?>
         ...
         <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom:10px;">
              <tr>
                <textarea class="notes_class" placeholder="TERMS/NOTES" name="term_notes" id="term_notes" style="width:99.3%; border: 1px solid #000; height: 70px;"><?php echo isset($info['term_notes'])?$info['term_notes']:'' ?></textarea>  
              </tr>
            </table>
...
$(".freight_fee,.prep_fee,.parts_fee,.doc_fee,.tire_wheel_fee").on('change keyup paste',function(){
			data_id=$(this).attr('data-id');
			calculate_tax(data_id);
			calculate_balance(data_id);
			assign_payment(data_id);
...
function calculate_tax(data_id){
		...
		var amount = freight+doc+part_fee+sell_price;
