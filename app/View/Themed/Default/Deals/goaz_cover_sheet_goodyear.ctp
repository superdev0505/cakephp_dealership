               ...
               <table width="100%" border="1">
               		<tr>
                    	<td width="40%;" rowspan="3">
                            ...
                            <label class="small_text"style="width:70%;float:left;">80848</label><br/>
                    ...
                    <tr>
                    	<td width="40%;" rowspan="2" valign="top">
                            ...
                            <label class="small_text" style="width:30%;float:left;">MERCH#</label>
                            <label class="small_text"style="width:70%;float:left;">6035512 771000941</label><br/>
                            <label class="small_text"style="width:100%;float:left;">866-565-7028 - 561-741-4449 - FAX</label>
                    ...
                    <tr>
                    	<td width="40%;" rowspan="2" valign="top">
                        	<label style="width:100%;float:left;">SUN WEST CREDIT UNION</label><br/>
                       
                          
                            <label class="small_text"style="width:100%;float:left;">602-866-1178</label><br/>
                            <label class="small_text"style="width:80%;float:left;">602-866-1161 - FAX</label>
                            <label class="small_text" style="width:20%;float:left;">DECISION</label>
                    ...
                    <tr>
                     ...
                     <tr>
                    	<td width="40%;" rowspan="2" valign="top">
                            ...
                            &nbsp;
                          <br/>
                            <label class="small_text"style="width:70%;float:left;">&nbsp;</label>
                            <label class="small_text" style="width:20%;float:left;">DECISION</label>
                    ...
                    <tr>
                     ...
                     <tr>
                    	<td width="40%;" rowspan="2" valign="top">
                        	<label style="width:80%;float:left;">HELP ME RIDE</label>
                            <label style="width:20%;float:left;">DOUG</label>
                            <br/>
                       
                            <label class="small_text" style="width:80%;float:left;">720-863-4967</label>
                             <label class="small_text" style="width:20%;float:left;">PRUIT</label>
                          <br/>
                            <label class="small_text"style="width:100%;float:left;">866-863-0406  FAX</label>
                    ...
                    <tr>
                    	<td><input type="text" name="18sent1" value="<?php echo isset($info['18sent1'])?$info['18sent1']:''; ?>" style="width:90%;" /> <br/>
                       &nbsp;
                        
                        </td>
                        <td><input type="text" name="18app1" value="<?php echo isset($info['18app1'])?$info['18app1']:''; ?>" style="width:90%;" /> <br/> &nbsp;
                        
                        </td>
                        <td><input type="text" name="18td1" value="<?php echo isset($info['18td1'])?$info['18td1']:''; ?>" style="width:90%;" /> <br/> &nbsp;
