...
?>
		<div class="wraper header"> 
			...
			<div class="left1"> <span class="span24">Name</span>:
				<input name="first_name" id="first_name" type="text" class="input35" value="<?php echo isset($info['first_name'])?$info['first_name']:''; ?>" placeholder=""/>
				<input name="last_name" id="last_name" type="text" class="input35" value="<?php echo isset($info['last_name'])?$info['last_name']:''; ?>" placeholder=""/>
				<hr/>
				<span class="span24">Address</span>:
				<input name="address" type="text" id="address" class="input71" value="<?php echo isset($info['address'])?$info['address']:''; ?>" placeholder=""/>
				<hr/>
				<span class="span71">City:&nbsp;
				<input name="city" type="text" id="city" class="input25" value="<?php echo isset($info['city'])?$info['city']:''; ?>" placeholder=""/>
				State:&nbsp;
				<input name="state" type="text" id="state" class="input20" value="<?php echo isset($info['state'])?$info['state']:''; ?>" placeholder=""/>
				Zip:&nbsp;
				<input name="zip" type="text" id="zip" class="input12" value="<?php echo isset($info['zip'])?$info['zip']:''; ?>" placeholder=""/>
				</span>
				<?php /*?><hr/>
			...
			<div class="right1"> <span class="span24">Home Phone</span>:
				<input name="phone" type="text" id="phone" class="input71" value="<?php echo isset($info['phone'])?$info['phone']:''; ?>" placeholder=""/>
				<hr/>
				<span class="span24">Cell Phone</span>:
				<input name="mobile" type="text" id="mobile" class="input71" value="<?php echo isset($info['mobile'])?$info['mobile']:''; ?>" placeholder=""/>
				<hr/>
				<span class="span24">Email Address</span>:
				<input name="email" type="text" id="email" class="input71" value="<?php echo isset($info['email'])?$info['email']:''; ?>" placeholder=""/>
				<?php /*?><hr/>
			...
			<div class="left1">Condition:&nbsp;
				<input name="condition" type="text" class="input35" value="<?php echo isset($info['condition'])?$info['condition']:''; ?>" placeholder=""/>
				</span> &nbsp;Year:&nbsp;
				<input name="year" type="text" class="input35" value="<?php echo isset($info['year'])?$info['year']:''; ?>" placeholder=""/>
				</span>
				<hr/>
				<span class="span24">Make</span>:
				<input name="make" type="text" class="input71" value="<?php echo isset($info['make'])?$info['make']:''; ?>" placeholder=""/>
				<hr/>
				<span class="span24">Model</span>:
				<input name="model" type="text" class="input71" value="<?php echo isset($info['model'])?$info['model']:''; ?>" placeholder=""/>
				<hr/>
				<span class="span24">Category</span>:
				<input name="type" type="text" class="input71" value="<?php echo isset($info['type'])?$info['type']:''; ?>" placeholder=""/>
			</div>
			<!---left1-->
			<div class="right1"> <span class="span24">Mileage</span>:
				<input name="odometer" type="text" class="input71" value="<?php echo isset($info['odometer'])?$info['odometer']:''; ?>" placeholder=""/>
				<hr/>
				<span class="span24">Color</span>:
				<input name="unit_color" type="text" class="input71" value="<?php echo isset($info['unit_color'])?$info['unit_color']:''; ?>" placeholder=""/>
				<hr/>
				<span class="span24">Vin#</span>:
				<input name="vin" type="text" class="input71" value="<?php echo isset($info['vin'])?$info['vin']:''; ?>" placeholder=""/>
				<hr/>
				<span class="span24">Stock #</span>:
				<input name="stock_num" type="text" value="<?php echo isset($info['stock_num'])?$info['stock_num']:''; ?>" placeholder=""/>
			</div>
			<!---right1-->
			...
			<div class="left1 trade_in" style="width: 33%;"> <span class="span24">Year (Trade)</span>:
				<input name="year_trade" type="text" class="input71" value="<?php echo isset($info['year_trade'])?$info['year_trade']:''; ?>" placeholder=""/>
				<hr/>
			...
			<div class="left1" style="height: 310px; "> 
				...
				<input name="msrp"  id="msrp" type="text" class="input71 tradeDiff" value="<?php echo isset($info['unit_value'])?$info['unit_value']:''; ?>" placeholder=""/>
