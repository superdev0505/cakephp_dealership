...
all claims, demands, loses and expenses, included attorney fees, asserted or incurred by reason of such injury, death, loss or responsibility. This again includes if caused or contributed to by the negligence or other wrongful conduct of any such persons or entities.  </span>
                </div>
                <div class="full">
                <span class="full">These persons and entities include: Del Amo Motorsports, Too Fast Inc.,  local dealer organizing the Ride, all organizations affiliated with them, all sponsors or contributors to the Ride, all governmental agencies involved or assisting with the Ride, all employees, officers, agents or volunteers of all the forgoing, and all other persons  and entities otherwise involved in organizing, operating or assisting with the Ride.  </span>
                </div>
                
                
                <div class="full">
                <span class="full">I(X) <input type="text" style="width:25%"  name="name" value="<?php //echo isset($info['name'])?$info['name']:''; ?>" /> date <input type="text" style="width:14%" class="date_input_field" name="filled_date1" value="<?php echo isset($info['filled_data1'])?$info['filled_data1']:date('m/d/Y'); ?>" /> give this Release and other things in connection with my entire participation in the Ride, whether as a driver, a
passenger or any other capacity. I also give this Release and other things on behalf of, and I agree that they will be binding upon, my heirs, representatives, assigns, dependents and anyone else who might claim a loss on account of anything happening to me. </span>
                </div>
                <div class="page-break"></div>
                <div class="full">
                <span class="full"><strong>I(X) <input type="text" style="width:25%" name="name" value="<?php //echo isset($info['name'])?$info['name']:''; ?>" /> AM RESPONSIBLE FOR ANY DAMAGE TO THE MOTORCYCLE DUE TO RIDER NEGLIGENCE. DEL AMO MOTORSPORTS AND DUCATI WILL SEEK FULL PAYMENT FOR ANY AND ALL DAMAGE TO THE UNIT.</strong></span>
                </div>
...
$cleaned1 = preg_replace("/([0-9]{3})([0-9]{3})([0-9]{4})/", "$1-$2-$3", $phone_number1);
               ...
               <div class="page-break"></div>
               <h1 style="text-decoration:underline;text-align:center;padding-top:15px;">Del Amo Demo Ride Checklist </h1><br/><br/>
              
               
               <h4><strong> 1.IS THIS A BUYING DECISION? IF SO, TWO FORMS OF ID AND TAKE COPY’S</strong></h4>
               <div class="full">
               <label><input type="checkbox" name ="california_licence" value="california_licence" <?php echo (isset($info['california_licence']) && $info['california_licence']=='california_licence')?'checked="checked"':'';  ?> />&nbsp;UNITED STATES ISSUED DRIVERS LICENSE WITH MOTORCYCLE ENDORSEMENT</label><br />
                <label><input type="checkbox" name ="major_card" value="major_card" <?php echo (isset($info['major_card']) && $info['major_card']=='major_card')?'checked="checked"':'';  ?> />&nbsp;MAJOR CREDIT OR DEBIT CARD</label><br />
                 ...
                 <label><input type="checkbox" name ="waiver_form_signed" value="waiver_form_signed" <?php echo (isset($info['waiver_form_signed']) && $info['waiver_form_signed']=='waiver_form_signed')?'checked="checked"':'';  ?> />&nbsp;DEMO WAIVER FORM INITIALED AND SIGNED AND FULLY COMPLETED</label><br />
                  <label><input type="checkbox" name ="explain_demo_route" value="explain_demo_route" <?php echo (isset($info['explain_demo_route']) && $info['explain_demo_route']=='explain_demo_route')?'checked="checked"':'';  ?> />&nbsp;FULLY EXPLAIN DEMO RIDE ROUTE, ASK FOR MAPQUEST</label><br />
                 ...
                 <br/>
              <h4><strong>2. Test Ride Route</strong></h4>  
              <div class="full">
              <?php echo $this->Html->image(FULL_BASE_URL.'/app/webroot/img/orange_county_route_map.png'); ?>
              </div>
