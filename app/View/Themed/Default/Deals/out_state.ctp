...
<div class="wraper main" id="worksheet_wraper"  style=" overflow: auto;"> 
	...
	.second label {float: left; width: 35%; text-align: right;}
@media print {
		...
		<div class="row" style="float: left; width: 100%; margin: 0;">
			<div class="form-left" style="float: left; width: 40%; box-sizing: border-box;">
				<div class="first" style="width: 100%; box-sizing: border-box; border: 1px solid #000; float: left;">
					<h3 class="print_color" style="border-bottom: 1px solid #000; margin: 0; padding: 3px; font-size: 16px; background-color: #7aa2e2 !important;"><b>Added Equipment</b></h3>
					...
					<div class="form-field" style="float: left; width: 100%; margin: 4px 15px;">
						<input type="text" name="asses_option5" value="<?php echo isset($info['asses_option5']) ? $info['asses_option5'] : ''; ?>" style="text-align: center;width: 48%; float: left; margin-right: 15px;">
						<input type="text" id="accessories5" class="price" name="accessories5" value="<?php echo isset($info['accessories5']) ? $info['accessories5'] : ''; ?>" style="width: 40%; float: left;">
					</div>
				</div>
			...
			<!-- right side start -->
			<div class="right-side" style="float: right; width: 56%; margin: 0; margin-bottom: 15px;">
				<div class="first" style="width: 100%; float: left; box-sizing: border-box; border: 1px solid #000;">
					...
					<div class="row" style="float: lefft; width: 100%; margin: 2px 0;">
						<div class="form-field" style="float: let; width: 100%; ">
...
$(document).ready(function(){
	...
	*/
	...
	function calculate_totalinvoice() {
		...
		var accessories5 = isNaN(parseFloat( $('#accessories5').val()))?0.00:parseFloat($('#accessories5').val());
		var optional_equipment = accessories1 + accessories2 + accessories3 + accessories4 + accessories5;
		...
		var bal = total + service_contract - cash_down + finance_amt;
