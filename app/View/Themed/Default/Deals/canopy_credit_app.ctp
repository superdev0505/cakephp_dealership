...
h2 {font-size:12px!important;fontweight:bolder;} h4,h3 {font-size:9px!important;font-weight:bold;padding-top:0px!important;padding:0px!important;} table.set_padding td{padding:1px 2px 0px 6px!important;}
...
table.set_padding td
{
	padding: 8px 5px 0px 14px;!important;
 ...
 @page
    {
        ...
        margin: 7mm 7mm 1mm 7mm ;  /* his affects the margin in the printer settings */
    }
}
</style>
<?php
 if($edit){?>
	...
	<div class="wraper header">
        ...
        <table class="main_width no_padding">
            <tr>
                <td rowspan="3" style="vertical-align:middle;width:15%;"><h4 style="text-align:center; vertical-align:middle;">Check Appropriate Box</h4>
                </td>
                <td><input type="checkbox" name="individual_credit" value="yes" <?php echo (isset($info['individual_credit'])&&$info['individual_credit']=='yes')?'checked="checked"':''; ?> />&nbsp; If you are applying for individual credit in your own name and are relying on your own income or assets and not the income and assets of another person as the basis for repayment of the credit requested, complete Section A.
                </td>
            </tr>
            <tr>
                <td><input type="checkbox" name="married_and_community" value="yes" <?php echo (isset($info['married_and_community'])&&$info['married_and_community']=='yes')?'checked="checked"':''; ?> />&nbsp; If you are married and live in a community property state, complete all Sections including Section B providing information about your spouse.
                </td>
            </tr>
            <tr>
                <td><input type="checkbox" name="joint_credit" value="yes" <?php echo (isset($info['joint_credit'])&&$info['joint_credit']=='yes')?'checked="checked"':''; ?>  />&nbsp; If this is an application for joint credit with another person, complete all Sections providing information in Section B about the co-applicant. 
                </td>
            </tr>
        </table>
        ...
        <table style="width:99%">
            <tr>
                <td width="82.1%">
    		       <h4 style="text-align:center;padding:10px;">NOTE: APPLICANT, IF MARRIED, MAY APPLY FOR A SEPARATE ACCOUNT</h4>
                </td>
            </tr>
        </table>
        ...
        <table bordercolor="#CCCCCC" border="1" class="main_width set_padding" >
            <tr>
                <td>SELLER<br  />
                    <input type="text" style="width:460px;" name="sperson" value="<?php echo $info['sperson']; ?>" /></td>
                <td>Email<br  />
                <input class="email" type="text" style="width:276px;" name="email" value="<?php echo $info['email']; ?>" /></td>
                <td>DATE<br /><input type="text" style="width:253px;" name="created" value="<?php echo date('Y-m-d'); ?>" /></td>
            </tr>
        </table>
            ...
            <tr>
                <td>
                    <table border="1" bordercolor="#CCCCCC" class="main_width set_padding" >
                        <tr>
                            <td>LAST NAME <br/><input type="text" style="width:130px;" class="text_captialize" name="last_name" value="<?php echo $info['last_name']; ?>" />
                            </td>
                            <td>FIRST NAME<br/><input type="text" style="width:130px;" name="first_name" class="text_captialize" value="<?php echo $info['first_name']; ?>" />
                            </td>
                            <td>INITIAL<br/><input type="text" style="width:70px;" name="suffix" value="<?php echo $info['suffix']; ?>" />
                            </td>
                            <td>DOB<br/><input style="font-size:12px; width:80px;" class="dob" type="text" name="dob_data" value="<?php echo isset($info['dob_data']) ? $info['dob_data'] : $info['dob']; ?>" maxlength="8" />
                            </td>
	                        <td>DRIVER LICENSE#<br/><input type="text" style="width:140px;" name="driver_lic" value="<?php echo !empty($info['driver_lic'])?$info['driver_lic']:''; ?>" />
                            </td>
                            <td>SSN / TAX ID<br/><input type="text" style="width:120px;" name="ss_num" value="<?php echo $info['ss_num']; ?>" class="ssn-num" maxlength="11"/>
                            </td>
                            <td>Age of <br />Dependants<br/><input type="text" style="width:120px;" name="age_of_dependants" value="<?php echo $info['age_of_dependants']; ?>" />
                            </td>
                            <td><input type="radio" name="martial_status" value="Married" <?php echo (isset($info['martial_status'])&&$info['martial_status']=='Married')?'checked="checked"':''; ?> /> &nbsp;Married<br/><input type="radio" name="martial_status" value="Unmarried" <?php echo (isset($info['martial_status'])&&$info['martial_status']=='Separated')?'checked="checked"':''; ?>  /> &nbsp;Unmarried<br/><input type="radio" name="martial_status" Unmarried value="Separated" /> &nbsp;Separated
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">Address<br/><input type="text" style="width:272px;" name="address" value="<?php echo $info['address']; ?>"  />
                            </td>
                            <td>City<br/><input type="text" style="width:80px;" name="city" value="<?php echo $info['city']; ?>" />
                            </td>
                            <td>State<br/><input type="text" style="width:80px;" name="state" value="<?php echo $info['state']; ?>" />
                            </td>
                            <td>Zip<br/><input type="text" style="width:140px;" name="zip" value="<?php echo $info['zip']; ?>" />
                            </td>
                            <td>Home Phone<br/><input type="text" style="width:120px;" name="mobile" value="<?php $phone = $info['mobile']; $phone_number = preg_replace('/[^0-9]+/', '', $phone); $cleaned = preg_replace("/([0-9]{3})([0-9]{3})([0-9]{4})/", "($1)-$2-$3", $phone_number); echo $cleaned;  ?>" />
                            </td>
                            <td colspan="2">HOW LONG AT ADDRESS?<br/><input type="text" style="width:100px;" name="residence_length" value="<?php echo $info['residence_length']; ?>" />YRS
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" style="width:25%">PREVIOUS ADDRESSES (TO COVER 5 YRS RESIDENCE)<br/><input type="text" style="width:272px;" name="address2" value="<?php echo $info['address2']; ?>" />
                            </td>
                            <td>City<br/><input type="text" style="width:80px;" name="city2" value="<?php echo $info['city2']; ?>" />
                            </td>
                            <td>State<br/><input type="text" style="width:80px;" name="state2" value="<?php echo $info['state2']; ?>" />
                            </td>
                            <td>Zip<br/><input type="text" style="width:140px;" name="zip2" value="<?php echo $info['zip2']; ?>" />
                            </td>
                            <td>How Long ?<br/>
                        ...
                        <tr>
                            <td colspan="2"><input type="text" style="width:272px;" name="address3" value="<?php echo $info['address3']; ?>" />
                            </td>
                            <td>City<br/><input type="text" style="width:80px;" name="city3" value="<?php echo $info['city3']; ?>" />
                            </td>
                            <td>State<br/><input type="text" style="width:80px;" name="state3" value="<?php echo $info['state3']; ?>" />
                            </td>
                            <td>Zip<br/><input type="text" style="width:140px;" name="zip3" value="<?php echo $info['zip3']; ?>" />
                            </td>
                            <td>How Long ?<br/>
                        ...
                        <tr>
                            <td colspan="2">PRESENT EMPLOYER<br /><input type="text" style="width:272px;" name="employer" value="<?php echo $info['employer']; ?>" />
                            </td>
                            <td colspan="2">OCCUPATION OR RANK<br /><input type="text" style="width:160px;" name="main_job" value="<?php echo $info['main_job']; ?>" />
                            </td>
                            <td colspan="2">DEPARTMENT OR BADGE NO.<br /><input type="text" style="width:275px;" name="department"  value="<?php echo $info['department']; ?>" />
                            </td>
                        ...
                        <tr>
                            <td colspan="2">PRESENT EMPLOYER'S ADDRESS<br /><input type="text" style="width:272px;" name="employer_address" value="<?php echo $info['employer_address']; ?>" /></td>
                    ...
                    <tr>
                        <table bordercolor="#CCCCCC" border="1" class="main_width set_padding">
                        <tr>
                            <td style="width:25%">PREVIOUS EMPLOYMENT (TO COVER 5 YEAR HISTORY)<br /><input type="text" style="width:220px;" name="previous_employer" value="<?php echo $info['previous_employer']; ?>" />
                            </td>
                    ...
                    <tr>
                        <td>&nbsp;<br /><input type="text" style="width:220px;" name="previous_employer2" value="<?php echo $info['previous_employer2']; ?>" />
                        </td>
                    ...
                    <tr>
                        <td style="width:25%">NEAREST RELATIVE NOT LIVING WITH YOU<br /><input type="text" style="width:220px;" name="ref1_name" value="<?php echo $info['ref1_name']; ?>"  /></td>
 ...
 <div class="full zero_padding">
    ...
    <span class="full zero_padding">
        <table style="width:100%" class="mid_width no_padding">
            <tr>
                <td>Applicant's Gross Monthly Income from Employment</td>
                <td></td>
                <td align="right" style="width: 16%;">$<input type="text" style="width:120px;" name="income_monthly1"  class="bottom_border grossincome1" value="<?php echo isset($info['income_monthly1']) ? $info['income_monthly1'] : ""; ?>" /></td>
            </tr>
            <tr>
                ...
                <td></td>
                <td align="right" style="width: 16%;">$<input type="text" style="width:120px;" name="income_monthly2" value="<?php echo isset($info['income_monthly2']) ? $info['income_monthly2'] : ""; ?>"  class="grossincome1 bottom_border" /></td>
            </tr>
            <tr>
                ...
                <td align="right" style="width:16%" >$<input type="text" style="width:120px;" name="other_income2" value="<?php echo isset($info['other_income2']) ? $info['other_income2'] : ""; ?>"  class="grossincome1 bottom_border"  /></td>
            </tr>
            <tr>
                <td>Amount of other Monthly Income and Source(s)</td><td></td>
                <td align="right" style="width:16%" >$<input type="text" style="width:120px;" name="other_income" value="<?php echo isset($info['other_income']) ? $info['other_income'] : ""; ?>"  class="grossincome1 bottom_border"  /></td>
            </tr>
            <tr>
                <td></td><td style="width: 14%;"><strong>TOTAL MONTHLY INCOME</strong></td>
                <td align="right" style="width:16%" >$<input type="text" style="width:120px;" name="total_monthly"  value="<?php echo $info['total_monthly']; ?>" id="totalincome1" /></td>
            </tr>
        </table>
    </span>
</div>
    <span class="span60 print_month" style="width:48%;float:left;">PURCHASER HEREBY ACKNOWLEDGES RECEIPT OF A COPY OF THIS CREDIT STATEMENT<br />
        <input type="text" class="bottom_border" style="width:99%" /><br/>
             APPLICANT'S SIGNATURE

    </span>
    <span class="span60 print_month" style="width:46%;float:left;">
    ...
    <table>
        <tr>
            <td>
                <table border="1" bordercolor="#CCCCCC" class="main_width set_padding">
                    <tr>
                        <td>LAST NAME <br/><input type="text" style="width:130px;" name="cobuyer_lname" value="<?php echo $info['cobuyer_lname']; ?>" /></td>
                    ...
                    <tr>
                        <td colspan="2">Address<br/><input type="text" style="width:272px;" name="cobuyer_address" value="<?php echo $info['cobuyer_address']; ?>" /></td>
                    ...
                    <tr>
                        <td colspan="2" style="width:25%">PREVIOUS ADDRESSES (TO COVER 5 YRS RESIDENCE)<br/><input type="text" style="width:272px;" name="co_address" value="<?php echo $info['co_address']; ?>" /></td>
                    ...
                    <tr>
                        <td colspan="2"><input type="text" style="width:272px;" name="co_address2" value="<?php echo $info['co_address2']; ?>" /></td>
                ...
                <tr>
                    <td colspan="2">PRESENT EMPLOYER<br /><input type="text" style="width:272px;" name="cobuyer_employer" value="<?php echo $info['cobuyer_employer']; ?>" /></td>
                ...
                <tr>
                    <td colspan="2">PRESENT EMPLOYER'S ADDRESS<br /><input type="text" style="width:272px;" name="cobuyer_employer_address" value="<?php echo $info['cobuyer_employer_address']; ?>" /></td>
                ...
                <tr>
                    <table bordercolor="#CCCCCC" border="1" class="main_width set_padding">
                <tr>
                    <td style="width:25%">PREVIOUS EMPLOYMENT (TO COVER 5 YEAR HISTORY)<br /><input type="text" style="width:220px;" name="co_previous_employer" /></td>
                ...
                <tr>
                    <td>&nbsp;<br /><input type="text" style="width:220px;" name="co_previous_employer2" value="<?php echo $info['co_previous_employer2']; ?>" />
                    </td>
            ...
            <tr>
                <td style="width:25%">NEAREST RELATIVE NOT LIVING WITH YOU<br /><input type="text" style="width:220px;" name="co_ref_name" value="<?php echo $info['co_ref_name']; ?>" /></td>
    ...
    <span class="full zero_padding">
        <table style="width:100%" class="mid_width no_padding">
            <tr>
                ...
                <td align="right" style="width:16%;">$<input type="text" style="width:120px;" name="cobuyer_income_monthly2" value="<?php echo isset($info['cobuyer_income_monthly2']) ? $info['cobuyer_income_monthly2'] : ""; ?>"   class="grossincome2 bottom_border"  /></td>
            </tr>
            <tr>
                ...
                <td align="right" style="width:16%;">$<input type="text" style="width:120px;" name="cobuyer_monthly_mortgage" value="<?php echo isset($info['cobuyer_monthly_mortgage']) ? $info['cobuyer_monthly_mortgage'] : "0.00"; ?>"   class="grossincome2 bottom_border" /></td>
            </tr>
            ...
            <tr>
                ...
                <td align="right" style="width:15%;">$<input type="text" style="width:120px;" name="cobuyer_monthly_mortgage2" value="<?php echo isset($info['cobuyer_monthly_mortgage2']) ? $info['cobuyer_monthly_mortgage2'] : ""; ?>"  class="grossincome2 bottom_border" /></td>
            </tr>
        <tr>
            <td>Amount of other Monthly Income and Source(s)</td><td></td>
            <td align="right" style="width:16%;">$<input type="text" style="width:120px;" name="cobuyer_other_monthly" value="<?php echo isset($info['cobuyer_other_monthly']) ? $info['cobuyer_other_monthly'] : ""; ?>"   class="grossincome2 bottom_border"  /></td>
        </tr>
        <tr>
            <td></td>
            <td style="width: 14%;"><strong>TOTAL MONTHLY INCOME</strong></td>
            <td align="right">$<input type="text" style="width:120px;" name="cobuyer_total_monthly" value="<?php echo isset($info['cobuyer_total_monthly']) ? $info['cobuyer_total_monthly'] : ""; ?>"   id="totalincome2" /></td>
        </tr>
    </table>
    </span>
 </div>

 <h4 style="text-align:left;padding-top:8px;">
    <strong>SECTION C:</strong>Applicant References
</h4>
 <table  bordercolor="#CCCCCC" border="1" class="main_width set_padding">
    <tr>
        <td>PERSONAL FRIENDS KNOWN OVER ONE YEAR<br />1. &nbsp;<input type="text" style="width:292px;" name="ref2_name" value="<?php echo $info['ref2_name']; ?>" /></td>
    ...
    <tr>
        <td>&nbsp;<br />2. &nbsp;<input type="text" style="width:292px;" name="ref3_name" value="<?php echo $info['ref3_name']; ?>" /></td>
...
<span class="span60" style="width:48%">
    ...
    <p align="center" style="padding-top:10px;">Date / Time - <?php echo date('M d, Y h:i A'); ?>
    </p>
...
$(document).ready(function(){
 ...
 function convertFormatedMoney (money){
	...
	$('input.grossincome1').on('keyup',function(){
	...
	$('input.grossincome2').on('keyup',function(){
	...
	$(".grossincome1").on('keyup',function(){

		var valdata = 0;
		$( ".grossincome1" ).each(function( index )
		{
			totalcount = $(this).val();
		...
		//alert(valdata);
		$("#totalincome1").val(convertFormatedMoney(valdata.toString()));
	});

	$(".grossincome2").on('keyup',function(){

		var valdata = 0;
		$( ".grossincome2" ).each(function( index )
		{
			totalcount = $(this).val();
			totalcount = totalcount.replace(/,/g, '');
			//alert(totalcount);
		...
		//alert(valdata);
		$("#totalincome2").val(convertFormatedMoney(valdata.toString()));
	});
    ...
    $('.ssn-num').on('change keyup paste', function() {
        var num = $(this).val();
        num = num
            .replace(/[^0-9]+/g, '')
            .replace(/([0-9]*)([0-9]{4})$/, '$1-$2')
            .replace(/([0-9]*)([0-9]{2}\-[0-9]{4})$/, '$1-$2');
        $(this).val(num);
    });
