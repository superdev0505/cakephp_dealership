	...
	<div class="wraper header">
		<div class="row" style="float: left; width: 100%; margin: 3px 0;">
			...
			<div class="right" style="width: 50%; float: right;">
				<h2 style="float: left; width: 100%; margin: 5px 0; font-size: 20px;">MARINE PURCHASE AGREEMENT</h2>
		...
		<div class="cover" style="width: 100%; float: left; border: 1px solid #000; box-sizing: border-box; padding: 10px; border-radius: 7px; margin: 7px 0;">
			<div class="row" style="float: left; width: 100%; margin: 3px 0;">
				<div class="form-field" style="float: left; width: 30%;">
					<label>STOCK#</label>
					<input type="text" name="stock_num" value="<?php echo isset($info['stock_num'])?$info['stock_num']:''; ?>" style="width: 77%;">
				</div>
				...
				<div class="form-field" style="float: left; width: 28%;">
					<label>HOURS</label>
					<input type="text" name="hours" value="<?php echo isset($info['hours'])?$info['hours']:''; ?>" style="width: 77%;">
				</div>
			</div>
			...
			<div class="row" style="float: left; width: 100%; margin: 3px 0;">
				<div class="form-field" style="float: left; width: 40%;">
					...
					<input type="text" name="motor_make" value="<?php echo isset($info['motor_make'])?$info['motor_make']:''; ?>" style="width: 70%;">
				</div>
				<div class="form-field" style="float: left; width: 60%;">
					<label>MODEL</label>
					<input type="text" name="motor_model" value="<?php echo isset($info['motor_model'])?$info['motor_model']:''; ?>" style="width: 88%;">
				</div>
			</div>
			
			<div class="row" style="float: left; width: 100%; margin: 3px 0;">
				<div class="form-field" style="float: left; width: 100%;">
					<label>TRAILER DESCRIPITION</label>
					<input type="text" name="trailer" value="<?php echo isset($info['trailer'])?$info['trailer']:''; ?>" style="width: 81%;">
				</div>
			</div>	
		</div>
		...
		<div class="cover" style="width: 100%; float: left; border: 1px solid #000; box-sizing: border-box; padding: 10px; border-radius: 7px; margin: 7px 0;">
			<div class="row" style="float: left; width: 100%; margin: 3px 0;">
				<div class="form-field" style="float: left; width: 40%;">
					<label>BOAT MAKE</label>
					<input type="text" name="boat_make1" value="<?php echo isset($info['boat_make1'])?$info['boat_make1']:''; ?>" style="width: 74%;">
				</div>
				<div class="form-field" style="float: left; width: 60%;">
					<label>MODEL</label>
					<input type="text" name="boat_model1" value="<?php echo isset($info['boat_model1'])?$info['boat_model1']:''; ?>" style="width: 89%;">
				</div>
			</div>
			...
			<div class="row" style="float: left; width: 100%; margin: 3px 0;">
				<div class="form-field" style="float: left; width: 40%;">
					<label>MOTOR MAKE</label>
					<input type="text" name="motor_make1" value="<?php echo isset($info['motor_make1'])?$info['motor_make1']:''; ?>" style="width: 70%;">
				</div>
				<div class="form-field" style="float: left; width: 36%;">
					<label>MODEL</label>
					<input type="text" name="motor_model1" value="<?php echo isset($info['motor_model1'])?$info['motor_model1']:''; ?>" style="width: 81%;">
				</div>
				<div class="form-field" style="float: left; width: 24%;">
					<label>HOURS</label>
					<input type="text" name="motor_hours1" value="<?php echo isset($info['motor_hours1'])?$info['motor_hours1']:''; ?>" style="width: 72%;">
				</div>
			</div>
			...
			<div class="row" style="float: left; width: 100%; margin: 3px 0;">
				<div class="form-field" style="float: left; width: 100%;">
					<label>TRAILER DESCRIPITION</label>
					<input type="text" name="trailer1" value="<?php echo isset($info['trailer1'])?$info['trailer1']:''; ?>" style="width: 81%;">
				</div>
			</div>
		</div>
		...
		<div class="row" style="float: left; width: 100%; margin: 0px;">
			<div class="left" style="float: left; width: 48%;">
				<div class="cover" style="width: 100%; float: left; border: 1px solid #000; box-sizing: border-box; padding: 10px; border-radius: 7px; margin: 7px 0;">
					<table cellpadding="0" cellspacing="0" width="100%">
						<tr>
							<td style="width: 80%;"><b style="width: 16px;">MARINE ON THE WATER PACKAGE</b></td>
							<td style="width: 20%; text-align: right;"><b style="width: 16px;"><input type="text" class="price" id="water_package" name="water_package" value="<?php echo isset($info['water_package'])?$info['water_package']: '699.00'; ?>" style="width: 100%; font-size: 15px; font-weight: 700;"></b></td>
						</tr>
						
						<tr>
							<td style="width: 80%;"><p style="margin: 0; font-size: 12px;">Includes: Pre delivery inspection, motor mounting & hook up, motor runup, vessel numbers, interior & exterior detailing, orientation and show through on delivery.</p></td>
							<td style="width: 20%; text-align: right;">&nbsp;</td>
						</tr>
						
						<tr>
							<td style="width: 80%;"><b style="width: 16px;">MARINE BATTERY INSTALLED</b></td>
			...
			<div class="center" style="width: 4%; float: left; margin: 100px 0 0 0;">
				<img class="arrow" src="<?php echo ('/app/webroot/files/dealer_name/dealer_logo/'.$cid.'/arrow.png'); ?>" alt="" style="width: 100%; height: 495px;">
			</div>
...
$(document).ready(function(){
	...
	*/
	...
	$(".price").on('change keyup paste', function(){
		...
		var total_option = water_package + battery_install + spare_tire + price1 + price2 +price3 + price4 + price5 + price6 + price7 + price8 + price9 + price10 + price11 + price12 + price13 + price14 + price15 + price16 + wire;
