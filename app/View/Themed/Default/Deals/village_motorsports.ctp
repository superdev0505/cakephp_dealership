	...
	<div class="wraper header">
		<div class="row" style="float: left; width: 100%; margin: 0; border-bottom: 1px solid #000;">
			<div class="left" style="float: left; width: 75%; margin: 0; border-right: 1px solid #000; box-sizing: border-box; padding: 14px;">			
				...
				<div class="address1" style="float: left; width: 23%; margin: 0;">
				...
				<div class="address2" style="float: left; width: 21%; margin: 0 0 0 2%;">
					<p style="font-size: 14px; margin: 0;">
		...
		<table cellpadding="0" cellspacing="0" width="100%" style="margin: 0; float: left; margin: 0;">
			...
			<tr>
				<td style="width: 70%; text-align: right;">Sales Tax</td>
				<td><input type="text" id="sales" class="price_value" name="sales" value="<?php echo isset($info['sales'])?$info['sales']: ''; ?>" style="width: 100%;"></td>
			</tr>
			<tr>
...
$(document).ready(function(){
	...
	*/
	...
	function calculate_total() {
       ...
       total_sales = (cash_price + freight + access + labor + tax)*6/100;
       total_price = cash_price + freight +	assembly + access + tax + warrenty + total_sales + license + labor;
       $("#sales").val(total_sales.toFixed(2));
