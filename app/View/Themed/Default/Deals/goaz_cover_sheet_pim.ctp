...
<div class="wraper main" id="worksheet_wraper"  style=" overflow: auto;"> 
	...
	@media print { 
		...
		input[type=text]{border:none;border-bottom:1px solid #000;height:17px;}
               ...
               <table width="100%" border="1">
               		<tr>
                    	<td width="40%;" rowspan="2">
                        	<label style="width:100%;float:left;">BMW FINANCIAL</label><br/>
                            <label class="small_text" style="width:100%;float:left;">877-269-3577</label>
                            <br/>
                            <label class="small_text" style="width:30%;float:left;">MERCH#</label>
                            <label class="small_text"style="width:25%;float:left;">&nbsp;</label>
                            <label class="small_text" style="width:45%;float:left;">Dealer # 41206</label><br/>
                            <label class="small_text"style="width:45%;float:left;">800</label>
                            <label class="small_text" style="width:100%;float:left;">800-776-4269 FAX</label><br/>
                    ...
                    <tr>
                    	<td><input type="text" name="sent1" value="<?php echo isset($info['sent1'])?$info['sent1']:''; ?>" style="width:90%;" /> 
                        </td>
                        <td><input type="text" name="app1" value="<?php echo isset($info['app1'])?$info['app1']:''; ?>" style="width:90%;" /> 
                        
                        </td>
                        <td><input type="text" name="td1" value="<?php echo isset($info['td1'])?$info['td1']:''; ?>" style="width:90%;" /> 
                    ...
                    <tr>
                    	<td width="40%;" rowspan="2" valign="top">
                        	<label style="width:100%;float:left;">FREEDOMROAD FINANCIAL</label><br/>
                       
                            <label class="small_text" style="width:50%;float:left;">866-455-7623</label>
                            <label class="small_text"style="width:50%;float:left;">Dealer # 1277680</label><br/>
                            <label class="small_text"style="width:70%;float:left;">866-450-4348 FAX</label>
                            <label class="small_text" style="width:20%;float:left;">Triumph # 451214</label>
                            
                        </td>
                        <td width="40%;" rowspan="2" valign="top">
                        	  <label style="width:100%;float:left;">INS. REQ. </label><br/>                             <span class="small_text" style="width:30%;float:left;">CREDIT LINE</span>
                              <input type="text" name="credit_line5" value="<?php echo isset($info['credit_line5'])?$info['credit_line5']:''; ?>" style="width:68%;float:left;" /> <br />
                              <span class="small_text" style="width:30%;float:left;">TIER</span>
                              <input type="text" name="tier2" value="<?php echo isset($info['tier2'])?$info['tier2']:''; ?>" style="width:68%;float:left;" /> 
                    ...
                    <tr>
                       ...
                       &nbsp;
                        ...
                        <tr>
                    	<td width="40%;" rowspan="2" valign="top">
                        	<label style="width:65%;float:left;">DUCATI FINANCIAL</label>
                            <label style="width:35%;float:left;">Dealer # 109131</label>
                            <br/>
                       
                            <label class="small_text" style="width:100%;float:left;">855-382-2847
</label>
                          <br/>
                            <label class="small_text"style="width:70%;float:left;">888-879-2834 FAX</label>
                    ...
                    <tr>
                     ...
                     <tr>
                    	<td width="40%;" rowspan="2" valign="top">
                        	<label style="width:100%;float:left;">MB FINANCIAL</label><br/>
                       
                            <label class="small_text" style="width:50%;float:left;">847-653-2223 / JAKE</label>
                            <label class="small_text" style="width:50%;float:left;">C.S./ 888-422-6562</label>
                          <br/>
                            <label class="small_text"style="width:100%;float:left;"> 800-832-0125 FAX</label>
                    ...
                    <tr>
                     ...
                     <tr>
                    	<td width="40%;" rowspan="2" valign="top">
                        	<label style="width:100%;float:left;">BLUE FEDERAL CREDIT UNION</label><br/>
                       
                            <label class="small_text" style="width:100%;float:left;">307-996-1120</label>
                          <br/>
                    ...
                    <tr>
                     ...
                     <tr>
                    	<td width="40%;" rowspan="2" valign="top">
                        	<label style="width:100%;float:left;">CREDIT UNION WEST</label><br/>
                       
                            &nbsp;
                          <br/>
                            <label class="small_text"style="width:50%;float:left;">602-631-3290</label>
                            <label class="small_text" style="width:50%;float:left;">CONTACT SATINA / HAI</label><br/>
                            <label class="small_text"style="width:100%;float:left;">602-749-2942 FAX</label>
                    ...
                    <tr>
                    	<td width="40%;" rowspan="2">
                        	<label style="width:100%;float:left;">THUNDERROAD FINANCIAL</label><br/>
                            <label class="small_text" style="width:50%;float:left;">775-332-1965 </label>
                            <label class="small_text" style="width:50%;float:left;">GOAZWEST</label>
                            <br/>
                            <label class="small_text" style="width:75%;float:left;">775-384-2883 FAX</label>
                    ...
                    <tr>
                    	<td width="40%;" rowspan="2" valign="top">
                        	<label style="width:100%;float:left;">SUNWEST FEDERAL CREDIT UNION</label><br/>
                       
                            <label class="small_text" style="width:100%;float:left;">602-993-2993</label>
                          <br/>
                            <label class="small_text"style="width:100%;float:left;">602-866-1143 FAX</label>
                    ...
                    <tr>
                     ...
                     <tr>
                    	<td width="40%;" rowspan="2" valign="top">
                            ...
                            <label class="small_text" style="width:100%;float:left;">520-806-8701</label>
                          <br/>
                            <label class="small_text"style="width:100%;float:left;">520-292-9289 FAX</label>
                    ...
                    <tr>
                    	<td><input type="text" name="8sent1" value="<?php echo isset($info['11sent1'])?$info['11sent1']:''; ?>" style="width:90%;" /> <br/>
                       &nbsp;
                     ...
                     <tr>
                    	<td width="40%;" rowspan="2" valign="top">
                        	<label style="width:100%;float:left;">DEER VALLEY CREDIT UNION</label><br/>
                       
                            <label class="small_text" style="width:100%;float:left;">602-375-7319
</label>
                          <br/>
                            <label class="small_text"style="width:100%;float:left;">602-375-7333 FAX
</label>
                    ...
                    <tr>
                    	<td width="40%;" rowspan="2" valign="top">
                        	<label style="width:100%;float:left;">AL FINANCIAL EIN # 953191434</label><br/>
                       
                            <label class="small_text" style="width:100%;float:left;">602-678-0400</label>
                          <br/>
                            <label class="small_text"style="width:80%;float:left;">602-678-1919 FAX</label>
                    ...
                    <tr>
                    	<td width="40%;" rowspan="2" valign="top">
                            ...
                            <label class="small_text" style="width:100%;float:left;">602-789-0712
</label>
                        ...
                        <td width="40%;" rowspan="2" valign="top">
                             ...
                             <span class="small_text" style="width:30%;float:left;">CREDIT LINE</span>
                              <input type="text" name="32credit_line5" value="<?php echo isset($info['32credit_line5'])?$info['32credit_line5']:''; ?>" style="width:68%;float:left;" />
                    ...
                    <tr>
                    	<td><input type="text" name="12sent1" value="<?php echo isset($info['13sent1'])?$info['13sent1']:''; ?>" style="width:90%;" /> 
                        
                        </td>
                        <td><input type="text" name="13app1" value="<?php echo isset($info['13app1'])?$info['13app1']:''; ?>" style="width:90%;" />  
                        
                        </td>
                        <td><input type="text" name="13td1" value="<?php echo isset($info['13td1'])?$info['13td1']:''; ?>" style="width:90%;" /> 
                    ...
                    <tr>
                    	<td width="40%;" rowspan="2" valign="top">
                        	<label style="width:100%;float:left;">SPRING LEAF
</label><br/>
                       
                            <label class="small_text" style="width:100%;float:left;">602-298-9436
</label><br/>
 <label class="small_text" style="width:75%;float:left;">602-298-9440 FAX</label>
<label class="small_text" style="width:75%;float:left;">FAX APP</label>
                    ...
                    <tr>
                    	<td><input type="text" name="14sent1" value="<?php echo isset($info['14sent1'])?$info['14sent1']:''; ?>" style="width:90%;" /> <br/>
                       &nbsp;
                        
                        </td>
                        <td><input type="text" name="14app1" value="<?php echo isset($info['14app1'])?$info['14app1']:''; ?>" style="width:90%;" /> <br/> &nbsp;
                        
                        </td>
                        <td><input type="text" name="14td1" value="<?php echo isset($info['14td1'])?$info['14td1']:''; ?>" style="width:90%;" /> <br/> &nbsp;
