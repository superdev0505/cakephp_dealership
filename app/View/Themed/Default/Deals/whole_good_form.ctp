...
@media print { body {font-family: Georgia, ‘Times New Roman’, serif;} h2 {font-size:12px!important;fontweight:bolder;} h4,h3 {font-size:9px!important;font-weight:bold;padding-top:0px!important;padding:0px!important;} table.set_padding td{padding:1px 2px 0px 6px!important;}
	...
	<div class="wraper header"> 
      ...
      <tr>
        <td style="color:#000; font-size:14px; padding:10px 0;">  PRODUCT 2: <input  value="<?php echo isset($info['product2']) ? $info['product2'] : $addonVehicles[0]['AddonVehicle']['year'].','.$addonVehicles[0]['AddonVehicle']['make'].','.$addonVehicles[0]['AddonVehicle']['model']; ?>"  name="product2" type="text" class="dte_fm3" />  STOCK # 2: <input name="pr2_stock" value="<?php echo isset($info['pr2_stock']) ? $info['pr2_stock'] : $addonVehicles[0]['AddonVehicle']['stock_num']; ?>" type="text" class="dte_fm" /> </td>
      </tr>
      
      <tr>
        <td style="color:#000; font-size:14px; padding:10px 0;">  Vin 2: <input  value="<?php echo isset($info['vin2']) ? $info['vin2'] : $addonVehicles[0]['AddonVehicle']['vin']; ?>"  name="vin2" type="text" class="dte_fm3" /></td>
      </tr>
      
      <tr>
        <td style="color:#000; font-size:14px; padding:10px 0;">  PRODUCT 3: <input  value="<?php echo isset($info['product3']) ? $info['product3'] : $addonVehicles[1]['AddonVehicle']['year'].','.$addonVehicles[1]['AddonVehicle']['make'].','.$addonVehicles[1]['AddonVehicle']['model']; ?>"  name="product3" type="text" class="dte_fm3" />  STOCK # 3: <input name="pr3_stock" value="<?php echo isset($info['pr2_stock']) ? $info['pr2_stock'] : $addonVehicles[1]['AddonVehicle']['stock_num']; ?>" type="text" class="dte_fm" /> </td>
      </tr>
      
      <tr>
        <td style="color:#000; font-size:14px; padding:10px 0;"> Vin 3: <input  value="<?php echo isset($info['vin3']) ? $info['vin3'] : $addonVehicles[1]['AddonVehicle']['vin']; ?>"  name="vin3" type="text" class="dte_fm3" /></td>
      </tr>
    </table>
