				...
				<div align="center" style="margin-top: 20px;">
					...
					<h3>
                     ...
                     <a href="#" id="calculateDown" class="btn btn-info pull-left noprint" style="margin-left:10px;">Calulate Down</a>
						<input name="down_payment" id="down_pay" type="text" class="input15 tradeDiff"   placeholder=""/>
					</h3>
					<span id='errorForDownPay'></span> </div>
			</div>
			<!---left1-->
			<div class="right1" style=" top: -25px; position: relative; height: 285px;">
				<table style="width: 80%;">
					<thead>
						<tr>
					...
					<tbody>
						<tr>
							<td width="33%" align="center"><input name="loan_apr" type="text" id="apr" class="input12" placeholder="" style="width: 83px;"/>
								%</td>
