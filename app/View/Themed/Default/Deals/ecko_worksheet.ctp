...
?>
		<div class="wraper header"> 
			...
			<div class="left1" style="height: 253px;">
			...
			<!---left1-->
			<div class="right1" style=" top: -22px; position: relative;height: 255px;">
				<table style="width: 80%;">
					<thead>
						<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom:10px;">
			  <tr>
			    <textarea class="notes_class" placeholder="TERMS/NOTES" name="term_notes" id="term_notes" style="width:99.3%; border: 1px solid #000; height: 75px; margin-top: -16px;"><?php echo isset($info['term_notes'])?$info['term_notes']:'' ?></textarea>  
			  </tr>
			</table>
		</div>
		<!---left1-->
