...
input[type="radio"] {position: relative; top: 4px;}
	...
	<div class="wraper header"> 
		...
		<div class="container" style="width: 960px; margin: 0 auto;">
			...
			<div class="left"  style="float: left; width: 30%; margin: 0 0 66px;">
				<strong>Southern Thunder Harley-Davidson</strong>
				<ul style="margin: 0; padding: 0;">
					<li style="border-right: 1px solid #000;">4870 Venture Dr. </li>
			...
			<div class="right" style="float: right;">
				<strong>www.SouthernThunderHD.com</strong>
				<p style="margin: 2px 0; text-align: center;">(662) 349-1099</p>
			</div>
		</div>
