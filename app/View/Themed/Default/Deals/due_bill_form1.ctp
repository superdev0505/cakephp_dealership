  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom:10px;">
    <tr>
      ...
      <td style="width:20%; margin-bottom:10px; padding:2px 0; margin:0 10px;">
        <input name="due_description<?php echo $i; ?>" value="<?php echo (isset($info['due_description'.$i]) && !empty($info['due_description'.$i])) ? $info['due_description'.$i] : $info['description'.$i]; ?>" type="text" class="bill_inp4">
      </td>

      <td style="width:10%; margin-bottom:10px; padding:2px 0; margin:0 10px; ">
        <input name="due_hours<?php echo $i; ?>" id="due_hours<?php echo $i; ?>" value="<?php echo (isset($info['due_hours'.$i]) && !empty($info['due_hours'.$i])) ? $info['due_hours'.$i] : $info['hours'.$i]; ?>"  type="text" class="bill_inp4 currency additional">
      </td>

      <td style="width:10%; margin-bottom:10px; padding:2px 0; margin:0 10px; ">
        <input name="due_rate<?php echo $i; ?>" id="due_rate<?php echo $i; ?>" value="<?php echo (isset($info['due_rate'.$i]) && !empty($info['due_rate'.$i])) ? $info['due_rate'.$i] : $info['rate'.$i]; ?>"  type="text" class="bill_inp4 currency additional">
      </td>
      
      <td style="width:10%; margin-bottom:10px; padding:2px 0; margin:0 10px;">
        <input name="due_price<?php echo $i; ?>" id="<?php echo $i; ?>" value="<?php echo (isset($info['due_price'.$i]) && !empty($info['due_price'.$i])) ? $info['due_price'.$i] : $info['price'.$i]; ?>" type="text" class="bill_inp4 currency price_set">
      </td>
    </tr>
  </table>
<?php } ?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom:10px;">
  <tr>
      <td>
          <textarea placeholder="TERMS / NOTES" name="term_notes" id="term_notes" style="width: 100%; border: 1px solid #000; height: 120px;"><?php echo isset($info['term_notes'])?$info['term_notes']:''; ?></textarea>
      </td>
  </tr>
</table>
