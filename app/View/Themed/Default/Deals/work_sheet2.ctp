 ...
 ?>           
			...
			<div class="right1"> <span class="span24">Mileage</span>:
				...
				<input name="vin_trade" type="text" class="input71" value="<?php echo $deal['Deal']['vin_trade']; ?>" placeholder=""/>
                           ...
                           <?php
                           if(in_array($cid,array(3201,3202)))
                           {
                           
                           ?>
                                <hr/>
				<span class="span24">Stock#</span>:
				<input name="stock_num_trade" type="text" class="input71" value="<?php echo $deal['Deal']['stock_num_trade']; ?>" placeholder=""/>    
                            <?php
                           }
                            ?>    
			...
			<span class="span24">Selling Price</span>$
				<input name="unit_value"  id="sell_price_value" type="text" class="input71" value="<?php echo $deal['Deal']['unit_value']; ?>" placeholder=""/>
            <span class="span24">Trade Allowance</span>$
				...
				<input name="subtotal" id="sell_price" type="text" class="input71 priceChange" value="<?php echo $deal['Deal']['subtotal']; ?>" placeholder=""/>
                                ...
                                <select name="freight_desc" id="freight_desc" class="form-control" style="width: auto; display: inline-block;">
                                    ...
                                    foreach ($all_fees as $value) {
                                        if (empty($value['FieldDescription']))
                                            continue;
                                        ?>				
                                        <option value="<?php echo $value['RecordType'] . '_' . $value['SequenceNumber'] . '_' . $value['FieldDescription']; ?>"  <?php if ($deal['Deal']['freight_desc'] == $value['RecordType'] . '_' . $value['SequenceNumber'] . '_' . $value['FieldDescription']) {
                                    echo 'selected';
                                } ?>><?php echo $value['FieldDescription'] . ' (' . $value['RecordType'] . ',' . $value['SequenceNumber'] . ')' ?></option>
                            <?php } ?>				
               ...
               <select name="prep_desc" id="prep_desc" class="form-control" style="width: auto; display: inline-block;">
                                    ...
                                    foreach ($all_fees as $value) {
                                        if (empty($value['FieldDescription']))
                                            continue;
                                        ?>				
                                        <option value="<?php echo $value['RecordType'] . '_' . $value['SequenceNumber'] . '_' . $value['FieldDescription']; ?>"  <?php if ($deal['Deal']['prep_desc'] == $value['RecordType'] . '_' . $value['SequenceNumber'] . '_' . $value['FieldDescription']) {
                                    echo 'selected';
                                } ?>><?php echo $value['FieldDescription'] . ' (' . $value['RecordType'] . ',' . $value['SequenceNumber'] . ')' ?></option>
                            <?php } ?>				
               ...
               <select name="doc_desc" id="doc_desc" class="form-control" style="width: auto; display: inline-block;">
                                    ...
                                    foreach ($all_fees as $value) {
                                        if (empty($value['FieldDescription']))
                                            continue;
                                        ?>				
                                        <option value="<?php echo $value['RecordType'] . '_' . $value['SequenceNumber'] . '_' . $value['FieldDescription']; ?>"  <?php if ($deal['Deal']['doc_desc'] == $value['RecordType'] . '_' . $value['SequenceNumber'] . '_' . $value['FieldDescription']) {
                                    echo 'selected';
                                } ?>><?php echo $value['FieldDescription'] . ' (' . $value['RecordType'] . ',' . $value['SequenceNumber'] . ')' ?></option>
                            <?php } ?>				
               ...
               <select name="parts_desc" id="parts_desc" class="form-control" style="width: auto; display: inline-block;">
                                    ...
                                    foreach ($all_fees as $value) {
                                        if (empty($value['FieldDescription']))
                                            continue;
                                        ?>				
                                        <option value="<?php echo $value['RecordType'] . '_' . $value['SequenceNumber'] . '_' . $value['FieldDescription']; ?>"  <?php if ($deal['Deal']['parts_desc'] == $value['RecordType'] . '_' . $value['SequenceNumber'] . '_' . $value['FieldDescription']) {
                                    echo 'selected';
                                } ?>><?php echo $value['FieldDescription'] . ' (' . $value['RecordType'] . ',' . $value['SequenceNumber'] . ')' ?></option>
                            <?php } ?>				
				...
				<input name="tag_fee" id="tag_tit"type="text" class="input71 priceChange" value="<?php echo $deal['Deal']['tag_fee']; ?>" placeholder=""/>
                                <?php
                           if(in_array($cid,array(3201,3202)))
                           {
               ...
               <select name="tag_desc" id="tag_desc" class="form-control" style="width: auto; display: inline-block;">
                                    ...
                                    foreach ($all_fees as $value) {
                                        if (empty($value['FieldDescription']))
                                            continue;
                                        ?>				
                                        <option value="<?php echo $value['RecordType'] . '_' . $value['SequenceNumber'] . '_' . $value['FieldDescription']; ?>"  <?php if ($deal['Deal']['tag_desc'] == $value['RecordType'] . '_' . $value['SequenceNumber'] . '_' . $value['FieldDescription']) {
                                    echo 'selected';
                                } ?>><?php echo $value['FieldDescription'] . ' (' . $value['RecordType'] . ',' . $value['SequenceNumber'] . ')' ?></option>
                            <?php } ?>				
				...
				<input name="tax_fee" id="tax"type="text" class="input70 priceChange" value="<?php echo $deal['Deal']['tax_fee']; ?>" placeholder=""/>
               ...
               <select name="sales_desc" id="sales_desc" class="form-control" style="width: auto; display: inline-block;">
                                    ...
                                    foreach ($all_fees as $value) {
                                        if (empty($value['FieldDescription']))
                                            continue;
                                        ?>				
                                        <option value="<?php echo $value['RecordType'] . '_' . $value['SequenceNumber'] . '_' . $value['FieldDescription']; ?>"  <?php if ($deal['Deal']['sales_desc'] == $value['RecordType'] . '_' . $value['SequenceNumber'] . '_' . $value['FieldDescription']) {
                                    echo 'selected';
                                } ?>><?php echo $value['FieldDescription'] . ' (' . $value['RecordType'] . ',' . $value['SequenceNumber'] . ')' ?></option>
                            <?php } ?>				
				...
				<table style="width: 80%;">
					...
					<tbody>
						<tr>
                            ...
                            <input name="loan_apr" type="text" id="apr" class="input12" value="<?php echo $deal['Deal']['loan_apr']; ?>" placeholder="" style="width: 83px;"/>
								%</td>
...
<!--			<option value="">* Select RecordType</option>-->
	<option <?php if ($deal['Deal']['RecordType'] == 'C') { echo 'selected'; } ?> value="C">cash deal</option>
        <option  <?php if ($deal['Deal']['RecordType'] == 'F') { echo 'selected'; } ?> value="F">financed</option>
        <option  <?php if ($deal['Deal']['RecordType'] == 'L') { echo 'selected'; } ?> value="L">lease</option>
        <option  <?php if ($deal['Deal']['RecordType'] == 'O') { echo 'selected'; } ?> value="O">outside financed</option>
   </select>
...
<!--			<option value="">* Select SaleType</option>-->
        <option  <?php if ($deal['Deal']['SaleType'] == 'R') { echo 'selected'; } ?> value="R">retail</option>
        <option  <?php if ($deal['Deal']['SaleType'] == 'L') { echo 'selected'; } ?> value="L">lease</option>
        <option  <?php if ($deal['Deal']['SaleType'] == 'F') { echo 'selected'; } ?> value="F">fleet</option>
        <option  <?php if ($deal['Deal']['SaleType'] == 'W') { echo 'selected'; } ?> value="W">wholesale</option>
        <option  <?php if ($deal['Deal']['SaleType'] == 'X') { echo 'selected'; } ?> value="X">dealer transfer</option>
        <option  <?php if ($deal['Deal']['SaleType'] == '1') { echo 'selected'; } ?> value="1">custom-1</option>
        <option  <?php if ($deal['Deal']['SaleType'] == '2') { echo 'selected'; } ?> value="2">custom-2</option>
        <option  <?php if ($deal['Deal']['SaleType'] == '3') { echo 'selected'; } ?> value="3">custom-3</option>
...
<div id="dms_xml_info" style="width:90%;margin:0 auto;display:none;">
<!-- Code for Raw XML -->
...
<div class="row">
    ...
    <xmp>
    <deal>
    <FirstName><?php echo $deal['Deal']['first_name']; ?></FirstName> 
    <LastName><?php echo $deal['Deal']['last_name']; ?></LastName>
    <Address><?php echo $deal['Deal']['address']; ?></Address>
    <City><?php echo $deal['Deal']['city']; ?></City>
    <State><?php echo $deal['Deal']['state']; ?></State>
    <Zip><?php echo $deal['Deal']['zip']; ?></Zip>
    <HomePhone><?php echo $cleaned2; ?></HomePhone>
    <CellPhone><?php echo $cleaned1; ?></CellPhone>
    <Email><?php echo $deal['Deal']['email']; ?></Email>
    <CFirstName><?php echo $deal['Deal']['cobuyer_fname']; ?></CFirstName>
    <CLastName><?php echo $deal['Deal']['cobuyer_lname']; ?></CLastName>
    <CAddress><?php echo $deal['Deal']['co_address']; ?></CAddress>
    <CCity><?php echo $deal['Deal']['co_city']; ?></CCity>
    <CState><?php echo $deal['Deal']['co_state']; ?></CState>
    <CZip><?php echo $deal['Deal']['co_zip']; ?></CZip>
    <CHomePHone><?php echo $deal['Deal']['cobuyer_phone']; ?></CHomePHone>
    <CCellPHone><?php echo $deal['Deal']['cobuyer_mobile']; ?></CCellPHone>
    <CEmail><?php echo $deal['Deal']['cobuyer_email']; ?></CEmail>
    <CSSN><?php echo $deal['Deal']['cobuyer_ssn']; ?></CSSN>
    <CDOB><?php echo $deal['Deal']['cobuyer_dob']; ?></CDOB>
    <Condition><?php echo $deal['Deal']['condition']; ?></Condition>
    <Year><?php echo $deal['Deal']['year']; ?></Year>
    <Make><?php echo $deal['Deal']['make']; ?></Make>
    <Model><?php echo $deal['Deal']['model']; ?></Model>
    <Category><?php echo $deal['Deal']['type']; ?></Category>
    <Mileage><?php echo $deal['Deal']['odometer']; ?></Mileage>
    <Color><?php echo $deal['Deal']['unit_color']; ?></Color>
    <VIN><?php echo $deal['Deal']['vin']; ?></VIN>
    <Stock><?php echo $deal['Deal']['stock_num']; ?></Stock>
    <TradeYear><?php echo $deal['Deal']['year_trade']; ?></TradeYear>
    <TradeMake><?php echo $deal['Deal']['make_trade']; ?></TradeMake>
    <TradeModel><?php echo $deal['Deal']['model_trade']; ?></TradeModel>
    <TradeMileage><?php echo $deal['Deal']['odometer_trade']; ?></TradeMileage>
    <TradeColor><?php echo $deal['Deal']['usedunit_color']; ?></TradeColor>
    <TradeVIN><?php echo $deal['Deal']['vin_trade']; ?></TradeVIN>
    <TradeAllowance><?php echo $deal['Deal']['trade_allowance']; ?></TradeAllowance>
    <TradePayoff><?php echo $deal['Deal']['trade_payoff']; ?></TradePayoff>
    <SellingPrice><?php echo $deal['Deal']['unit_value']; ?></SellingPrice>
    <Freight><?php echo $deal['Deal']['freight_fee']; ?></Freight>
    <Prep><?php echo $deal['Deal']['prep_fee']; ?></Prep>
    <Doc><?php echo $deal['Deal']['doc_fee']; ?></Doc>
    <Parts><?php echo $deal['Deal']['parts_fee']; ?></Parts>
    <TagTitle><?php echo $deal['Deal']['tag_fee']; ?></TagTitle>
    <SalesTax><?php echo $deal['Deal']['tax_fee']; ?></SalesTax>
    <Balance><?php echo $deal['Deal']['amount']; ?></Balance>
    <Downpayment><?php echo $deal['Deal']['down_payment']; ?></Downpayment> 
    </deal>  
    </xmp>
    </pre>    
</div>
...
<!-- End -->    
	...
	<div class="dontprint">
		<?php if($cid == 742139){ ?>
        	<a href="javascirpt:void()" id="data-view-toggle" class="btn btn-inverse" data-id="worksheet_container">Data View</a>
        <?php } ?>
...
$(document).ready(function(){
	...
	$("#data-view-toggle").on('click',function(e){
		e.preventDefault();
		data_id = $(this).attr('data-id');
		if(data_id == 'worksheet_container')
		{
			$("#worksheet_container").hide();
			$(this).text('Form View');
			$(this).attr('data-id','dms_xml_info');
			$("#dms_xml_info").show();
		}else
		{
			$("#dms_xml_info").hide();
			$(this).text('Data View');
			$(this).attr('data-id','worksheet_container');
			$("#worksheet_container").show();
		}
	...
	$(".tradeDiff").on('change keyup paste',function(){
											...
											actual_value = parseFloat($("#sell_price_value").val());
