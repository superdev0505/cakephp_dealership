				...
				<div class="widget widget-tabs widget-tabs-responsive">
					...
					<div class="widget-head">
						<ul>
							...
							<li><a href="#tab6-1" class="glyphicons notes" data-toggle="tab"><i></i>Vehicle</a></li>
					...
					<div class="widget-body">
						<?php echo $this->Form->create('Deal', array('type'=>'post','class' => 'form-inline apply-nolazy')); ?>
							...
							<div class="tab-pane active" id="tab1-1">
								<div class="row">
									...
									<div class="col-md-3"> <?php echo $this->Form->label('city','City:'); ?>
										<?php echo $this->Form->input('city', array('type' => 'text', 'label'=>false,'div'=>false,  'class' => 'col-md-1 form-control')); ?>
										<div class="separator"></div>
									</div>
									<div class="col-md-3">
									...
									<div class="col-md-3">
										...
										<?php echo $this->Form->input('zip', array('type' => 'text','label'=>false,'div'=>false, 'class' => 'form-control')); ?>
										<div class="separator"></div>
									</div>
...
?>
									...
									<div class="col-md-3"> <font color="red">*</font> <?php echo $this->Form->label('mobile','Cell:'); ?>
											<?php echo $this->Form->input('mobile', array('type' => 'text','label'=>false,'div'=>false,'class' => 'form-control')); ?>
									...
									<div class="col-md-3"> <font color='red'>*</font> <?php echo $this->Form->label('driver_lic_exp','Driver Lic Exp:', array('class'=>'strong')); ?> <?php echo $this->Form->input('driver_lic_exp', array('type' => 'text','label'=>false,'div'=>false,'class' => 'form-control','placeholder'=>'mm/dd/yyyy')); ?>
										<div class="separator"></div>
									</div>
									<div class="col-md-3"> <font color='red'>*</font> <?php echo $this->Form->label('ss_num','Social Secuirty#', array('class'=>'strong')); ?> <?php echo $this->Form->input('ss_num', array('type' => 'text','label'=>false,'div'=>false,'class' => 'form-control','placeholder'=>'_ _ _ -_ _ -_ _ _ _')); ?>
										<div class="separator"></div>
									</div>
									<div class="col-md-3"> <font color='red'>*</font> <?php echo $this->Form->label('dob','DOB:'); ?> <?php echo $this->Form->input('dob', array('type' => 'text','label'=>false,'div'=>false,'class' => 'form-control','placeholder'=>'mm/dd/yyyy')); ?>
										<div class="separator"></div>
									</div>
									<div class="col-md-3"> <font color='red'>*</font> <?php echo $this->Form->label('address2','Address (2)'); ?> <?php echo $this->Form->input('address2', array('type' => 'text','label'=>false,'div'=>false,'class' => 'form-control')); ?>
										<div class="separator"></div>
									</div>
									<div class="col-md-3"> <font color='red'>*</font> <?php echo $this->Form->label('city2','City (2)'); ?> <?php echo $this->Form->input('city2', array('type' => 'text','label'=>false,'div'=>false,'class' => 'form-control')); ?>
										<div class="separator"></div>
									</div>
...
?>
									...
									<div class="col-md-3"> <font color='red'>*</font> <?php echo $this->Form->label('zip2','Zip (2)'); ?> <?php echo $this->Form->input('zip2', array('type' => 'text','label'=>false,'div'=>false,'class' => 'form-control')); ?>
										<div class="separator"></div>
									</div>
								</div>
							</div>
							...
							<div class="tab-pane" id="tab2-1">
								<div class="row">
									<div class="col-md-3"> <font color="red">*</font> <?php echo $this->Form->label('residence_status','Residence Status:', array('class'=>'strong')); ?> <?php echo $this->Form->input('residence_status', array('type' => 'select', 'options' => array(
'Own' => 'Own',
'Rent' => 'Rent',
'Lease' => 'Lease',
'Parents' => 'Parents',
...
?>
									...
									<div class="col-md-3"> <font color="red">*</font> <?php echo $this->Form->label('mortgage_month_amount','Mortgage Month Amount:', array('class'=>'strong')); ?> <?php echo $this->Form->input('mortgage_month_amount', array('type' => 'text','label'=>false,'div'=>false, 'class' => 'form-control money_amount')); ?>
										<div class="separator"></div>
									</div>
...
?>
									...
									<div class="col-md-3"> <font color="red">*</font> <?php echo $this->Form->label('main_job','Main Occupation:', array('class'=>'strong')); ?> <?php echo $this->Form->input('main_job', array('type' => 'text','label'=>false,'div'=>false,'class' => 'form-control')); ?>
										<div class="separator"></div>
									</div>
									...
									<div class="col-md-3"> <font color="red">*</font> <?php echo $this->Form->label('job_length','Job Length:'); ?> <?php echo $this->Form->input('job_length', array('type' => 'select', 'options' => $years, 'empty' => 'Select','label'=>false,'div'=>false,'class' => 'form-control','style'=>'width: 100%'));
?>
										<div class="separator bottom"></div>
									</div>
									...
									<div class="col-md-3"> <font color='red'>*</font> <?php echo $this->Form->label('previous_employer_length','Previous Job Length', array('class'=>'strong')); ?>
										<?php
...
?>
									...
									<div class="col-md-3"> <font color='red'>*</font> <?php echo $this->Form->label('previous_employer_number','Previous Work#', array('class'=>'strong')); ?> <?php echo $this->Form->input('previous_employer_number', array('type' => 'text','label'=>false,'div'=>false,'class' => 'form-control')); ?>
										<div class="separator"></div>
									</div>
									<div class="col-md-3"> <font color='red'>*</font> <?php echo $this->Form->label('other_income','Other Income:'); ?> <?php echo $this->Form->input('other_income', array('type' => 'select', 'options' => array(
'Yes' => 'Yes',
'No' => 'No'
), 'empty' => 'Select','label'=>false,'div'=>false,'class' => 'form-control','style'=>'width: 100%'));
?>
									...
									<div class="col-md-3"> <font color='red'>*</font> <?php echo $this->Form->label('other_employer','Other Employer:'); ?> <?php echo $this->Form->input('other_employer', array('type' => 'text','label'=>false,'div'=>false,'class' => 'form-control')); ?>
										<div class="separator"></div>
									</div>
									<div class="col-md-3"> <font color='red'>*</font> <?php echo $this->Form->label('other_yearly','Other Yearly:'); ?> <?php echo $this->Form->input('other_yearly', array('type' => 'text','label'=>false,'div'=>false,'class' => 'form-control money_amount')); ?>
										<div class="separator"></div>
									</div>
							...
							<div class="tab-pane" id="tab3-1">
								<div class="row">
									<div class="col-md-3"> <font color="red">*</font> <?php echo $this->Form->label('co_suffix','Co-Suffix:', array('class'=>'strong')); ?> <?php echo $this->Form->input('co_suffix', array('type' => 'select', 'options' => array(
'Jr' => 'Jr',
'Sr' => 'Sr',
'II' => 'II',
'III' => 'III',
...
?>
									...
									<div class="col-md-3"> <font color="red">*</font> <?php echo $this->Form->label('cobuyer_fname','Co-First Name:', array('class'=>'strong')); ?> <?php echo $this->Form->input('cobuyer_fname', array('type' => 'text','label'=>false,'div'=>false,'class' => 'form-control')); ?>
										<div class="separator"></div>
									</div>
...
?>
									...
									<div class="col-md-3"> <font color="red">*</font> <?php echo $this->Form->label('cobuyer_gender','Co-Gender:', array('class'=>'strong')); ?> <?php echo $this->Form->input('cobuyer_gender', array('type' => 'select', 'options' => array(
'Male' => 'Male',
'Female' => 'Female'
), 'empty' => 'Select','label'=>false,'div'=>false,  'class' => 'form-control','style'=>'width: 100%'));
?>
									...
									<div class="col-md-3"> <font color="red">*</font> <?php echo $this->Form->label('cobuyer_mobile','Co-Cell:'); ?> <?php echo $this->Form->input('cobuyer_mobile', array('type' => 'text','label'=>false,'div'=>false,'class' => 'form-control')); ?>
										<div class="separator bottom"></div>
									</div>
									...
									<div class="col-md-3"> <font color='red'>*</font> <?php echo $this->Form->label('cobuyer_licence_exp','Co-Driver Lic Exp:', array('class'=>'strong')); ?> <?php echo $this->Form->input('cobuyer_licence_exp', array('type' => 'text','label'=>false,'div'=>false,'class' => 'form-control','placeholder'=>'mm/dd/yyyy')); ?>
										<div class="separator"></div>
									</div>
									<div class="col-md-3"> <font color='red'>*</font> <?php echo $this->Form->label('cobuyer_ssn','Co-Social Secuirty#', array('class'=>'strong')); ?> <?php echo $this->Form->input('cobuyer_ssn', array('type' => 'text','label'=>false,'div'=>false,'class' => 'form-control','placeholder'=>'_ _ _ -_ _ -_ _ _ _')); ?>
										<div class="separator"></div>
									</div>
									<div class="col-md-3"> <font color='red'>*</font> <?php echo $this->Form->label('cobuyer_dob','Co-DOB:'); ?> <?php echo $this->Form->input('cobuyer_dob', array('type' => 'text','label'=>false,'div'=>false,'class' => 'form-control','placeholder'=>'mm/dd/yyyy')); ?>
										<div class="separator"></div>
									</div>
									<div class="col-md-3"> <font color='red'>*</font> <?php echo $this->Form->label('co_address','Co-Address (2)'); ?> <?php echo $this->Form->input('co_address', array('type' => 'text','label'=>false,'div'=>false,'class' => 'form-control')); ?>
										<div class="separator"></div>
									</div>
									<div class="col-md-3"> <font color='red'>*</font> <?php echo $this->Form->label('co_city','Co-City (2)'); ?> <?php echo $this->Form->input('co_city', array('type' => 'text','label'=>false,'div'=>false,'class' => 'form-control')); ?>
										<div class="separator"></div>
									</div>
									...
									<div class="col-md-3"> <font color='red'>*</font> <?php echo $this->Form->label('co_zip','Co-Zip (2)'); ?> <?php echo $this->Form->input('co_zip', array('type' => 'text','label'=>false,'div'=>false,'class' => 'form-control')); ?>
										<div class="separator"></div>
									</div>
								</div>
							</div>
							...
							<div class="tab-pane" id="tab4-1">
								<div class="row">
									<div class="col-md-3"> <font color="red">*</font> <?php echo $this->Form->label('cobuyer_residence_status','Co-Residence Status:', array('class'=>'strong')); ?> <?php echo $this->Form->input('cobuyer_residence_status', array('type' => 'select', 'options' => array(
'Own' => 'Own',
'Rent' => 'Rent',
'Lease' => 'Lease',
'Parents' => 'Parents',
...
?>
									...
									<div class="col-md-3"> <font color="red">*</font> <?php echo $this->Form->label('cobuyer_monthly_mortgage','Co-Mortgage Month Amount:', array('class'=>'strong')); ?> <?php echo $this->Form->input('cobuyer_monthly_mortgage', array('type' => 'text','label'=>false,'div'=>false, 'class' => 'form-control money_amount')); ?>
										<div class="separator"></div>
									</div>
...
?>
									...
									<div class="col-md-3"> <font color="red">*</font> <?php echo $this->Form->label('cobuyer_main_job','Co-Main Occupation:', array('class'=>'strong')); ?> <?php echo $this->Form->input('cobuyer_main_job', array('type' => 'text','label'=>false,'div'=>false,'class' => 'form-control')); ?>
										<div class="separator"></div>
									</div>
									...
									<div class="col-md-3"> <font color="red">*</font> <?php echo $this->Form->label('cobuyer_job_length','Co-Job Length:'); ?> <?php echo $this->Form->input('cobuyer_job_length', array('type' => 'select', 'options' => $years, 'label'=>false,'div'=>false,'class' => 'form-control','style'=>'width: 100%'));
?>
										<div class="separator bottom"></div>
									</div>
									...
									<div class="col-md-3"> <font color='red'>*</font> <?php echo $this->Form->label('co_previous_employer_length','Co-Previous Job Length', array('class'=>'strong')); ?>
										<?php
...
?>
									...
									<div class="col-md-3"> <font color='red'>*</font> <?php echo $this->Form->label('co_previous_employer_number','Co-Previous Work#', array('class'=>'strong')); ?> <?php echo $this->Form->input('co_previous_employer_number', array('type' => 'text','label'=>false,'div'=>false,'class' => 'form-control')); ?>
										<div class="separator"></div>
									</div>
									<div class="col-md-3"> <font color='red'>*</font> <?php echo $this->Form->label('cobuyer_other_income','Co-Other Income:'); ?> <?php echo $this->Form->input('cobuyer_other_income', array('type' => 'select', 'options' => array(
'Yes' => 'Yes',
'No' => 'No'
), 'empty' => 'Select', 'label'=>false,'div'=>false,'class' => 'form-control','style'=>'width: 100%'));
?>
									...
									<div class="col-md-3"> <font color='red'>*</font> <?php echo $this->Form->label('cobuyer_other_employer','Co-Other Employer:'); ?> <?php echo $this->Form->input('cobuyer_other_employer', array('type' => 'text','label'=>false,'div'=>false,'class' => 'form-control')); ?>
										<div class="separator"></div>
									</div>
									<div class="col-md-3"> <font color='red'>*</font> <?php echo $this->Form->label('cobuyer_other_income_yearly','Co-Other Yearly:'); ?> <?php echo $this->Form->input('cobuyer_other_income_yearly', array('type' => 'text','label'=>false,'div'=>false,'class' => 'form-control money_amount')); ?>
										<div class="separator"></div>
									</div>
...
?>
							...
							<div class="tab-pane" id="tab5-1">
								<div class="row">
									<div class="col-md-3"> <font color="red">*</font> <?php echo $this->Form->label('ref1_name','Ref #1 Name:', array('class'=>'strong')); ?> <?php echo $this->Form->input('ref1_name', array('type' => 'text','label'=>false,'div'=>false, 'class' => 'form-control')); ?>
										<div class="separator"></div>
									</div>
									<div class="col-md-3"> <font color="red">*</font> <?php echo $this->Form->label('ref1_phone','Ref #1 Phone:', array('class'=>'strong')); ?> <?php echo $this->Form->input('ref1_phone', array('type' => 'text','label'=>false,'div'=>false, 'class' => 'form-control')); ?>
										<div class="separator"></div>
									</div>
									<div class="col-md-3"> <font color="red">*</font> <?php echo $this->Form->label('ref1_city','Ref #1 City:', array('class'=>'strong')); ?> <?php echo $this->Form->input('ref1_city', array('type' => 'text','label'=>false,'div'=>false, 'class' => 'form-control')); ?>
										<div class="separator"></div>
									</div>
									<div class="col-md-3"> <font color="red">*</font> <?php echo $this->Form->label('ref1_state','Ref #1 State:', array('class'=>'strong')); ?>
										<?php
...
?>
									...
									<div class="col-md-3"> <font color="red">*</font> <?php echo $this->Form->label('ref2_name','Ref #2 Name:', array('class'=>'strong')); ?> <?php echo $this->Form->input('ref2_name', array('type' => 'text','label'=>false,'div'=>false, 'class' => 'form-control')); ?>
										<div class="separator"></div>
									</div>
									<div class="col-md-3"> <font color="red">*</font> <?php echo $this->Form->label('ref2_phone','Ref #2 Phone:', array('class'=>'strong')); ?> <?php echo $this->Form->input('ref2_phone', array('type' => 'text','label'=>false,'div'=>false, 'class' => 'form-control')); ?>
										<div class="separator"></div>
									</div>
									<div class="col-md-3"> <font color="red">*</font> <?php echo $this->Form->label('ref2_city','Ref #2 City:', array('class'=>'strong')); ?> <?php echo $this->Form->input('ref2_city', array('type' => 'text','label'=>false,'div'=>false, 'class' => 'form-control')); ?>
										<div class="separator"></div>
									</div>
									<div class="col-md-3"> <font color="red">*</font> <?php echo $this->Form->label('ref2_state','Ref #2 State:', array('class'=>'strong')); ?>
										<?php
...
?>
									...
									<div class="col-md-3"> <font color="red">*</font> <?php echo $this->Form->label('ref3_name','Ref #3 Name:', array('class'=>'strong')); ?> <?php echo $this->Form->input('ref3_name', array('type' => 'text','label'=>false,'div'=>false, 'class' => 'form-control')); ?>
										<div class="separator"></div>
									</div>
									<div class="col-md-3"> <font color="red">*</font> <?php echo $this->Form->label('ref3_phone','Ref #3 Phone:', array('class'=>'strong')); ?> <?php echo $this->Form->input('ref3_phone', array('type' => 'text','label'=>false,'div'=>false, 'class' => 'form-control')); ?>
										<div class="separator"></div>
									</div>
									<div class="col-md-3"> <font color="red">*</font> <?php echo $this->Form->label('ref3_city','Ref #3 City:', array('class'=>'strong')); ?> <?php echo $this->Form->input('ref3_city', array('type' => 'text','label'=>false,'div'=>false, 'class' => 'form-control')); ?>
										<div class="separator"></div>
									</div>
									<div class="col-md-3"> <font color="red">*</font> <?php echo $this->Form->label('ref3_state','Ref #3 State:', array('class'=>'strong')); ?>
										<?php
...
?>
							...
							<div class="tab-pane" id="tab6-1">
								...
								<div class="row">
									...
									<div class="col-md-3">
										...
										<?php echo $this->Form->input('make', array('type' => 'select', 'options' => $mk_options, 'empty' => 'Select','label'=>false,'div'=>false, 'class' => 'form-control','style'=>'width: 100%'));?>
										<div class="separator"></div>
									</div>

									<div class="col-md-3">
										<?php echo $this->Form->label('year','Year:'); ?><br />
										<?php echo $this->Form->input('year', array('type' => 'select', 'options' => $year_opt, 'empty' => 'selected', 'label'=>false,'div'=>false,  'class' => 'form-control','style'=>'width: 80%'));?>
								...
								<div class="row">
									...
									<div class="col-md-3">
										...
										<?php
										$display_model_id = ( $this->request->data['Deal']['model_id'] != '')? "inline-block" : 'none';
										...
										<?php
										$display_model_txt = ( $this->request->data['Deal']['model_id'] == '')? "inline-block" : 'none';
									...
									<div class="col-md-3">
										...
										<?php echo $this->Form->input('class', array('type' => 'select', 'options'=>$body_sub_type_options,   'empty' => 'Select', 'label' => false, 'div' => false, 'class' => 'form-control','style'=>'width: 100%')); ?>
									</div>

									<div class="col-md-3">
										<?php echo $this->Form->label('unit_value','Value/Unit:'); ?>
										<?php echo $this->Form->input('unit_value', array('type' => 'text',  'label'=>false,'div'=>false,'class' => 'form-control money_amount')); ?>
										<div class="separator"></div>
									</div>

									<div class="col-md-3"><?php echo $this->Form->label('stock_num','Stock#'); ?>
										<?php echo $this->Form->input('stock_num', array('type' => 'text', 'label'=>false,'div'=>false,'class' => 'form-control'));?>
										<div class="separator"></div>
									</div>
								...
								<div class="row">
									<div class="col-md-2"><?php echo $this->Form->label('condition','Condition:'); ?>
										<?php echo $this->Form->input('condition', array('type' => 'select', 'options' => array('New' => 'New','Used' => 'Used','Rental' => 'Rental','Demo' => 'Demo'), 'empty' => 'Select','label'=>false,'div'=>false,'class' => 'form-control','style'=>'width: 100%')); ?>
										<div class="separator"></div>
									</div>
								...
								<div class="row">
									...
									<div class="col-md-3">
										...
										<?php echo $this->Form->input('category_trade', array('type' => 'select', 'options' => $d_type_options, 'empty' => 'Select', 'label'=>false,'div'=>false, 'class' => 'form-control','style'=>'width: 100%'));?>
										<div class="separator"></div>
									</div>
									...
									<div class="col-md-3"> <?php echo $this->Form->label('make_trade','(Trade) Make:'); ?>
										<?php echo $this->Form->input('make_trade', array('type' => 'select',  'options' => $mk_options_trade, 'empty' => 'Select','label'=>false,'div'=>false,'style'=>'width: 100%','class' => 'form-control')); ?>
										<div class="separator"></div>
									</div>
									<div class="col-md-3">
								...
								<div class="row">
									...
									<div class="col-md-3">
										...
										<?php
										$display_model_id_trade = ( $this->request->data['Deal']['model_id_trade'] != '' || $this->request->data['Deal']['model_trade'] == '' )? "inline-block" : 'none';
										...
										<?php
										$display_model_txt_trade = ( $this->request->data['Deal']['model_id_trade'] == '' && $this->request->data['Deal']['model_trade'] != '')? "inline-block" : 'none';
								...
								<div class="row">
									...
									<div class="col-md-3"> <?php echo $this->Form->label('condition_trade','(Trade) Condition:'); ?>
										<?php echo $this->Form->input('condition_trade', array('type' => 'select',  'options' => array('Used' => 'Used','Rental' => 'Rental','Demo' => 'Demo'), 'empty' => 'Select', 'label'=>false,'div'=>false,'style'=>'width: 100%','class' => 'form-control'));?>
										<div class="separator"></div>
									</div>
							...
							<div class="tab-pane" id="tab7-1">
								<div class="row">
									<div class="col-md-3"> <font color="red">*</font> <?php echo $this->Form->label('fee_type','FIXED FEE / PAYMENT:', array('class'=>'strong')); ?>
							...
							<div class="tab-pane" id="tab10-1">
								<div class="row">
									<div class="col-md-12">
										...
										<?php echo $this->Form->input('notes', array('type' => 'textarea','label'=>false,'div'=>false, 'class' => 'form-control')); ?>
