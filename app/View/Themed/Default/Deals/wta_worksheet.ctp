...
@media print {
	...
	.arrow {height: 440px !important;}
	.purchaser {margin: 5% 0 0 !important;}
	...
	<div class="wraper header">
		<div class="row" style="float: left; width: 100%; margin: 3px 0;">
			<div class="left" style="float: left; width: 50%;">
				<div class="logo" style="width: 34%; float: left; margin-right: 10px;">
					<img  src="<?php echo ('/app/webroot/files/dealer_name/dealer_logo/'.$cid.'/wtalogo1.png'); ?>" alt="" style="width: 100%;">
				</div>
				<p style="float: left;"><b>WHOLESALE TRAILERS<br>OF ALBERTA LTD.<br>1915 Sparrow Drive<br>Nisku, Alberta, Canada T9E 8A7<br>Tel: (780)955-2445 Fax: (780)955-2939</b></p>
			</div>
		...
		<div class="cover" style="width: 100%; float: left; border: 1px solid #000; box-sizing: border-box; padding: 10px; border-radius: 7px; margin: 7px 0;">
			...
			<div class="row" style="float: left; width: 100%; margin: 3px 0;">
				...
				<div class="form-field" style="float: left; width: 50%;">
					<label>CELL</label>
					<input type="text" name="mobile" value="<?php echo isset($info['mobile'])?$info['mobile']:''; ?>" style="width: 89%;">
				</div>
			</div>	
		</div>
		...
		<div class="cover" style="width: 100%; float: left; border: 1px solid #000; box-sizing: border-box; padding: 10px; border-radius: 7px; margin: 7px 0;">
			<div class="row" style="float: left; width: 100%; margin: 3px 0;">
				<div class="form-field" style="float: left; width: 40%;">
					<label>YEAR</label>
					<input type="text" name="year" value="<?php echo isset($info['year'])?$info['year']:''; ?>" style="width: 85%;">
				</div>
				<div class="form-field" style="float: left; width: 60%;">
					<label>STOCK#</label>
					<input type="text" name="stock_num" value="<?php echo isset($info['stock_num'])?$info['stock_num']:''; ?>" style="width: 88%;">
				</div>
			</div>
			...
			<div class="row" style="float: left; width: 100%; margin: 3px 0;">
				<div class="form-field" style="float: left; width: 40%;">
					<label>MAKE</label>
					<input type="text" name="make" value="<?php echo isset($info['make'])?$info['make']:''; ?>" style="width: 84.5%;">
				</div>
				<div class="form-field" style="float: left; width: 60%;">
					<label>MODEL</label>
			...
			<div class="row" style="float: left; width: 100%; margin: 3px 0;">
				<div class="form-field" style="float: left; width: 100%;">
					<label>VIN#</label>
					<input type="text" name="vin" value="<?php echo isset($info['vin'])?$info['vin']:''; ?>" style="width: 95.3%;">
				</div>
			</div>	
		</div>
		...
		<div class="cover" style="width: 100%; float: left; border: 1px solid #000; box-sizing: border-box; padding: 10px; border-radius: 7px; margin: 7px 0;">
			<div class="row" style="float: left; width: 100%; margin: 3px 0;">
				<div class="form-field" style="float: left; width: 40%;">
					...
					<input type="text" name="trade_type" value="<?php echo isset($info['trade_type'])?$info['trade_type']:''; ?>" style="width: 70%;">
				</div>
				...
				<div class="form-field" style="float: left; width: 24%;">
					...
					<input type="text" name="trade_value" value="<?php echo isset($info['trade_value'])?$info['trade_value']:''; ?>" style="width: 50%;">
				</div>
			</div>
			...
			<div class="row" style="float: left; width: 100%; margin: 3px 0;">
				<div class="form-field" style="float: left; width: 40%;">
					<label>MAKE</label>
					<input type="text" name="make_trade" value="<?php echo isset($info['make_trade'])?$info['make_trade']:''; ?>" style="width: 83%;">
				</div>
				<div class="form-field" style="float: left; width: 36%;">
					<label>MODEL</label>
				...
				<div class="form-field" style="float: left; width: 24%;">
					<label>VIN#</label>
					<input type="text" name="vin_trade" value="<?php echo isset($info['vin_trade'])?$info['vin_trade']:''; ?>" style="width: 79%;">
				</div>
			</div>
		</div>
		...
		<div class="row" style="float: left; width: 100%; margin: 0px;">
			<div class="left" style="float: left; width: 48%;">
				<div class="cover" style="width: 100%; float: left; border: 1px solid #000; box-sizing: border-box; padding: 10px; border-radius: 7px; margin: 7px 0;">
					<table cellpadding="0" cellspacing="0" width="100%">
						<tr>
							<td style="width: 80%;"><b style="width: 16px;">SPARE TIRE:</b></td>
							<td style="width: 20%; text-align: right;"><b style="width: 16px;"><input type="text" class="price" id="spare" name="spare" value="<?php echo isset($info['spare'])?$info['spare']: ''; ?>" style="width: 100%; font-size: 15px; font-weight: 700;"></b></td>
						</tr>

						<tr>
							<td style="width: 80%;"><b style="width: 16px;">OPTIONS:</b></td>
							<td style="width: 20%; text-align: right;"><b style="width: 16px;"><input type="text" class="price" id="water_package" name="water_package" value="<?php echo isset($info['water_package'])?$info['water_package']: ''; ?>" style="width: 100%; font-size: 15px; font-weight: 700;"></b></td>
						</tr>
						...
						<tr>
							<td style="width: 80%; font-size: 16px;"><b style="width: 16px;"><input type="text" name="title17" value="<?php echo isset($info['title17'])?$info['title17']:''; ?>" style="width: 100%;"></b></td>
						...
						<tr>
							<td style="width: 80%; font-size: 16px;"><b style="width: 16px;">TOTAL OPTION</b></td>
			...
			<div class="center" style="width: 4%; float: left; margin: 97px 0 0 0;">
				<img class="arrow" src="<?php echo ('/app/webroot/files/dealer_name/dealer_logo/'.$cid.'/arrow.png'); ?>" alt="" style="width: 100%; height: 422px;">
			</div>
			
			<div class="right" style="float: right; width: 48%; box-sizing: border-box;">
				<div class="cover" style="width: 100%; float: left; border: 1px solid #000; box-sizing: border-box; padding: 10px; border-radius: 7px; margin: 1.5% 0 0;">
					<table cellpadding="0" cellspacing="0" width="100%;">
						<tr>
							<td style="width: width: 80%; font-size: 16px;">RETAIL PRICE</td>
						...
						<tr>
							...
							<td style="width: width: 20%; font-size: 16px;"><input type="text" class="price" id="unit_value" name="unit_value" value="<?php echo isset($info['unit_value'])?$info['unit_value']: ''; ?>" style="width: 100%;"></td>
						</tr>
						...
						<tr>
							<td style="width: width: 80%; font-size: 16px;">BALANCE DUE</td>
							<td style="width: width: 20%; font-size: 16px;"><input type="text" class="price" id="balance" name="balance" value="<?php echo isset($info['balance'])?$info['balance']: ''; ?>" style="width: 100%;"></td>
						</tr>
				...
				<div class="row" style="float: left; width: 100%; margin: 13px 13px;">
					<div class="form-field" style="float: left; width: 90%;">
						<label style="width: 38%; display: inline-block; font-size: 16px;">Finance Deal</label>
	    				<span style="width: 60%; display: inline-block; text-align: center;">
	   						<label style="display: block;">Yes <input type="checkbox" name="finance_yes" style="margin-right: 20px;" value="Yes" <?php echo ($info['finance_yes'] == "Yes") ? "checked" : ""; ?> />  No <input type="checkbox" name="finance_no" value="No" <?php echo ($info['finance_no'] == "No") ? "checked" : ""; ?> /></label>
	    				</span>
					</div>
				</div>
				
				<div class="cover purchaser" style="width: 100%; float: left; border: 1px solid #000; box-sizing: border-box; padding: 4% 10px 10px; border-radius: 7px;">
...
$(document).ready(function(){
	...
	*/
	...
	function calculate_totalinvoice() {
		var spare = isNaN(parseFloat( $('#spare').val()))?0.00:parseFloat($('#spare').val());
		var water_package = isNaN(parseFloat( $('#water_package').val()))?0.00:parseFloat($('#water_package').val());
		...
		var total_option = spare + water_package + battery_install + spare_tire + price1 + price2 +price3 + price4 + price5 + price6 + price7 + price8 + price9 + price10 + price11 + price12 + price13 + price14 + price15 + price16 + wire;
		...
		var sub_total = msrp + adjustment + total_option + unit_value;
		$("#sub_total").val(sub_total.toFixed(2));
		var trade_value = isNaN(parseFloat( $('#trade_value').val()))?0.00:parseFloat($('#trade_value').val());
		var deposit = isNaN(parseFloat( $('#deposit').val()))?0.00:parseFloat($('#deposit').val());
		var balance = sub_total - trade_value - deposit;
