	...
	<div class="wraper header">
		...
		<div class="row" style="float: left; width: 100%; margin: 7px 0;">
			<div class="left" style="float: left; width: 50%; margin: 0; border: 1px solid #000; box-sizing: border-box; padding: 6px;">
				<div class="row" style="float: left; width: 100%;margin: 3px 0;">
					<div class="form-field" style="width: 50%; float: left; margin: 0;">
						<label>Stock</label>
						<input type="text" name="stock_num_trade" value="<?php echo isset($info['stock_num_trade']) ? $info['stock_num_trade'] : ''; ?>" style="width: 81%;">
					</div>
				...
				<div class="row" style="float: left; width: 100%;margin: 3px 0;">
					<div class="form-field" style="width: 40%; margin: 0; float: left;">
						...
						<input type="text" name="vehicle_year_trade" value="<?php echo isset($info['vehicle_year_trade']) ? $info['vehicle_year_trade'] : ''; ?>" style="width: 40%;">
					</div>
					<div class="form-field" style="width: 30%; margin: 0; float: left;">
						<label>Make:</label>
						<input type="text" name="vehicle_make_trade" value="<?php echo isset($info['vehicle_make_trade']) ? $info['vehicle_make_trade'] : ''; ?>" style="width: 60%;">
					</div>
					<div class="form-field" style="width: 30%; margin: 0; float: right;">
						<label>Model:</label>
						<input type="text" name="vehicle_model_trade" value="<?php echo isset($info['vehicle_model_trade']) ? $info['vehicle_model_trade'] : ''; ?>" style="width: 60%;">
					</div>
				</div>
			...
			<div class="right" style="float: right; width: 50%; border: 1px solid #000; box-sizing: border-box; padding: 6px; border-left: 0px;">
				<div class="row" style="float: left; width: 100%; margin: 3px 0;">
					<div class="form-field" style="width: 14%; float: left; margin: 3px 0px;">
						<label>Trade-In</label>
						<span style="float: right;"><input type="checkbox" name="trade_check" <?php echo ($info['trade_check'] == "trade-in") ? "checked" : ""; ?> value="trade-in"/></span>
					</div>
					<div class="form-field" style="width: 15%; float: left; margin: 3px 45px;">
						<label>Purchase</label>
						<span style="float: right;"><input type="checkbox" name="purchase_check" <?php echo ($info['purchase_check'] == "purchase") ? "checked" : ""; ?> value="purchase"/></span>
					</div>
					<div class="form-field" style="width: 20%; float: left; margin: 3px 5px;">
						<label>Consignment</label>
						<span style="float: right;"><input type="checkbox" name="consignment_check" <?php echo ($info['consignment_check'] == "consignment") ? "checked" : ""; ?> value="consignment"/></span>
					</div>
				</div>
