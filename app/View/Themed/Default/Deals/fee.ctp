...
<tr>
<div align ="center">
<p><strong>FIXED FEE / PAYMENT</strong> </br>
(1) Start by selecting the Condition and the Unit Type. </p>
...
<p>(2) Fill out fee(s) for this Unity Type (below).</p>
...
&nbsp;&nbsp;<font color="red">*</font>&nbsp;Deal Notes:&nbsp;<?php echo $this->Form->input('notes', array('type' => 'text', 'class' => 'span4')); ?>
</br></br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<?php echo $this->Form->submit('<i class="icon-save"></i> Save Fixed Fee(s)', array('div' => false, 'class' => 'btn btn-success')); ?>
</fieldset>
