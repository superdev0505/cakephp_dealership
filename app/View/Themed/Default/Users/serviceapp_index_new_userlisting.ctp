    ...
    <div class="widget widget-body-white">
        <div class="widget-body">
            <div class="row">
                    ...
                    <div class="col-md-3">
                            <?php
                            echo $this->Form->select('search_all', $service_group, array('div' => false, 'selected'=>$selected_type, 'class'=>"form-control", 'style' => 'width: 100%', 'empty' => 'Staff Search', 'id' => 'UserSearchAll'));
          ...
          $('#btn-submit-search').live('click',function(){
               ...
               if($.trim(val) != ""){
                    $.ajax({
                          type: "GET",
                          cache: false,
                          url: "<?php echo $this->Html->url(array('controller' =>'users','action' => 'search_result')) ?>/"+groupid+"/"+val+"/load_first",
                          success: function(data) {
                              $("#search-result-content").html(data);
                              $('.ajax-loading').addClass('hide');
                          }
                    ...
                    $.ajax({
                        type: "GET",
                        cache: false,
                        url: "<?php echo $this->Html->url(array('controller' =>'users','action' => 'search_result')) ?>/"+groupid+"/load_first",
                        success: function(data) {
                            $("#search-result-content").html(data);
                            $('.ajax-loading').addClass('hide');
                        }
