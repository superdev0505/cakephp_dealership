	...
	<!-- col -->
		...
		<div class="col-separator col-unscrollable box">
			...
			<div class="col-table">
				...
				<h4 class="innerAll margin-none border-bottom text-center bg-blue text-white"><i class="fa fa-lock"></i> Login to your Account</h4>
...
<h3>Business Development Center</h3>
</div>
                                 ...
                                 <?php if($browser_ok != false){ ?>
 								  <div class="panel-body">
									...
									<?php echo $this->Form->create('User',array('class'=>'form-horizontal apply-nolazy','role'=>"form" )); ?>
									  ...
									  <button type="submit" class="btn bg-blue btn-block text-white">Login</button>
									...
									<?php echo $this->Form->end(); ?>
								   	...
								   	<div class="col-sm-12 col-sm-offset-0 text-center padding-none">
										...
										<?php echo $this->html->link('Forgot?','mailto:support@dp360crm.com?subject=DP360 CRM - BDC App Login Support',array('class'=>'btn btn-danger no-ajaxify','escape'=>false)); ?>
