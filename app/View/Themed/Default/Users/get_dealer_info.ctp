		...
		<div class="row">
			<div class="col-md-6">
				...
				<ul class="list-unstyled list-group-1">
					...
					<li><span class="strong">Dealer Email:</span> <?php echo $user['User']['d_email']; ?></li>
...
endforeach;
            ...
            ?>
            <span data-toggle="notyfy" data-type="information" data-layout="top" class="btn btn-info">No Information found.</span>
</div>
        <?php
        endif;
        ?>
