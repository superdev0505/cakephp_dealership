		...
		<div class="innerB">
			<div class="row">
				...
				<div class="col-xs-3">
					...
					<?php echo $this->Form->input('email', array('autocomplete' => 'off',  'required' => 'required','label' => false, 'div' => false, 'class' => 'form-control','style'=>'width: 100%')); ?>
					<div class="separator"></div>
				</div>
			</div>
			<div class="row">
				<div class="col-xs-3">
					...
					<?php echo $this->Form->input('password', array( 'autocomplete' => 'off', 'required' => 'required','label' => false, 'div' => false, 'class' => 'form-control','style'=>'width: 100%')); ?>
					<div class="separator"></div>
				</div>
				<div class="col-xs-3">
		...
		<div class="innerB">
			<div class="row">
				...
				<div class="col-xs-3">
					...
					<?php echo $this->Form->input('d_type', array('type' => 'text', 'empty' => 'Select', 'label' => false, 'div' => false, 'class' => 'form-control','style'=>'width: 100%')); ?>
					<div class="separator"></div>
				</div>
				...
				<div class="col-xs-3">
                    ...
                    'Auto' => 'Auto',
                    'AG' => 'AG',
                    'Wheel/Tire' => 'Wheel/Tire','Trailer' => 'Trailer'), 'empty' => 'Select',  'required'=>'required','class' => 'form-control','style'=>'width: 100%')); ?>
			...
			<div class="row">
                ...
                <div class="col-xs-6">
					<br />
					<?php echo $this->Form->label('report_access','Report Centre - Access:'); ?>
					<?php echo $this->Form->input('report_access',array('class' => 'input-mini','type' => 'checkbox')); ?>
					<div class="separator"></div>
				</div>
			</div>
	...
	<?php
	 if(isset($save_sucees)){ ?>
		...
		$.ajax({
			type: "GET",
			cache: false,
			url:  "/users/search_user?first_name=&last_name=&group=&dealer_id=<?php echo $this->request->data['User']['dealer_id']; ?>&_=1403699290831",
			success: function(data){
