<!--<script src="/app/View/Themed/Default/webroot/assets/components/common/forms/ckeditor/bootstrap-ckeditor-fix.js"></script>-->
...
<script type="text/javascript">
    ...
    /////save data
		...
		//content = $("#txtContent").text();
                ...
                //die('test');
		//content = $('textarea[name="content_data"]').val();
