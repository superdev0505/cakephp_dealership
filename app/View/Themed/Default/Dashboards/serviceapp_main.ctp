                        ...
                        <table class="table table-condensed table-striped table-primary table-vertical-center checkboxs">
                            ...
                            <tbody>
                                ...
                                <tr class="selectable">
                                    ...
                                    <td class="center"><?php echo $event['ServiceEvent']['id'];  ?></td>
                                    <td class="center"><?php echo date("h:i A",strtotime($event['ServiceEvent']['start']));  ?></td>
                                    <td>
                                        <strong><?php echo $event['ServiceEvent']['first_name'];  ?> <?php echo $event['ServiceEvent']['last_name'];  ?></strong>
                                        <br/>
                                        <small>Location: <?php echo $event['ServiceLead']['city'];  ?></small>
                                    </td>
                                    <td class="center"><?php echo format_phone($event['ServiceEvent']['phone']);  ?></td>
                                    <td class="center">&euro;46</td>
