...
<h4 class="innerAll margin-none border-bottom text-center bg-primary">
    <?php echo $this->Form->create('devteamdaily', array('url' => array('controller' => 'Projects', 'action' => 'close'), 'class' => 'form-inline apply-nolazy')); ?>
...
<tr>
    <th id="Campaign-grid_c0"  style="width:230px;" >Project Number #</th>
<th id="Campaign-grid_c0">Severity</th>
<th id="Campaign-grid_c0">Project Name</th>
<th id="Campaign-grid_c3"  style="width:400px;" >Project Description</th>
<th id="Campaign-grid_c3">Assign To</th>
<!--<th id="Campaign-grid_c3" style="width: 97px; text-align: center;">Total <br> To-do list</th>-->
<th id="Campaign-grid_c3">Attachment</th>
<th id="Campaign-grid_c3" class="text-center">Re-activate</th>
...
<!--<tr  style="border-top: 10px solid #3695d5;">-->
    <tr class="bg-primary">
<th id="Campaign-grid_c0" class="bg-primary"  style="width:230px;" >Project Number #</th>
<th id="Campaign-grid_c0" class="bg-primary">Severity</th>
<th id="Campaign-grid_c0" class="bg-primary">Project Name</th>
<th id="Campaign-grid_c3" class="bg-primary" style="width:400px;" >Project Description</th>
<th id="Campaign-grid_c3"  class="bg-primary">Assign To</th>
<!--<th id="Campaign-grid_c3"  class="bg-primary" style="width: 97px; text-align: center;">Total <br> To-do list</th>-->
<th id="Campaign-grid_c3" class="bg-primary">Attachment</th>
<th id="Campaign-grid_c3" class="bg-primary text-center">Re-activate</th>
<!--<th id="Campaign-grid_c3">Close Ticket</th>-->
</tr>
<tr>
    <?php
    ...
    if($project['Project']['support_id']==0 || $project['Project']['support_id']==''){
        ...
        echo $project['Support']['User']['dealer'];
    }
...
<?php
echo $this->Text->truncate(strip_tags($project['Project']['description']), 130, array('html' => true,
...
//echo count($project['DevteamDaily']);
  ?> 
<!--</td>-->
<!--<td><?php //echo $this->Html->link('Edit', 'edit/' .$project['Project']['id'], array('class'=>'no-ajaxify')); ?>&nbsp;</a>
</td>-->
<td>
    <?php //echo $this->Html->link('File Upload', '#', array('class'=>'file_upload','id'=>$project['Project']['id'])); ?>
<!--    <br/>
    <br/>
    <b>Uploaded:</b>
    <br/>-->
...
<td class="text-center"><?php echo $this->Html->link('<i class="fa fa-repeat  fa-2x"></i>', 'reactive/' . $project['Project']['id'], array('class'=>'no-ajaxify','escape'=>false), 'Are you sure you?', false); ?>&nbsp;</a>
</td>
...
$script.ready('bundle', function() {
	...
	e.preventDefault();
     ...
     ///on click pop-up 
        ...
        if($(this).val()!=''){
location.href = "<?php echo $this->Html->url(array('controller'=>'projects','action'=>'close')); ?>/"+$(this).val();
                        }
