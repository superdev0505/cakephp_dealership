...
&nbsp;&nbsp;&nbsp; <a class="btn btn-success btn" href="/reports">Drop-Down Graphs</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a class="btn btn-success btn" disabled href="/reports2">Unit Graphs</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-success btn" href="/reports3">Lead Stats</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-success btn" href="/reports4">Events Graphs</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-success btn" href="/reports5">Eblast Graphs</a>
</br>
</br>
<table  class="pietable">
<tr bgcolor="#ffffff" >
<td style="border-right: 1px solid;">
<div class="piechart-drop-head">Select Unit Graphs</div>
...
<td>
<td><div id="condition_piechart" class="show-piechart"> </div></td>
</tr>
</table>
...
function showpiechart(url){
	...
	var newdata = [];
	var dataPath = "<?php echo $this->webroot ?>reports2/"+url;
 ...
 showpiechart("getConditionPieData");
});
