...
echo $this->element('followupelement', array('arrResults'=>isset($PresaleFollowupData[$SecId])? $PresaleFollowupData[$SecId]: array(),'Tab'=>'Presale','SecId'=>$SecId,'TotalCount'=>$TotalCount)); ?>