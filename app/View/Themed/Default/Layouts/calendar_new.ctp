...
'/app/View/Themed/Default/webroot/assets/components/common/forms/wizards/assets/custom/js/form-wizards-event.init.js?v=v1.0.3-rc2&sv=v0.0.1.1.50',
...
'/app/View/Themed/Default/webroot/assets/components/modules/admin/calendar/assets/custom/js/calendar.init.js?v=v1.0.2&sv=v0.0.1.52', 
