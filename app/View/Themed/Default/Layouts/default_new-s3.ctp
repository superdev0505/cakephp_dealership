			...
			<div class="navbar hidden-print main" role="navigation">
				...
				<ul class="main pull-right">
					...
					<li class="dropdown username">
						...
						<?php echo $this->Html->image('/app/View/Themed/Default/webroot/assets/images/icon-user-51x51.png',array('class'=>"img-circle",'width'=>"30")); ?><?php echo AuthComponent::user('full_name'); ?>
