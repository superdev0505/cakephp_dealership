...
<body class="scripts-async" onLoad="alert(dfdf);">
					...
					<li>
						...
						<div id="sidebar-discover-media" class="sidebar-discover-menu">
							...
							<ul class="animated fadeIn">
								<li><a href="<?php echo $this->Html->url(array('controller'=>'contacts','action'=>'leads')); ?>"><i class="fa fa-user"></i>New Lead</a></li>
								<li><a href="<?php echo $this->Html->url(array('controller'=>'contacts','action'=>'leads')); ?>"><i class="fa fa-user"></i>Edit Lead</a></li>
								<li><a href="<?php echo $this->Html->url(array('controller'=>'contacts','action'=>'leads')); ?>"><i class="fa fa-video-camera"></i>View All Leads</a></li>
								<li><a href="<?php echo $this->Html->url(array('controller'=>'contacts','action'=>'leads')); ?>"><i class="fa fa-video-camera"></i>Search Leads</a></li>					
								<li><a href="<?php echo $this->Html->url(array('controller'=>'contacts','action'=>'leads')); ?>"><i class="fa fa-video-camera"></i>View Mobile</a></li>
								<li><a href="<?php echo $this->Html->url(array('controller'=>'contacts','action'=>'leads')); ?>"><i class="fa fa-video-camera"></i>View Web</a></li>					
								<li><a href="<?php echo $this->Html->url(array('controller'=>'contacts','action'=>'leads')); ?>"><i class="fa fa-video-camera"></i>View Phone</a></li>
								<li><a href="<?php echo $this->Html->url(array('controller'=>'contacts','action'=>'leads')); ?>"><i class="fa fa-video-camera"></i>View Showroom</a></li>
								<li><a href="<?php echo $this->Html->url(array('controller'=>'contacts','action'=>'leads')); ?>"><i class="fa fa-video-camera"></i>View Parts</a></li>
								<li><a href="<?php echo $this->Html->url(array('controller'=>'contacts','action'=>'leads')); ?>"><i class="fa fa-video-camera"></i>View Service</a></li>
								<li><a href="<?php echo $this->Html->url(array('controller'=>'contacts','action'=>'leads')); ?>"><i class="fa fa-video-camera"></i>View Rental</a></li>
...
<li><a href="<?php echo $this->Html->url(array('controller'=>'full_calendar','action'=>'index')); ?>"><i class="fa fa-circle-o"></i>Meetings</a></li>
<li><a href="<?php echo $this->Html->url(array('controller'=>'full_calendar','action'=>'index')); ?>"><i class="fa fa-circle-o"></i>Overdue</a></li>
<li><a href="<?php echo $this->Html->url(array('controller'=>'full_calendar','action'=>'index')); ?>"><i class="fa fa-circle-o"></i>Future</a></li>
<li><a href="<?php echo $this->Html->url(array('controller'=>'full_calendar','action'=>'index')); ?>"><i class="fa fa-circle-o"></i>Completed</a></li>
					...
					<li>
						...
						<ul class="animated fadeIn">
								<li><a href="<?php echo $this->Html->url(array('controller'=>'deals','action'=>'deals_main')); ?>"><i class="fa fa-file-text-o"></i>My Deals</a></li>
													<li><a href="<?php echo $this->Html->url(array('controller'=>'deals','action'=>'deals_main')); ?>"><i class="fa fa-legal"></i>New Deal</a></li>
													<li><a href="<?php echo $this->Html->url(array('controller'=>'deals','action'=>'deals_main')); ?>"><i class="fa fa-legal"></i>Edit Deal</a></li>
								<li><a href="finances.html?lang=en"><i class="fa fa-legal"></i>My Forms</a></li>
								<li><a href="<?php echo $this->Html->url(array('controller'=>'deals','action'=>'deals_main')); ?>"><i class="fa fa-ticket"></i>Set / Edit Fees</a></li>
													<li><a href="<?php echo $this->Html->url(array('controller'=>'deals','action'=>'deals_main')); ?>"><i class="fa fa-ticket"></i>Deals Pipline</a></li>
							</ul>
						</div>
					</li>
			<li>
			...
			<div class="navbar hidden-print main" role="navigation">
				...
				<ul class="main pull-right">
					...
					<li class="dropdown username">
						<a href="" class="dropdown-toggle" data-toggle="dropdown"><?php echo $this->Html->image('avatar-36x36.jpg',array('class'=>"img-circle",'width'=>"30")); ?><?php echo AuthComponent::user('full_name'); ?><span class="caret"></span></a>
