...
'/app/View/Themed/Default/webroot/assets/components/modules/admin/maps/vector/assets/lib/jquery-jvectormap-1.2.2.min.js?v=v1.0.3-rc2&sv=v0.0.1.1',
'/app/View/Themed/Default/webroot/assets/components/modules/admin/charts/flot/assets/lib/jquery.flot.js?v=v1.0.2&sv=v0.0.1',
'/app/View/Themed/Default/webroot/assets/components/common/forms/editors/wysihtml5/assets/lib/js/wysihtml5-0.3.0_rc2.min.js?v=v1.0.2&sv=v0.0.1',
...
'/app/View/Themed/Default/webroot/assets/components/modules/admin/charts/flot/assets/custom/js/jquery.flot.axislabels.js?v=v1.0.3-rc2', 

'/app/View/Themed/Default/webroot/assets/components/modules/admin/charts/easy-pie/assets/lib/js/jquery.easy-pie-chart.js?v=v1.0.3-rc2',
'/app/View/Themed/Default/webroot/assets/components/modules/admin/charts/sparkline/jquery.sparkline.min.js?v=v1.0.3-rc2', 
'/app/View/Themed/Default/webroot/assets/components/modules/admin/maps/vector/assets/lib/maps/jquery-jvectormap-world-mill-en.js?v=v1.0.3-rc2&sv=v0.0.1.1', 
'/app/View/Themed/Default/webroot/assets/components/common/forms/editors/wysihtml5/assets/lib/js/bootstrap-wysihtml5-0.0.2.js?v=v1.0.2&sv=v0.0.1',
...
'/app/View/Themed/Default/webroot/js/jquery/delayKeyup.js?v=v1.0.2&sv=v0.0.11', 
...
'/app/View/Themed/Default/webroot/assets/components/modules/admin/charts/flot/assets/custom/js/flotchart-bars-horizontal.init.js?v=v1.0.3-rc2',
'/app/View/Themed/Default/webroot/assets/components/modules/admin/charts/flot/assets/custom/js/flotchart-bars-vertical.init.js?v=v1.0.3-rc2',
'/app/View/Themed/Default/webroot/assets/components/modules/admin/charts/easy-pie/assets/custom/easy-pie.init.js?v=v1.0.3-rc2',
'/app/View/Themed/Default/webroot/assets/components/modules/admin/charts/sparkline/sparkline.init.js?v=v1.0.3-rc2',
...
'/app/View/Themed/Default/webroot/assets/components/common/forms/editors/wysihtml5/assets/custom/wysihtml5.init.js?v=v1.0.2&sv=v0.0.1',
...
<body class="scripts-async" >
	...
	<div class="container-fluid menu-hidden">
		...
		<?php echo $this->element('crmreport_sidebar_menu'); ?>
		<!-- Content -->
		<div id="content">
			<?php echo $this->element('crmreport_top_area'); ?>
