...
.label-danger-crmgroup {
	color: #cc3a3a !important;
	border: 2px solid #cc3a3a !important;
	font-weight: bold !important;
	font-size: 13px !important;
}
.label-warning-crmgroup {
	color: #d2ba02 !important;
	border: 2px solid #fde000 !important;
	font-weight: bold !important;
	font-size: 13px !important;
}
.label-success-crmgroup {
	color: #8bbf61 !important;
	border: 2px solid #8bbf61 !important;
	font-weight: bold !important;
	font-size: 13px !important;
}
...
<body class="scripts-async" >
	...
	<div>
		...
		<div id="content" style='margin-left: 0px;'>
			...
			<?php 
				//echo $this->element('crmgroup_top_area');
			?>
			<!-- navbar -->
