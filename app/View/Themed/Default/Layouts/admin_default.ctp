...
<?php } ?> 
'/app/View/Themed/Default/webroot/assets/components/core/js/sidebar.discover.init.js?v=v1.0.6',
'/app/View/Themed/Default/webroot/assets/components/common/forms/ckeditor/ckeditor.init.js?v=23',
...
<body class="scripts-async" >
	...
	<div class="container-fluid menu-hidden">
		...
		<?php echo $this->element('admin_sidebar_menu'); ?>
		<!-- Content -->
		<div id="content">
			<!-- navbar -->
			<?php echo $this->element('admin_layout_top_area'); ?>
			<!-- // END navbar -->
