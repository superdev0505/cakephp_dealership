                ...
                <div class="container"><div class="logo">
                    ...
                    <ul class="nav">
                        <?php if ($this->Session->read('Auth.User')): ?>
                            ...
                            <li class="<?php if ($this->params['controller'] == 'reports') echo 'active'; ?>"><a href="<?php echo $this->Html->url(array('plugin' => '', 'controller' => 'reports', 'action' => 'index')); ?>"><span><i class="icon-signal"></i></span><?php echo __('REPORTS'); ?></a></li> <li class="dropdown <?php if ($this->params['controller'] == 'deals') echo 'active'; ?>">
                          ...
                          <!-- <?php echo $this->Html->url(array('plugin' => '', 'controller' => 'Eblasts', 'action' => 'index')); ?> --><li class="<?php if ($this->params['controller'] == 'eblast'); ?>"><a href=""><span><i class="icon-envelope"></i></span><?php echo __('eBLAST'); ?></a></li>
