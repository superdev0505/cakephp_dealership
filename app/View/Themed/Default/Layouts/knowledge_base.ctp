...
<link rel="stylesheet" href="/app/View/Themed/Default/webroot/css/theme.css?v=12" />
...
'/app/View/Themed/Default/webroot/js/inventory.js?v=v1.0.2&sv=v0.0.11', 
...
<body class="scripts-async" >
	...
	<div class="container-fluid menu-hidden">
		...
		<div id="footer" class="hidden-print">
			...
			<!--  Copyright Line -->
			<div class="copy">&copy; 2014 - Dealership Performance CRM LLC - All Rights Reserved.</div>
			<!--  End Copyright Line -->
