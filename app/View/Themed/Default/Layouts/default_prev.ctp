...
<div class="row">
<div class="span2"> 
<a href="<?php echo $this->Html->url('/contacts'); ?>" ><h3 class="muted"><?php if($title) echo $title; else echo 'LightWeight CRM'; ?></h3></a>
</div>
<div class="span10">
<span style="display: inline-block;">
<ul class="nav nav-tabs">
<li class="<?php if($this->params['controller']=='dashboards') echo 'active'; ?>"><a href="<?php echo $this->Html->url(array('plugin'=>'','controller'=>'dashboards','action'=>'index')); ?>"><i class="icon-dashboard"></i> Dashboard</a>
...
<li class="<?php if($this->params['controller']=='contacts') echo 'active'; ?>"><a href="<?php echo $this->Html->url(array('plugin'=>'','controller'=>'contacts','action'=>'index')); ?>"><i class="icon-list"></i> Contacts</a>
<ul class="dropdown-menu">
<li><a href="<?php echo $this->Html->url(array('plugin'=>'','controller'=>'contacts','action'=>'add'));?>" ><i class="icon-plus"></i> <?php echo __('New Contact')?></a></li>
</ul>
...
Copyright &copy; 2013 <?php if($copyright) echo $copyright; else echo 'Dealership Performance'; ?>&nbsp;| Powered By Dealership Performance |&nbsp;
<div class="dropup">
<a class="dropdown-toggle supported-by" data-toggle="dropdown" href="#">Supported By</a>
<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
<li><a href="http://www.DealershipPerformance.com" target="_blank">Dealership Performance</a></li>
<li><a href="http://www.DealershipPerformance.com/contact-us.html" target="_blank">Dealership Performance Support</a></li>
</ul>
</div>
</div>
</div>
