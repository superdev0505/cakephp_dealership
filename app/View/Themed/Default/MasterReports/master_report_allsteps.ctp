					...
					if(isset($today_events_by_user[$key])){
						echo ( $today_events_by_user[$key] != 0)?
							$this->Html->link( $today_events_by_user[$key],
								array('controller'=>'realtime_reports','action'=>'all_event_details','todays_event', $key), array('class'=>'realtime_stat_details no-ajaxify')
							)
						  	: '0';
					...
					if(isset($overdue_events_by_user[$key])){
						echo ($overdue_events_by_user[$key] != 0)?
							$this->Html->link( $overdue_events_by_user[$key],
								array('controller'=>'realtime_reports','action'=>'all_event_details','overdue', $key), array('class'=>'realtime_stat_details no-ajaxify')
							)
						  	: '0';
				...
				<tr class="text-primary">
					...
					echo ( $total_today != 0)?
							$this->Html->link( $total_today,
								array('controller'=>'realtime_reports','action'=>'all_event_details','todays_event', 'all'), array('class'=>'realtime_stat_details no-ajaxify')
							)
						  	: '0';
					...
					echo ($total_overdue != 0)?
							$this->Html->link( $total_overdue,
								array('controller'=>'realtime_reports','action'=>'all_event_details','overdue', 'all'), array('class'=>'realtime_stat_details no-ajaxify')
							)
						  	: '0';
