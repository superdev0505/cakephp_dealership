...
we were calling to ask some quick questions regarding your recent dealings with the dealership- If you would please give us a call back at 817-592-9416. <br/><br />
...
Thanks and have a great day!!</label>
 ...
 <hr />
									...
									<div class="col-md-10">
										...
										with <i style="font-size: 14px;"><?php echo "Freedom Powersports"; ?></i> . I have a couple of quick questions about your recent experience with our <i style="font-size: 14px;"><?php echo $dealer; ?></i> dealership. It should take less than a minute.
                                        <br/><br/>
									...
									<div class="col-md-10">
										<label>1. Have you determined if we will be earning your business?</label>
										<?php echo $this->Form->input('SurveyAnswer.145.answer', array('type' => 'select','class' => 'form-control','options'=>array('no' => 'No','positive_no' => 'Positive No','negative_no' => 'Negative No','yes' => 'Yes'),'empty' => 'select'));

										echo $this->Form->hidden('SurveyAnswer.145.question_id',array('value'=>'145'));
										echo $this->Form->hidden('SurveyAnswer.145.bdc_survey_id',array('value'=>''));
										?>
										<div class="separator"></div>
									</div>

									<div class="col-md-10" id="option_div" style="display:none;">
										<label>No-I regret to hear that, what could we have done better?  </label>
										<?php echo $this->Form->input('SurveyAnswer.146.answer', array('type' => 'textarea', 'class' => 'form-control novalidate','value'=>''));
										echo $this->Form->hidden('SurveyAnswer.146.question_id',array('value'=>'146'));
										echo $this->Form->hidden('SurveyAnswer.146.bdc_survey_id',array('value'=>''));

										?>
										<div class="separator"></div>
                                        	<label id="option_positive_no" class="option-div">Positive no- We look forward to staying in contact with you and earning your business in the future</label>

                                            <label class="option-div" id="option_negative_no">Negative no- Again, I regret hear that. Freedom’s owner has said we are not to loose any deals is it ok if I have member of our senior management team give you a call to make sure you get the best deal?
                                        <?php echo $this->Form->input('SurveyAnswer.147.answer', array('type' => 'select','class' => 'form-control novalidate','options'=>array('yes' => 'Yes','no' => 'No'),'empty' => 'select'));

										echo $this->Form->hidden('SurveyAnswer.147.question_id',array('value'=>'147'));
										echo $this->Form->hidden('SurveyAnswer.147.bdc_survey_id',array('value'=>''));
										?>
                                        </label>
									...
									<div class="col-md-10 option-div" id="option_yes" style="display:none;">
										<label>Yes- Wonderful, glad to hear it and welcome to the freedom family! Is there anything we can do to help you with before you pick it up? <br/>
                                        Confirm the phone number they want us to use.
                                        </label>
										<?php echo $this->Form->input('SurveyAnswer.148.answer', array('type' => 'textarea', 'class' => 'form-control novalidate','value'=>''));
										echo $this->Form->hidden('SurveyAnswer.148.question_id',array('value'=>'148'));
										echo $this->Form->hidden('SurveyAnswer.148.bdc_survey_id',array('value'=>''));
									...
									<div class="col-md-10">
										<label class="appointment-set" style="display:none;">	Great, you have an appointment set for <span id="appointment_date_time"></span> I will let the General Manager know to expect you so they can get a deal worked out for you! Have a great day!</label>
                                        <label class="appointment-refused" style="display:none;">	Thank you for the opportunity to work with you, I hate to hear that we are unable to earn your business but please keep us in mind! Have a wonderful day!</label>
										<div class="separator"></div>
									</div>
                                    <div class="col-md-10">
...
$(function(){
	...
	$("#SurveyAnswer123Answer").on('change',function(){
			if($(this).val() == 'Yes'){
			$("#lead_appointment").trigger('click');
			$(".appointment-refused").hide();
			}
			else{
			$(".appointment-refused").show();
			}
		});

	$("#SurveyAnswer145Answer").on('change',function(){
		$val = $(this).val();
		$(".option-div").hide();
		if($val != '')
		{
