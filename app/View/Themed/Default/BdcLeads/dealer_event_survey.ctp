                    ...
                    <?php //echo $this->element('other_location_bdc_leads'); ?>
                        ...
                        <?php echo $this->Form->hidden('BdcLead.id',array('value'=>$id)); ?>
                           ...
                           <div class="col-md-10" id="VoicemailScript" style="display:none">
                                ...
                                <label>  Hi <i style="font-size: 14px;color:#4193d0;"><?php echo  $contact_info['BdcLead']['full_name']; ?></i>  my name is <i style="font-size: 14px;color:#4193d0;"><?php echo  $sperson; ?></i> I am calling on behalf of

 <i style="font-size: 14px;color:#4193d0;"><?php echo $dealer; ?></i> customer service department.No reason for a call back. <br /><br />

I was just calling to invite you to a special event being held for the dealerships "Very important Riders".<br /><br />


As an attending guest of the event, the dealership is offering a $1,500 shopping spree with the purchase of any new 2015 Big Twin and a $1,000 shopping spree with a purchase of any new 2015 Sportster. In addition, the dealership is extending this offer to your family and friends if you bring them along! <br /><br />
This special event is kicking off today and running through May 2nd at the dealership located at: 1116 oak forest dr. in Onalaska. This is a great opportunity to purchase or trade in! If you have any questions or would like more information on the event, please call the dealership directly at (608) 783-6112.<br /><br/>
We sure look forward to seeing you there! Take care, Thanks.
 ...
 <hr />
									...
									<div class="col-md-10">
										...
										calling on behalf of <i style="font-size: 14px;"><?php echo $dealer; ?></i> customer service department.how are you? </label> <br /><br />
              <label>GREAT! The reason for this quick call is you are listed as a very important rider with <?php echo $dealer; ?> and we would like to invite you to a special event. </label>
              <br /><br />
              <label>As an attending guest of the event, the dealership is offering a $1,500 shopping spree with the purchase of any new 2015 Big Twin and $1,000 with the purchase of any new 2015 "Sportster". In addition, the dealership is extending this invitation to your family and friends if you bring them along! If you are looking to purchase, or trade in your current bike, this is a great opportunity! This event starts today and only runs through May 2nd.  </label>
              <br/><br />
              <label><?php echo $dealer; ?> is proud to have you as a very important rider ,and excited, as we hope you are, to extend this invitation!</label>
										<div class="separator"></div>
									</div>


									<div class="col-md-10">
										<label>1.	Can I mark you as "attending"?
									...
									<div class="col-md-10">
										<label>2. Would you like the dealership's address?

										<?php echo $this->Form->input('SurveyAnswer.95.answer', array('options' => array('n/a' => 'N/A','yes' => 'Yes','no' => 'No','maybe' => 'Maybe'), 'type' => 'select', 'class' => 'form-control'));?>
                                         <br />Dealerships address is:  1116 Oak Forest Dr, Onalaska, WI 54650
                                        <br />Their phone number is: (608) 783-6112

                                        </label>
                                        <?php
										echo $this->Form->input('95.1', array('type' => 'textarea','class' => 'form-control novalidate'));
										echo $this->Form->hidden('SurveyAnswer.95.question_id',array('value'=>'95'));
										echo $this->Form->hidden('SurveyAnswer.95.bdc_survey_id',array('value'=>''));
									...
									<div class="col-md-10">
										<label>2. If you have any questions, I can have someone from the dealership give you a call. Would you like me to forward your information for a call back?
										<?php echo $this->Form->input('SurveyAnswer.96.answer', array('options' => array('n/a' => 'N/A','yes' => 'Yes','no' => 'No','maybe' => 'Maybe'), 'type' => 'select', 'class' => 'form-control'));?></label>
                                        <?php
										echo $this->Form->input('96.1', array('type' => 'textarea','class' => 'form-control novalidate' ,'style' => 'display:none;'));
										echo $this->Form->hidden('SurveyAnswer.96.question_id',array('value'=>'96'));
										echo $this->Form->hidden('SurveyAnswer.96.bdc_survey_id',array('value'=>''));
									...
									<div class="col-md-10">
										<label>	Thanks so much for your time, we look forward to seeing you there! </label>
										<div class="separator"></div>
									</div>
                                    <div class="col-md-10">
			...
			success: function(){
					...
					success: function(data){
						...
						$.ajax({
							type: "GET",
							cache: false,
							url:  "/bdc_leads/event_sold_result/lead_action:event_solds/search_all2:"+search_all2+"/search_all:"+search_all+"/search_all_value:/selected_lead_type",
							success: function(data){
