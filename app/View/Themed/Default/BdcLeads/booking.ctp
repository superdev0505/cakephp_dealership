<body class="scripts-async">
	...
	<ul class="list-unstyled">
		...
		<li>
			...
			<div id="sidebar-discover-social" class="sidebar-discover-menu">
				...
				<ul class="animated fadeIn">
					<li><a href="index.html?lang=en">Analytics</a></li>
		...
		<li>
			<a href="#sidebar-discover-media" class="glyphicons picture" data-toggle="sidebar-discover"><span class="badge pull-right badge-primary hidden-md">2</span><i></i><span>Media</span></a>
			<div id="sidebar-discover-media" class="sidebar-discover-menu">
				...
				<ul class="animated fadeIn">
					...
					<li><a href="gallery.html?lang=en"><i class="fa fa-camera"></i> Photo Gallery</a></li>
				</ul>
			</div>
		</li>
		...
		<li>
			...
			<div id="sidebar-discover-email" class="sidebar-discover-menu">
				...
				<ul class="animated fadeIn">
					<li><a href="email.html?lang=en"><i class="fa fa-envelope"></i> Inbox</a></li>
					<li><a href="email_compose.html?lang=en"><i class="fa fa-pencil"></i> Compose</a></li>
				</ul>
			</div>
		</li>
		...
		<li class="active">
			...
			<div id="sidebar-discover-financial" class="sidebar-discover-menu">
				...
				<ul class="animated fadeIn">
					...
					<li class="active"><a href="bookings.html?lang=en"><i class="fa fa-ticket"></i> Bookings</a></li>
				</ul>
			</div>
		</li>
	...
	<ul class="main pull-left hidden-xs">
		...
		<li class="dropdown">
			...
			<ul class="dropdown-menu">
				...
				<li><a href="tables_responsive.html?lang=en">Tables Responsive</a></li>
		...
		<li>
			<ul class="colors pull-left hidden-xs">
		
				<li class="active"><a href="?module=admin&page=bookings&url_rewrite=&build=&v=v1.0.2&skin=style-default" style="background-color: #3695d5" class="no-ajaxify"><span class="hide">style-default</span></a></li>
				<li><a href="?module=admin&page=bookings&url_rewrite=&build=&v=v1.0.2&skin=alizarin-crimson" style="background-color: #F06F6F" class="no-ajaxify"><span class="hide">alizarin-crimson</span></a></li>
				<li><a href="?module=admin&page=bookings&url_rewrite=&build=&v=v1.0.2&skin=green-army" style="background-color: #9FB478" class="no-ajaxify"><span class="hide">green-army</span></a></li>
		...
		<li class="dropdown">
			...
			<ul class="dropdown-menu pull-right">
								<li><a href="?module=admin&page=bookings&url_rewrite=&build=&v=v1.0.2&skin=brown"><span class="color" style="background-color: #d39174" class="no-ajaxify"></span> brown</a></li>
								<li><a href="?module=admin&page=bookings&url_rewrite=&build=&v=v1.0.2&skin=purple-gray"><span class="color" style="background-color: #AF86B9" class="no-ajaxify"></span> purple-gray</a></li>
								<li><a href="?module=admin&page=bookings&url_rewrite=&build=&v=v1.0.2&skin=blue-gray"><span class="color" style="background-color: #7293CF" class="no-ajaxify"></span> blue-gray</a></li>
								<li><a href="?module=admin&page=bookings&url_rewrite=&build=&v=v1.0.2&skin=purple-wine"><span class="color" style="background-color: #CC6788" class="no-ajaxify"></span> purple-wine</a></li>
								<li><a href="?module=admin&page=bookings&url_rewrite=&build=&v=v1.0.2&skin=black-and-white"><span class="color" style="background-color: #979797" class="no-ajaxify"></span> black-and-white</a></li>
								<li><a href="?module=admin&page=bookings&url_rewrite=&build=&v=v1.0.2&skin=amazon"><span class="color" style="background-color: #8BC4B9" class="no-ajaxify"></span> amazon</a></li>
								<li><a href="?module=admin&page=bookings&url_rewrite=&build=&v=v1.0.2&skin=amber"><span class="color" style="background-color: #CACA8A" class="no-ajaxify"></span> amber</a></li>
								<li><a href="?module=admin&page=bookings&url_rewrite=&build=&v=v1.0.2&skin=android-green"><span class="color" style="background-color: #A9C784" class="no-ajaxify"></span> android-green</a></li>
								<li><a href="?module=admin&page=bookings&url_rewrite=&build=&v=v1.0.2&skin=antique-brass"><span class="color" style="background-color: #B3998A" class="no-ajaxify"></span> antique-brass</a></li>
								<li><a href="?module=admin&page=bookings&url_rewrite=&build=&v=v1.0.2&skin=antique-bronze"><span class="color" style="background-color: #8D8D6E" class="no-ajaxify"></span> antique-bronze</a></li>
								<li><a href="?module=admin&page=bookings&url_rewrite=&build=&v=v1.0.2&skin=artichoke"><span class="color" style="background-color: #B0B69D" class="no-ajaxify"></span> artichoke</a></li>
								<li><a href="?module=admin&page=bookings&url_rewrite=&build=&v=v1.0.2&skin=atomic-tangerine"><span class="color" style="background-color: #F19B69" class="no-ajaxify"></span> atomic-tangerine</a></li>
								<li><a href="?module=admin&page=bookings&url_rewrite=&build=&v=v1.0.2&skin=bazaar"><span class="color" style="background-color: #98777B" class="no-ajaxify"></span> bazaar</a></li>
								<li><a href="?module=admin&page=bookings&url_rewrite=&build=&v=v1.0.2&skin=bistre-brown"><span class="color" style="background-color: #C3A961" class="no-ajaxify"></span> bistre-brown</a></li>
								<li><a href="?module=admin&page=bookings&url_rewrite=&build=&v=v1.0.2&skin=bittersweet"><span class="color" style="background-color: #d6725e" class="no-ajaxify"></span> bittersweet</a></li>
								<li><a href="?module=admin&page=bookings&url_rewrite=&build=&v=v1.0.2&skin=blueberry"><span class="color" style="background-color: #7789D1" class="no-ajaxify"></span> blueberry</a></li>
								<li><a href="?module=admin&page=bookings&url_rewrite=&build=&v=v1.0.2&skin=bud-green"><span class="color" style="background-color: #6fa362" class="no-ajaxify"></span> bud-green</a></li>
								<li><a href="?module=admin&page=bookings&url_rewrite=&build=&v=v1.0.2&skin=burnt-sienna"><span class="color" style="background-color: #E4968A" class="no-ajaxify"></span> burnt-sienna</a></li>
							</ul>
		</li>
	</ul>
		</li>
	...
	<ul class="main pull-right">
		...
		<li class="dropdown username">
			<a href="" class="dropdown-toggle" data-toggle="dropdown"><img src="../assets/images/people/35/2.jpg" class="img-circle" width="30"/> Bill Jonson <span class="caret"></span></a>
			...
			<ul class="dropdown-menu pull-right">
				...
				<li><a href="login.html?lang=en" class="glyphicons lock no-ajaxify"><i></i>Logout</a></li>
		    </ul>
		</li>
	</ul>
</div>
