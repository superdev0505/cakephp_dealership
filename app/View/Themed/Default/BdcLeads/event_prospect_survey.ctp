...
The reason for my call is to invite you to a special event the dealership is having for their very important customers, their friends and family.  <i style="font-size: 14px;color:#4193d0;"><?php echo $dealer; ?></i> is offering a $1500 shopping spree with the purchase of a NEW 2015 Big Twin and $1,000 on the purchase of a new 2015 Sportster!If you have any questions or would just like more information on the event, please call the dealership directly at (608) 783-6112.<br/>
	...
	$(".BdcInvalidLead").on('click',function(e){
		...
		$.ajax({
			...
			success: function(data){
				...
				type: "GET",
				cache: false,
				url: "<?php echo $this->Html->url(array('controller'=>'bdc_leads','action'=>'lead_details','event_solds' => 'event_solds')); ?>/"+next_id,
				success: function(data){
