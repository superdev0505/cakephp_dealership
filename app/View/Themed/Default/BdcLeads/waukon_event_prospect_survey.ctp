...
<?php 		if(!empty($last_call))
                    ...
                    <?php echo $this->element('other_location_bdc_leads'); ?>
                        ...
                        <?php echo $this->Form->hidden('BdcLead.id',array('value'=>$id)); ?>
                           ...
                           <div class="col-md-10" id="VoicemailScript" style="display:none">
                                ...
                                <label>  Hi <i style="font-size: 14px;color:#4193d0;"><?php echo  $contact_info['BdcLead']['full_name']; ?></i>  my name is <i style="font-size: 14px;color:#4193d0;"><?php echo  $sperson; ?></i> and I was calling to invite you, your family, and friends, down to Waukon Harley-Davidson’s Cabin Fever Party on Saturday, February 18th. The party kicks off at 11am with a Chili Feed. Take advantage of the 20% off Licensed Clothing and 10% off Accessories that you can fit into a Harley-Davidson shopping bag! One bag will be provided per customer. Plus, the 2016 Model Year Clearance Sale is happening now. Get the lowest prices of the year on New 2016 Harley-Davidson motorcycles!  
 ...
 <hr />
									...
									<div class="col-md-10">
                                    <label>	Hi, my name is <i style="font-size: 14px;"><?php echo  $sperson; ?></i> and  I was calling to invite you, your family, and friends, down to Waukon Harley-Davidson’s Cabin Fever Party on Saturday, February 18th. <br/><br/>
                    The party kicks off at 11am with a Chili Feed. Take advantage of the 20% off Licensed Clothing and 10% off Accessories that you can fit into a Harley-Davidson shopping bag! One bag will be provided per customer. Plus, the 2016 Model Year Clearance Sale is happening now. Get the lowest prices of the year on New 2016 Harley-Davidson motorcycles!                 
                                     </label>             
              <br />
									...
									<div class="col-md-10">
										<label> Does this sound like something you would like to attend? 
										<?php echo $this->Form->input('SurveyAnswer.97.answer', array('type' => 'select','class' => 'form-control','options' => array('yes' => 'Yes','no' => 'No','maybe' => 'Maybe'),'empty'=>'select')); 
                                 ...
                                 <br /><br/>
                                 (if maybe): Well, we sure hope to see you down there. If you have any questions on the event, please give the dealership a call directly (CSR offer dealership contact information below)
                                 <br/><br/>
                                 
                               
                             (if No) "Well, we hope you can make it to the next big event or stop in whenever you can to check out the new inventory. Thanks for taking my call and have a great day.)<br/>                         
                               <br/><br/>
                               DEALERSHIP DETAILS:<br/>

WAUKON HARLEY-DAVIDSON<br/>
208 HWY 9 SW WAUKON IA 52172<br/>
PHONE: (563) 568-3471<br/>
FAX: (563) 568-3690<br/>
(Hwy 9 and 76 S.)<br/>
Hours of the event 9-5<br/>
TUE-FRI 9-6 | SAT 9-5<br/>
CLOSED SUN-MON
			...
			success: function(){
					...
					success: function(data){
						...
						$.ajax({
							type: "GET",
							cache: false,
							url:  "/bdc_leads/event_sold_result/"+$load_first+"/lead_action:event_leads/search_all2:"+search_all2+"/search_all:"+search_all+"/search_all_value:/selected_lead_type",
							success: function(data){
