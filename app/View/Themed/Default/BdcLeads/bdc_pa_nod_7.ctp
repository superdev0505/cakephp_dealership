			...
			<div class="wizard">
				<div class="widget  widget-tabs-responsive">
					...
					<div class="widget-head" style="height:70px;padding-left:5px;">
						Welcome to the dealership family P&A Needs offer discount (Call 1) - 10 days 
                    ...
                    <div class="col-md-10">
                        ...
                        &nbsp;&nbsp;<strong>Status:<?php echo $contact_info['BdcLead']['status']; ?></strong>
                        ...
                        <?php echo $this->Form->hidden('BdcLead.id',array('value'=>$id)); ?>
                            ...
                            <div class="col-md-10">
								...
								echo $this->Form->hidden('BdcSurvey.survey_id',array('value'=>7));
								...
								echo $this->Form->hidden('BdcSurvey.lead_sales_step',array('value'=>$contact_info['BdcLead']['sales_step']));
									...
									<div class="col-md-10">
									<label>	Congratulations on your recent purchase! The reason for the call is introduce myself and to invite you down to the dealership for a special VIP fitting and add on accessories appointment. When would be the best time to come down to the dealership and get introduced to our staff?</label> 
                                    
                                    <?php echo $this->Form->input('SurveyAnswer.79.answer', array('type' => 'textarea','class' => 'form-control','value'=>''));
										echo $this->Form->hidden('SurveyAnswer.79.question_id',array('value'=>'79'));
										echo $this->Form->hidden('SurveyAnswer.79.bdc_survey_id',array('value'=>''));
										?>
										<div class="separator"></div>
									</div>
...
$(function(){
	...
	$("a#skip_lead")function(event)
	{
		...
		if(next_id)
		{
			$.ajax({
					type: "GET",
					cache: false,
					url: "/bdc_leads/bdc_pa_nod_7/"+next_id,
	...
	$("a#btn-cancel-survey")function(event){
		event.preventDefault();
		$.ajax({
			type: "GET",
			cache: false,
