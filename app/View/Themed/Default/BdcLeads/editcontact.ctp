...
<div class="wizard">
	<div class="widget widget-tabs widget-tabs-responsive">
		...
		<div class="widget-body">
			<?php echo $this->Form->create('Contact', array('action' => 'editcontact', 'class' => 'form-inline')); ?>
			<div class="tab-content">
				...
				<div class="tab-pane active" id="tab1-1">
					<div class="row">
						...
						<div class="col-md-3">
							...
							<?php echo $this->Form->select('status', $options, array('empty' => 'Select', 'required' => 'required', 'selected' => $this->request->input['Contact']['status'], 'class' => 'form-control','style'=>'width: 100%')); ?>
							<div class="separator"></div>
						</div>
						<div class="col-md-3">
				...
				<div class="tab-pane" id="tab2-1">
					...
					<div class="row">
						<div class="col-md-3">
							...
							'Male' => 'Male',
							'Female' => 'Female'
							), 'empty' => 'Select', 'selected' => '','required' => 'required','label'=>false,'div'=>false, 'selected' => $this->request->input['Contact']['gender'], 'class' => 'form-control','style'=>'width: 100%'));
							?>
							<div class="separator"></div>
						</div>
						<div class="col-md-3">
				...
				<div class="tab-pane" id="tab4-1">
					<div class="row">
						...
						<div class="col-md-3">
							...
							'Rental' => 'Rental',
							'Demo' => 'Demo'
							), 'empty' => 'Select', 'Select', 'selected' => '','label'=>false,'div'=>false,'selected' => $this->request->input['Contact']['condition'], 'class' => 'form-control','style'=>'width: 100%'));
							?>
							<div class="separator"></div>
						</div>
						<div class="col-md-3">
					...
					<div class="row">
						<div class="col-md-3">
							...
							<?php echo $this->Form->input('make', array('type' => 'select', 'required' => 'required', 'options' => array(
								...
								'Watsonian' => 'Watsonian',
								'Zero' => 'Zero',
							), 'empty' => 'Select', 'selected' => '','label'=>false,'div'=>false,'selected' => $this->request->input['Contact']['make'], 'class' => 'form-control','style'=>'width: 100%'));
							?>
							<div class="separator"></div>
						</div>
						<div class="col-md-3">
						...
						<div class="col-md-3">
							...
							<?php echo $this->Form->input('type', array('type' => 'select', 'required' => 'required', 'options' => array(
								...
								'UTV' => 'UTV',
							), 'empty' => 'Select', 'selected' => '', 'selected' => $this->request->input['Contact']['type'], 'label'=>false,'div'=>false, 'class' => 'form-control','style'=>'width: 100%'));
							?>
							<div class="separator"></div>
						</div>
						<div class="col-md-3">
				...
				<div class="tab-pane" id="tab5-1">
					<div class="row">
						<div class="col-md-3">
							<?php echo $this->Form->label('transmission','Trans:'); ?>
							<?php echo $this->Form->input('transmission', array('type' => 'text','label'=>false,'div'=>false, 'class' => 'form-control')); ?>
							<div class="separator"></div>
						</div>
						<div class="col-md-3">
							<?php echo $this->Form->label('drivetrain','Drivetrain:'); ?>
							<?php echo $this->Form->input('drivetrain', array('type' => 'text','label'=>false,'div'=>false, 'class' => 'form-control')); ?>
							<div class="separator"></div>
						</div>
						<div class="col-md-3">
				...
				<div class="tab-pane" id="tab6-1">
					<div class="row">
						...
						<div class="col-md-3">
							...
							'Rental' => 'Rental',
							'Demo' => 'Demo'
							), 'empty' => 'Select', 'Select', 'selected' => '','label'=>false,'div'=>false,'selected' => $this->request->input['Contact']['condition_trade'],'style'=>'width: 100%','class' => 'form-control'));
							?>
							<div class="separator"></div>
						</div>
						<div class="col-md-3">
...
'2001' => '2001',
'2000' => '2000',
							), 'empty' => 'Select', 'selected' => '','label'=>false,'div'=>false,'selected' => $this->request->input['Contact']['year_trade'],'style'=>'width: 100%','class' => 'form-control'));
							?>
							<div class="separator"></div>
						</div>
					</div>
...
'Watsonian' => 'Watsonian',
'Zero' => 'Zero',
							), 'empty' => 'Select', 'selected' => '', 'selected' => $this->request->input['Contact']['make_trade'],'label'=>false,'div'=>false,'style'=>'width: 100%','class' => 'form-control')); ?>
							<div class="separator"></div>
						</div>
						<div class="col-md-3">
...
'Utility Vehicle' => 'Utility Vehicle',
'UTV' => 'UTV',
							), 'empty' => 'Select', 'selected' => '', 'selected' => $this->request->input['Contact']['type_trade'],'style'=>'width: 100%','label'=>false,'div'=>false,'class' => 'form-control')); ?>
							<div class="separator"></div>
						</div>
						<div class="col-md-3">
							<?php echo $this->Form->label('engine_trade','Engine/T:'); ?> 
				...
				<div class="tab-pane" id="tab7-1">
					<div class="row">
						<div class="col-md-3">
							<?php echo $this->Form->label('transmission_trade','Trans/T:'); ?> 
							<?php echo $this->Form->input('transmission_trade', array('type' => 'text', 'label'=>false,'div'=>false,'class' => 'form-control')); ?>
							<div class="separator"></div>
						</div>
						<div class="col-md-3">
							<?php echo $this->Form->label('drivetrain_trade','Drivetrain/T:'); ?> 
							<?php echo $this->Form->input('drivetrain_trade', array('type' => 'text', 'label'=>false,'div'=>false,'class' => 'form-control')); ?>
							<div class="separator"></div>
						</div>
						<div class="col-md-3">
					...
					<div class="row">
						...
						<div class="col-md-3">
							<?php echo $this->Form->label('zone','Time Zone:'); ?>
							<?php echo $this->Form->input('zone', array('type' => 'text', 'readonly' => 'true', 'label'=>false,'div'=>false, 'value' => "$zone", 'class' => 'form-control')); ?>
							Current Log Date:&nbsp;<?php echo $datetimefullview; ?>
							<div class="separator"></div>
						</div>
						<div class="col-md-3">
			...
			<button type="submit" class="btn btn-success"><i class="fa fa-save"></i> Save Log</button>
