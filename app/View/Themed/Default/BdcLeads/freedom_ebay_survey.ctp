...
<?php 		if(!empty($last_call))
            ...
            <strong>Note : </strong><span style="font-size:12px;"><?php echo $this->Text->truncate(strip_tags($contact_info['BdcLead']['notes']),250); ?> </span> 
					...
					<div class="widget-body"> 
                       ...
                       <tr>
                       <td colspan="4" class="bg-primary"><strong>Update log Contact Info:</strong></td>
                       </tr>
...
I just had a quick question for you. If you could give me a call back at your convenience, I would appreciate it. My phone number is ______. Again this is <i style="font-size: 14px;color:#4193d0;"><?php echo  $sperson; ?></i> give me a call back at _____. Thank you, and I look forward to hearing from you!            
</label>
 ...
 <hr />
									...
									<div class="col-md-10">
										<label>	Hey this is <i style="font-size: 14px;"><?php echo  $sperson; ?></i> at <i style="font-size: 14px;"><?php echo $dealer; ?></i>. Is this <i style="font-size: 14px;"><?php echo  $contact_info['BdcLead']['full_name']; ?></i> ? Great! How are you today? I just had a quick question for you, is now a good time?   
									...
									<div class="col-md-10">
										<label> Do you still have <i style="font-size: 14px;"><?php echo $contact_info['BdcLead']['make'].' '.$contact_info['BdcLead']['model'].' '.$contact_info['BdcLead']['year'] ?> </i>?
										<?php echo $this->Form->input('SurveyAnswer.124.answer', array('type' => 'select','class' => 'form-control','options' => array('yes' => 'Yes','no' => 'No'),'empty'=>'select')); 
										
										echo $this->Form->hidden('SurveyAnswer.124.question_id',array('value'=>'124'));
										echo $this->Form->hidden('SurveyAnswer.124.bdc_survey_id',array('value'=>''));
										?>
                                        </label> 
											<div class="separator"></div>
									</div>
                                    ...
                                    <div class="col-md-10 do-have-secion" style="display:none;">
										<label> Awesome! How is it treating you? Wonderful! I just wanted you to know we are looking for pre-owned inventory and that particular model is one we are looking for. What do you think about trading it in or selling it outright?
										<?php echo $this->Form->input('SurveyAnswer.125.answer', array('type' => 'select','class' => 'form-control novalidate','options' => array('trade_in' => 'TradeIn','seller' => 'Seller','not_interested' => 'Not Interested'),'empty'=>'select')); 
										
										echo $this->Form->hidden('SurveyAnswer.125.question_id',array('value'=>'125'));
										echo $this->Form->hidden('SurveyAnswer.125.bdc_survey_id',array('value'=>''));
										?>
                                          <a href="<?php echo $this->Html->url(array('controller'=>'contacts_transfer','action' => 'lead_transfer_location',$contact_info['BdcLead']['id'],'action_source'=>'bdc_survey_form')); ?>" class="btn btn-primary pull-right no-ajaxify" style="display:none;" id="transfer_lead_location_link">Location Transfer</a>
                                        </label> 
                                     ...
                                     <div class="col-md-10 not-have-secion" style="display:none;">
										<label>Oh, do you still ride? What are you riding now? 
										<?php echo $this->Form->input('SurveyAnswer.126.answer', array('type' => 'select','class' => 'form-control','options' => array('yes' => 'Yes','no' => 'No'),'empty'=>'select')); 
										
										echo $this->Form->hidden('SurveyAnswer.126.question_id',array('value'=>'126'));
										echo $this->Form->hidden('SurveyAnswer.126.bdc_survey_id',array('value'=>''));
										?>
                                        </label> 
											<div class="separator"></div>
									</div>
                                    ...
                                    <div class="col-md-10">
										<label> Do you need any parts for the unit?
										<?php echo $this->Form->input('SurveyAnswer.127.answer', array('type' => 'select','class' => 'form-control','options' => array('yes' => 'Yes','no' => 'No'),'empty'=>'select'));
										
										echo $this->Form->hidden('SurveyAnswer.127.question_id',array('value'=>'127'));
										echo $this->Form->hidden('SurveyAnswer.127.bdc_survey_id',array('value'=>''));
										?>
                                        </label>
                                        <br/>
                                        <label id="parts_email_container" style="display:none;">
                                         <input type="checkbox" name="part_send_email" id ="partSendEmail" value="yes" /> &nbsp; Send Email to Parts Mgr. 
                                        </label> 
											<div class="separator"></div>
									</div>
                                    
                                    <div class="col-md-10">
										<label> Do you need service for the unit?
										<?php echo $this->Form->input('SurveyAnswer.128.answer', array('type' => 'select','class' => 'form-control','options' => array('yes' => 'Yes','no' => 'No'),'empty'=>'select'));
										
										echo $this->Form->hidden('SurveyAnswer.128.question_id',array('value'=>'128'));
										echo $this->Form->hidden('SurveyAnswer.128.bdc_survey_id',array('value'=>''));
										?>
                                        </label> 
                                        
                                         <br/>
                                        <label id="service_email_container" style="display:none;">
                                         <input type="checkbox" name="service_send_email" id ="serviceSendEmail" value="yes" /> &nbsp; Send Email to Service Mgr.
                                        </label> 
											<div class="separator"></div>
									</div>
                               ...
                               <br />
                               <label> Select Location <?php 
							    echo $this->Form->input('location_dealer_id', array('type' => 'select','class' => 'form-control novalidate','options' => $dealer_locations,'empty'=>'select location','name' => 'location_dealer_id'));
							   ?></label>
                                    <div class="separator"></div>
                                    </div>
                                    <?php //} ?>
...
$("#SurveyAnswer125Answer").on('change',function(){
		$val = $(this).val();
		if($val == 'trade_in' || $val == 'seller')
		{
			$("#transfer_lead_location_link").show();
			$("#transfer_lead_location_link").trigger('click');
			
		}else
		{
			$("#transfer_lead_location_link").hide();
		}
...
// Location transfer
	...
	$("#SurveyAnswer124Answer").on('change',function(){
		$(".do-have-secion,.not-have-section").slideUp();
		$("#SurveyAnswer125Answer,#SurveyAnswer126Answer").addClass('novalidate');
		$val = $(this).val();
		if($val == 'yes')
		{
			$("#SurveyAnswer125Answer").removeClass('novalidate');
			$(".do-have-secion").slideDown();
		}else if($val == 'no')
		{
			$("#SurveyAnswer126Answer").removeClass('novalidate');
