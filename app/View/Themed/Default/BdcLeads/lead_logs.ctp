...
$this->Paginator->options(
        array('update'=>'div.modalBody',
                'url'=>array('controller'=>'bdc_leads', 
'action'=>'lead_logs')));
?>
<?php
...
<table class="table table-striped table-responsive swipe-horizontal table-condensed table-primary">
                    ...
                    <tbody >
                     <tr class="text-primary">
							<td>Lead&nbsp;</td>
							<td><?php echo  $log['Contact']['sperson']; ?>&nbsp;</td>
							<td><?php echo  $custom_step_map[ $log['Contact']['sales_step'] ]; ?>&nbsp;</td>
							<td><?php echo $log['Contact']['status']; ?>&nbsp;</td>
							
							<td style="word-break:break-all;"><?php 
							
							echo  $log['Contact']['notes']; 
							
							?>&nbsp;
                            </td>
                            <td><?php echo $log['Contact']['modified_full_date']; ?>&nbsp;</td>
						</tr>
                    ...
                    <tr class="text-primary">
							...
							<td>
								<?php echo  (isset($custom_step_map[ $entry['sales_step'] ])) ?  $custom_step_map[ $entry['sales_step'] ]  :  $entry['sales_step'] ;   ?>
								&nbsp;
							</td>
