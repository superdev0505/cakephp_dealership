		...
		<div class="col-md-12">
			<div class="wizard">
				<div class="widget  widget-tabs-responsive">
                    ...
                    <div class="col-md-10">
									<strong><?php echo  $contact_info['BdcLead']['full_name'];?></strong>&nbsp;&nbsp;&nbsp;<strong>Status:<?php echo $contact_info['BdcLead']['status']; ?></strong>
                        ...
                        <?php echo $this->Form->hidden('BdcLead.id',array('value'=>$id)); ?>
                            ...
                            <div class="col-md-10">
								...
								echo $this->Form->hidden('BdcSurvey.survey_id',array('value'=>10));
								...
								echo $this->Form->hidden('BdcSurvey.lead_sales_step',array('value'=>$contact_info['BdcLead']['sales_step']));
									...
									<div class="col-md-10">
									<label>	Hi my name is <i style="font-size: 14px;"><?php echo  $sperson; ?></i> and the reason for the call is I wanted to check in with you and see if the dealership has taken care of your previous and current needs? (Great! Or) I am sorry to hear that I will immediately pass this along to the appropriate manager to get you taken care of immediately. I will also pass this along to the dealerships senior management to make them aware as well. Please except my apologies and we will be working immediately to make you a fully satisfied customer!! </label> <?php echo $this->Form->input('SurveyAnswer.82.answer', array('type' => 'textarea','class' => 'form-control','value'=>''));
										echo $this->Form->hidden('SurveyAnswer.82.question_id',array('value'=>'82'));
										echo $this->Form->hidden('SurveyAnswer.82.bdc_survey_id',array('value'=>''));
										?>
										<div class="separator"></div>
									</div>
	...
	$("a#skip_lead").on('click'function(event)
	{
		...
		if(next_id)
		{
			$.ajax({
					type: "GET",
					cache: false,
					url: "/bdc_leads/bdc_deal_care_10/"+next_id,
