...
I will try you back at a more convenient time. Thanks, and have a great day!!</label>
 ...
 <hr />
									...
									<div class="col-md-10">
										<label>Hello.  May I speak with <i style="font-size: 14px;"><?php echo $fname.' '.$lname; ?></i>?  My name is <i style="font-size: 14px;"><?php echo  $sperson; ?></i>,   I’m calling on behalf of <i style="font-size: 14px;"><?php echo $dealer; ?></i> customer service.  How are you today?  Did I catch you at a good time, I’d like to ask you a few quick questions regarding your recent purchase experience.
										<div class="separator"></div>
									</div>
							
									<div class="col-md-10">
										<label>1. Have you had a chance to ride your new vehicle?<?php echo $this->Form->input('SurveyAnswer.36.answer', array('options' => array('Yes'=>'Yes', 'No'=>'No'), 'type' => 'radio', 'class' => 'form-control','value'=>''));
										...
										?>  Does it exceed your expectations thus far?  </label>
										<div class="separator"></div>
									</div>
									<div class="col-md-10">
										<label>2. Did our sales team take time to go over all the operational details with you before your departure?  <?php echo $this->Form->input('SurveyAnswer.136.answer', array('options' => array('Yes'=>'Yes', 'No'=>'No'), 'type' => 'radio', 'class' => 'form-control','value'=>'')); 
										
										echo $this->Form->hidden('SurveyAnswer.136.question_id',array('value'=>'136'));
										echo $this->Form->hidden('SurveyAnswer.136.bdc_survey_id',array('value'=>''));
										?> </label>
										<div class="separator"></div>
									</div>
									<div class="col-md-10">
										<label>3. Now that you’ve had a couple of weeks to ride, are there any lingering questions that you’d like for me to forward to our performance team? <?php echo $this->Form->input('SurveyAnswer.38.answer', array('options' => array('Yes'=>'Yes', 'No'=>'No'), 'type' => 'radio', 'class' => 'form-control','value'=>'')); ?> (If Yes, take good notes and contact the SP on the deal with those questions and have them follow up! )
                                        <?php
										
										echo $this->Form->input('137.1', array('type' => 'textarea','class' => 'form-control','value'=>''));
										echo $this->Form->hidden('SurveyAnswer.137.question_id',array('value'=>'137'));
										echo $this->Form->hidden('SurveyAnswer.137.bdc_survey_id',array('value'=>''));
										?> 
										<div class="separator"></div>
									</div>
									<div class="col-md-10">
										<label>4. Has <i style="font-size: 14px;"><?php echo $sperson ;?></i> contacted you since taking delivery of your new bike? <?php echo $this->Form->input('SurveyAnswer.39.answer', array('options' => array('Yes'=>'Yes', 'No'=>'No'), 'type' => 'radio', 'class' => 'form-control','value'=>''));
									...
									<div class="col-md-10">
										<?php echo $this->Form->label('SurveyAnswer.42.answer','5.	On a scale of 1 to 10 where 10 is the best, how satisfied were you with the professionalism of your salesperson? '); ?> <?php echo $this->Form->input('SurveyAnswer.42.answer', array('type' => 'select', 'options' => array(
											'1' => '1',
											'2' => '2',
											'3' => '3',
											'4' => '4',
									...
									<div class="col-md-10">
										<?php echo $this->Form->label('SurveyAnswer.43.answer','6.	On this same scale, how would you rate your overall buying experience?'); ?> <?php echo $this->Form->input('SurveyAnswer.43.answer', array('type' => 'select', 'options' => array(
											'1' => '1',
											'2' => '2',
											'3' => '3',
											'4' => '4',
									...
									<div class="col-md-10">
										<label>7.	Would you refer a friend to the dealership?<?php echo $this->Form->input('SurveyAnswer.44.answer', array('options' => array('Yes'=>'Yes', 'No'=>'No'), 'type' => 'radio', 'class' => 'form-control','value'=>'')); 
									...
									<div class="col-md-10">
										<label>8.	Based on this purchase, would you purchase from this dealership again?<?php echo $this->Form->input('SurveyAnswer.45.answer', array('options' => array('Yes'=>'Yes', 'No'=>'No'), 'type' => 'radio', 'class' => 'form-control','value'=>'')); 
									...
									<div class="col-md-10">
										<label>9.	Would you like to receive information on upcoming special events or promotions the dealership may have?<?php echo $this->Form->input('SurveyAnswer.47.answer', array('options' => array('Yes'=>'Yes', 'No'=>'No'), 'type' => 'radio', 'class' => 'form-control','value'=>'')); 
									...
									<div class="col-md-10">
										<label>
                                        Please Like us on Facebook, from time to time we have picture contests but mostly we just love seeing photos of our customers as they ride all over the world.  Stay in touch and we’re always just a phone call or an email away when you need us.  <br/>
                                        I would like to thank you for giving <i style="font-size: 14px;"><?php echo $dealer; ?></i> the opportunity to earn your business.  Congratulations on your purchase and ride safe.</label>
										<div class="separator"></div>
									</div>
                                    <div class="col-md-10">
