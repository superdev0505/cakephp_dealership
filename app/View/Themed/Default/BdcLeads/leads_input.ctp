...
'10' => 'Call Center',
'11' => 'Rental'
), 'empty' => 'Select', 'selected' => $selected_lead_type, 'required' => 'required', 'class' => 'form-control','style'=>'width: 100%'));
?>
...
'Yacht' => 'Yacht'), 'empty' => 'Select', 'selected' => '', 'label'=>false,'div'=>false, 'class' => 'form-control','style'=>'width: 100%'));
?>
										<div class="separator"></div>
									</div>
						...
						<div class="col-md-3">
							...
							<div class="checkbox">
								<label class="checkbox-custom">
									<input type="checkbox" class="chk_lead_status" name="checkbox_status" value="<?php echo $v; ?>" >
									<i class="fa fa-fw fa-square-o"></i> <?php echo $v; ?>
								</label>
							</div>
							<?php } ?>
						</div>
