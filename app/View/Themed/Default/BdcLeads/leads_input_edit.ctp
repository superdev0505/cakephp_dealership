...
?>
								...
								<div class="row">
									...
									<div class="col-md-3"> <?php echo $this->Form->label('class','Class:'); ?> <?php echo $this->Form->input('class', array('type' => 'text', 'label'=>false,'div'=>false, 'class' => 'form-control')); ?>
										<div class="separator"></div>
									</div>
		...
		<div class="col-md-4">
			...
			<div class="widget widget-tabs widget-tabs-responsive">
				<div class="widget-body">
					Type: <?php echo $this->Form->input('d_type', array('type' => 'select', 'options' => $d_type_options, 'empty' => 'Select', 'selected' => '','label'=>false,'div'=>false, 'selected' => $this->request->input['Contact']['state'], 'class' => 'form-control','style'=>'width: 100%'));?>
					<div class="separator"></div>
					<div id="breadcrumb"></div>
					<div class="separator"></div>
					<div style="max-height: 347px;overflow: auto;">
						<div id="category_list" style="width: 95%">
