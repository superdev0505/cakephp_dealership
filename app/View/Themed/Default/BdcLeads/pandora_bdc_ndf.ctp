			...
			<div class="wizard">
				<div class="widget  widget-tabs-responsive">
                    ...
                    <a href="#" class="btn btn-danger BdcInvalidLead pull-right no-ajaxify" data-id="<?php echo $contact_info['BdcLead']['id']; ?>" style="margin-top:5px;" >Invalid Lead</a>
						<strong>Earn Your Business Day 1 BDC: </strong><?php echo  $contact_info['BdcLead']['full_name'];?>-
...
I will try you back at a more convenient time. Thanks, and have a great day!!</label>
 ...
 <hr />
									...
									<div class="col-md-10">
									<label>	Hello, may I speak  <i style="font-size: 14px;"><?php echo  $contact_info['BdcLead']['full_name']; ?></i> ?  Hello <i style="font-size: 14px;"><?php echo  $contact_info['BdcLead']['full_name']; ?></i> , did I catch you at a good time?</label> <?php /*echo $this->Form->input('SurveyAnswer.18.answer', array('type' => 'select', 'options' => array(
											'Yes' => 'Yes',
											'No' => 'No'
									...
									<div class="col-md-10">
										...
										calling on behalf of <i style="font-size: 14px;"><?php echo $dealer; ?></i> how are you today? .My call is in reference to the <i style="font-size: 14px;"><?php echo  $contact_info['BdcLead']['year'].' '.$contact_info['BdcLead']['make'].' '.$contact_info['BdcLead']['model'] ; ?></i> you inquired about last night/earlier today/over the weekend.  That indeed is an awesome choice.  </label>
										<div class="separator"></div>
									</div>
									
									
									<div class="col-md-10">
										<label>1.	I know you’ve done your research and likely have questions . . . . . how can I help? </label>
										<?php echo $this->Form->input('SurveyAnswer.132.answer', array('type' => 'textarea','class' => 'form-control','value'=>'')); 
										
										echo $this->Form->hidden('SurveyAnswer.132.question_id',array('value'=>'132'));
										echo $this->Form->hidden('SurveyAnswer.132.bdc_survey_id',array('value'=>''));
										?>
                                        <label>(Take good notes here because you likely are going to want to prep our SP for their first followup call to answer all these questions.<br/>
                                        If no questions and cusomer expresses that this is the bike for him/her then move into . . . . . . 
                                        )</label>
										<div class="separator"></div>
									</div>
									<div class="col-md-10">
										<label>2.	Will you be trading a bike?
										<?php echo $this->Form->input('SurveyAnswer.133.answer', array('options' => array('Yes'=>'Yes', 'No'=>'No'), 'type' => 'select', 'class' => 'form-control','empty'=>'Select')); ?></label>
										<?php //echo $this->Form->input('133.1', array('type' => 'textarea','class' => 'form-control novalidate','value'=>''));
										echo $this->Form->hidden('SurveyAnswer.133.question_id',array('value'=>'133'));
										echo $this->Form->hidden('SurveyAnswer.133.bdc_survey_id',array('value'=>''));
										?>
										<div class="separator"></div>
									</div>
									<div class="col-md-10">
										<label>3.	Does ours meet your budget requirements?  </label>
										<?php echo $this->Form->input('SurveyAnswer.134.answer', array('options' => array('Yes'=>'Yes', 'No'=>'No'), 'type' => 'radio', 'class' => 'form-control','value'=>'')); 
										echo $this->Form->hidden('SurveyAnswer.134.question_id',array('value'=>'134'));
										echo $this->Form->hidden('SurveyAnswer.134.bdc_survey_id',array('value'=>''));
										
										?>
										<div class="separator"></div>
									</div>
									<div class="col-md-10">
										<label>4.	Could I schedule a test ride visit here at the store so that one of my <?php echo $contact_info['BdcLead']['make']; ?> experts can show you all the performance features and then send you out for an amazing ride?</label>
										<?php echo $this->Form->input('SurveyAnswer.135.answer', array('options' => array('Yes'=>'Yes', 'No'=>'No'), 'type' => 'select', 'class' => 'form-control','empty'=>'Select')); 
										echo $this->Form->hidden('SurveyAnswer.135.question_id',array('value'=>'135'));
										echo $this->Form->hidden('SurveyAnswer.135.bdc_survey_id',array('value'=>''));
										
										?>
                                        <label>(Work your appointment magic and then make immediate contact with the next SP in the Round robin group)</label>
										<div class="separator"></div>
									</div>			
									...
									<div class="col-md-10">
                                        ...
                                        Thank you for your time today and have a great day!</label>
										<div class="separator"></div>
									</div>
                                    <div class="col-md-10">
...
$(function(){
	...
	$("#SurveyAnswer135Answer").on('change',function(){
		$val = $(this).val();
		if($val == 'Yes')
		{
