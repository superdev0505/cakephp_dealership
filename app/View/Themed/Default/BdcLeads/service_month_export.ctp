...
date_default_timezone_set(AuthComponent::user('zone'));
 ?>
<h4>Dealership Performance 360 CRM BDC Survey(Service Leads) - <?php echo date('l, F j, Y');?></h4>
<table>
<thead><tr>
...
<td  <?php echo $style;?>> <a href="#" class="btn btn-info updateExcelLead" data-id="<?php echo $lead['ServiceLeadsDms']['id']; ?>">Update Lead</a><br /><br />&nbsp;<a href="#" class="btn btn-inverse BdcInvalidLead no-ajaxify" data-id="<?php echo $lead['ServiceLeadsDms']['id']; ?>">Invalid Lead</a></td>
...
$(document).ready(function(){
	...
	$(".updateExcelLead").on('click',function(e){
		...
		$.ajax({
			type: "GET",
			cache: false,
			url:  "/bdc_leads/service_lead_details/"+lead_id,
