			...
			<div class="wizard">
				<div class="widget  widget-tabs-responsive">
					...
					<div class="widget-head">
						<span>&nbsp;In-Bound Lead :</span><strong><?php echo  $contact_info['BdcLead']['full_name'];?>-
                         <i class="fa fa-mobile"></i>
						<?php $phone = $contact_info['BdcLead']['mobile'];
$phone_number = preg_replace('/[^0-9]+/', '', $phone); //Strip all non number characters
$cleaned = preg_replace("/([0-9]{3})([0-9]{3})([0-9]{4})/", "($1) $2-$3", $phone_number); //Re Format it
echo $cleaned;?></strong>&nbsp;&nbsp;&nbsp;<strong>Status:<?php echo $contact_info['BdcLead']['status']; ?>
					</div>
					<div class="widget-body"> 
                        ...
                        <?php echo $this->Form->hidden('BdcLead.id',array('value'=>$id)); ?>
								...
								<div class="row">
									...
									echo $this->Form->hidden('BdcSurvey.survey_id',array('value'=>1));
									...
									<div class="col-md-10">
										<?php echo $this->Form->label('SurveyAnswer.1.answer','Hello, I am calling to see if <i style="font-size: 14px;">'.$fname.' '.$lname.'</i> is available?'); ?> <?php /*echo $this->Form->input('SurveyAnswer.1.answer', array('type' => 'select', 'options' => array(
											'Yes' => 'Yes',
											'No' => 'No'
											), 'empty' => 'Select','label'=>false,'div'=>false, 'class' => 'form-control'));
										echo $this->Form->hidden('SurveyAnswer.1.question_id',array('value'=>'1'));
										echo $this->Form->hidden('SurveyAnswer.1.bdc_survey_id',array('value'=>''));*/
										?>
										<div class="separator"></div>
									</div>
									<div class="col-md-10">
									...
									<div class="col-md-10">
										...
										<?php echo $this->Form->input('SurveyAnswer.2.answer', array('type' => 'textarea','class' => 'form-control','value'=>''));
										
										echo $this->Form->hidden('SurveyAnswer.2.question_id',array('value'=>'2'));
										echo $this->Form->hidden('SurveyAnswer.2.bdc_survey_id',array('value'=>''));
										?>
										<div class="separator"></div>
									</div>
									<div class="col-md-10">
										<label>2.	Were you greeted promptly?</label>
										<?php echo $this->Form->input('SurveyAnswer.3.answer', array('options' => array('Yes'=>'Yes', 'No'=>'No'), 'type' => 'radio', 'class' => 'form-control','value'=>'')); ?>
										<?php echo $this->Form->input('3.1', array('type' => 'textarea','class' => 'form-control','value'=>'')); 
										echo $this->Form->hidden('SurveyAnswer.3.question_id',array('value'=>'3'));
										echo $this->Form->hidden('SurveyAnswer.3.bdc_survey_id',array('value'=>''));
										?>
										<div class="separator"></div>
									</div>
									<div class="col-md-10">
										<label>3.	Were you treated courteously?   </label>
										<?php echo $this->Form->input('SurveyAnswer.4.answer', array('options' => array('Yes'=>'Yes', 'No'=>'No'), 'type' => 'radio', 'class' => 'form-control','value'=>'')); 
										echo $this->Form->hidden('SurveyAnswer.4.question_id',array('value'=>'4'));
										echo $this->Form->hidden('SurveyAnswer.4.bdc_survey_id',array('value'=>''));
									...
									<div class="col-md-10">
										...
										<?php echo $this->Form->input('SurveyAnswer.5.answer', array('options' => array('Yes'=>'Yes', 'No'=>'No'), 'type' => 'radio', 'class' => 'form-control','value'=>'')); 
										echo $this->Form->hidden('SurveyAnswer.5.question_id',array('value'=>'5'));
										echo $this->Form->hidden('SurveyAnswer.5.bdc_survey_id',array('value'=>''));
									...
									<div class="col-md-10">
										...
										<?php echo $this->Form->input('SurveyAnswer.6.answer', array('type' => 'textarea','class' => 'form-control','value'=>'')); 
										echo $this->Form->hidden('SurveyAnswer.6.question_id',array('value'=>'6'));
										echo $this->Form->hidden('SurveyAnswer.6.bdc_survey_id',array('value'=>''));
										
										?>
										<div class="separator"></div>
									</div>
									<div class="col-md-10">
										<label>6.	If you were to purchase would you be interested in adding any particular accessories?  If yes, what would that be?</label>
										<?php echo $this->Form->input('SurveyAnswer.7.answer', array('options' => array('Yes'=>'Yes', 'No'=>'No'), 'type' => 'radio', 'class' => 'form-control','value'=>'')); ?>
										<?php echo $this->Form->input('7.1', array('type' => 'textarea','class' => 'form-control','value'=>'')); 
										echo $this->Form->hidden('SurveyAnswer.7.question_id',array('value'=>'7'));
										echo $this->Form->hidden('SurveyAnswer.7.bdc_survey_id',array('value'=>''));
										?>
										<div class="separator"></div>
									</div>
									<div class="col-md-10">
										<label>7.	Would you have the accessories added on by the dealership?</label>
										<?php echo $this->Form->input('SurveyAnswer.8.answer', array('options' => array('Yes'=>'Yes', 'No'=>'No'), 'type' => 'radio', 'class' => 'form-control','value'=>''));
										echo $this->Form->hidden('SurveyAnswer.8.question_id',array('value'=>'8'));
										echo $this->Form->hidden('SurveyAnswer.8.bdc_survey_id',array('value'=>''));
									...
									<div class="col-md-10">
										...
										<?php echo $this->Form->input('SurveyAnswer.9.answer', array('options' => array('Yes'=>'Yes', 'Nothing'=>'Nothing'), 'type' => 'radio','class' => 'form-control','value'=>'')); 
										echo $this->Form->hidden('SurveyAnswer.9.question_id',array('value'=>'9'));
										echo $this->Form->hidden('SurveyAnswer.9.bdc_survey_id',array('value'=>''));
										
										?><br />(If the customer answers with “nothing” or appears not to have an answer to the question. 
Ask him/her if they are in the market and if yes, what time frame.)</label>
<?php echo $this->Form->input('9.1', array('type' => 'textarea','class' => 'form-control','value'=>'')); ?>
									...
									<div class="col-md-10">
                                        ...
                                        <?php echo $this->Form->input('SurveyAnswer.17.answer', array('type' => 'select', 'options' => array(
'now' => 'now',
'5days' => '5days',
'10days' => '10days',
'15days' => '15days',
...
'2year' => '2year'
										...
										echo $this->Form->hidden('SurveyAnswer.17.question_id',array('value'=>'17'));
										echo $this->Form->hidden('SurveyAnswer.17.bdc_survey_id',array('value'=>''));					
?>
									</div>
									<div class="col-md-10">
										<label>10.	Would you refer a friend?</label>
										<?php echo $this->Form->input('SurveyAnswer.11.answer', array('options' => array('Yes'=>'Yes', 'No'=>'No'), 'type' => 'radio', 'class' => 'form-control','value'=>''));
										echo $this->Form->hidden('SurveyAnswer.11.question_id',array('value'=>'11'));
										echo $this->Form->hidden('SurveyAnswer.11.bdc_survey_id',array('value'=>''));
									...
									<div class="col-md-10">
										<?php echo $this->Form->label('SurveyAnswer.12.answer','11.	On a scale of one to ten, ten being the best how would you rate your overall experience?'); ?> <?php echo $this->Form->input('SurveyAnswer.12.answer', array('type' => 'select', 'options' => array(
											'1' => '1',
											'2' => '2',
											'3' => '3',
											'4' => '4',
										...
										echo $this->Form->hidden('SurveyAnswer.12.question_id',array('value'=>'12'));
										echo $this->Form->hidden('SurveyAnswer.12.bdc_survey_id',array('value'=>''));
										?>
										<div class="separator"></div>
									</div>
									<div class="col-md-10">
										<label>12.	Did anyone mention financing to you?</label>
										<?php echo $this->Form->input('SurveyAnswer.13.answer', array('options' => array('Yes'=>'Yes', 'No'=>'No'), 'type' => 'radio', 'class' => 'form-control','value'=>''));
										echo $this->Form->hidden('SurveyAnswer.13.question_id',array('value'=>'13'));
										echo $this->Form->hidden('SurveyAnswer.13.bdc_survey_id',array('value'=>''));
									...
									<div class="col-md-10">
										...
										<?php echo $this->Form->input('SurveyAnswer.14.answer', array('options' => array('Yes'=>'Yes', 'No'=>'No'), 'type' => 'radio', 'class' => 'form-control','value'=>''));
										
										echo $this->Form->hidden('SurveyAnswer.14.question_id',array('value'=>'14'));
										echo $this->Form->hidden('SurveyAnswer.14.bdc_survey_id',array('value'=>''));
										?>
										<div class="separator"></div>
									</div>
									<div class="col-md-10">
										...
										<?php echo $this->Form->input('SurveyAnswer.15.answer', array('options' => array('Yes'=>'Yes', 'No'=>'No'), 'type' => 'radio', 'class' => 'form-control','value'=>''));
										echo $this->Form->hidden('SurveyAnswer.15.question_id',array('value'=>'15'));
										echo $this->Form->hidden('SurveyAnswer.15.bdc_survey_id',array('value'=>''));
										
										?><br />If yes, may I have your email address in order for you to be notified?</label>
                                        <?php echo $this->Form->input('15.1', array('type' => 'email','class' => 'form-control','value'=>$email)); ?>
										<div class="separator"></div>
									...
									<div class="col-md-10">
										...
										<?php echo $this->Form->input('SurveyAnswer.16.answer', array( 'type' => 'textarea', 'class' => 'form-control','value'=>''));
										echo $this->Form->hidden('SurveyAnswer.16.question_id',array('value'=>'16'));
										echo $this->Form->hidden('SurveyAnswer.16.bdc_survey_id',array('value'=>''));
...
$(function(){
	...
	$("a#skip_lead").on('click',function(event)
	{
		...
		if(next_id)
		{
			$.ajax({
					type: "GET",
					cache: false,
					url: "/bdc_leads/bdc_input_in_bound/"+next_id,
	...
	{
		validate=true;
		$("#SurveyAnswer .form-control").each(function(){
										 if($.trim($(this).val())=='')
										 {
											 $(this).focus();
