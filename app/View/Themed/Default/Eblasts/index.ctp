			...
			<div class="row">
				...
				<div class="col-sm-3 ">
					<div class="widget">
						...
						<div class="text-center innerAll">
							<a href="<?php echo $this->Html->url(array('controller'=>'eblasts','action'=>'templates_list')); ?>" class="strong  no-ajaxify"><u>Templates</u></a>
						</br></br>
				...
				<div class="col-sm-3">
					<div class="widget">
						<a href="<?php echo $this->Html->url(array('controller'=>'unsubscribes','action'=>'index')); ?>" class="display-block bg-warning innerAll text-center text-white"><i class="icon-envelope-3 fa-5x"></i></a>
						<div class="text-center innerAll">
							<a href="<?php echo $this->Html->url(array('controller'=>'unsubscribes','action'=>'index')); ?>" class="strong  "><u>Unsubscribe</u></a>
							</br></br>
							<div align="left"></div>
							<div class="clearfix"></div>
						</div>
