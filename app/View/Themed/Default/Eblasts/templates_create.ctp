<style type="text/css">
	...
	.cke_button__superbutton_label, .cke_button__emailpreview_label{display:  none;}
							...
							<div class="panel-body">
								...
								<div class="row">
									...
									<?php
	                                    ...
	                                    $options = array ( 'A' => 'Autoresponder','T' =>'Mail Template');
								...
								<div class="row">
									...
									<?php
										...
										echo $this->Form->textarea('template_html', array('class' => 'form-control '));
	                                ?>
									</div>
								</div>
								<div class="clearfix hspace12">&nbsp;</div>
									...
									<div class="tab-content">
										...
										<div class="tab-pane animated fadeInUp active" id="tab-1-userinput">
											...
											<!--	Modified Full Date: <a href="javascript:" field-name="{modified_full_date}" class="template-field"><span class="label label-success label-stroke">{modified_full_date}</span></a><br />
												...
												Vehicle URL: <a href="javascript:" field-name="{vehicle_url}" class="template-field"><span class="label label-success label-stroke">{vehicle_url}</span></a><br />
...
$script.ready('bundle', function() {
	...
	<?php  } ?>
		...
		$('#TemplateTemplateFromSperson').on('change', function() {
			var $this = $(this);
			if ($this.is(':checked')) {
				$("#TemplateTemplateEmailFromId").val('<?php echo AuthComponent::user("email"); ?>');
			} else {
				$("#TemplateTemplateEmailFromId").val('<?php echo AuthComponent::user("d_email"); ?>');
			}
		});
