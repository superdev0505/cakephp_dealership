            ...
            <div class="widget">
                ...
                <div class="text-center innerAll">
                    <u>
                        ...
                        <?php
                        if($selected_template_id==$template['TemplateApp']['template_id']){
                        ...
                        ?>
                        <input <?php echo $selected;?> type="radio" value="<?php echo $template['TemplateApp']['template_id'].'_'.$template['TemplateApp']['template_type']; ?>" name="template_id" class="form-control templates" /> <?php echo $template['TemplateApp']['template_title']; ?>
                    </u>
