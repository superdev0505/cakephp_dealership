...
@media print {
    #Credit_From #fixedfee_selection,.price_options,.noprint {
        display: none;
    }
	#Credit_From
	{
	...
	#Credit_From .print_month
	{
		display:block;
	}

#Credit_From input[type="checkbox"]{
height : 9px!important;
}
#Credit_From input[type="text"]{
...
#Credit_From table.main_width
{
	width:997px!important;
}
#Credit_From table.mid_width
{
	width:890px!important;
}
#Credit_From table.set_padding td
{
	padding: 1px 2px 0px 8px;!important;

}
#Credit_From table.no_padding td
{
	padding: 0px!important;
}
#Credit_From td
...
#Credit_From input[type="text"].bottom_border
{
border-bottom: 1px solid #000!important;

}
#Credit_From span.zero_padding,#Credit_From div.zero_padding
{
	padding:0px!important;
}
...
<div class="wraper header" id="Credit_From">
...
$cleaned3 = preg_replace("/([0-9]{3})([0-9]{3})([0-9]{4})/", "$1-$2-$3", $phone);
 ?>
        ...
        <input type="text" name="top_down_payment" style="width:153px" value="<?php echo isset($info['top_down_payment'])?$info['top_down_payment']:''; ?>" />
         ...
         <tr>
         <td>SELLER<br  />
         <input type="text" style="width:285px;" name="sperson" value="<?php echo $sales_person_name; ?>" /></td>
...
<table><tr><td>
 ...
 <tr><td>LAST NAME <br/><input type="text" class="text_captialize" style="width:130px;" name="last_name" value="<?php echo $info['last_name']; ?>" /></td>
 <td>FIRST NAME<br/><input type="text" class="text_captialize" style="width:130px;" name="first_name" value="<?php echo $info['first_name']; ?>" /></td>
...
<td colspan="2">
Cell Phone<br/>
<input type="text" style="width:120px;" name="mobile" value="<?php echo $cleaned1; ?>" />
</td>
</tr>
<tr>
<table bordercolor="#CCCCCC" border="1" class="main_width set_padding">
...
<td>Relationship<br/><input type="text" style="width:120px;" name="ref1_type" value="<?php echo $info['ref1_type']; ?>"  /></td>
 ...
 <td align="right">$<input type="text" class="bottom_border" style="width:120px;" name="income_monthly"  value="<?php echo $info['income_monthly']; ?>" /></td>
 </tr>
 <tr>
 ...
 <td></td>
 <td align="right">$<input type="text" class="bottom_border" style="width:120px;" name="mortgage_month_amount" value="<?php echo $info['mortgage_month_amount']; ?>" /></td>
 </tr>
 <tr>
 ...
 <td align="right" style="width:15%" >$<input type="text" class="bottom_border" style="width:120px;" name="other_income" value="<?php echo $info['other_income']; ?>" /></td>
 </tr>
 <tr>
 <td></td><td><strong>TOTAL MONTHLY INCOME</strong></td>
 <td align="right" style="width:15%" >$<input type="text" class="bottom_border" style="width:120px;" name="other_monthly" value="<?php echo $info['other_monthly']; ?>" /></td>
 </tr>
...
<td>Relationship<br/><input type="text" style="width:120px;" name="co_ref_type" value="<?php echo $info['co_ref_type']; ?>" /></td>
 ...
 <tr>
 <td>Applicant's Gross Monthly Income from Employment</td><td></td>
 <td align="right" style="width:15%;">$<input type="text" class="bottom_border" style="width:120px;" name="cobuyer_income_monthly" value="<?php echo $info['cobuyer_income_monthly']; ?>" /></td>
 </tr>
 ...
 <td align="right" style="width:15%;">$<input type="text" class="bottom_border" style="width:120px;" name="cobuyer_monthly_mortgage" value="<?php echo $info['cobuyer_monthly_mortgage']; ?>" /></td>
 </tr>
 ...
 <td align="right" style="width:15%;">$<input type="text" class="bottom_border" style="width:120px;" name="cobuyer_monthly_mortgage2" value="<?php echo $info['cobuyer_monthly_mortgage2']; ?>" /></td>
 </tr>

 <tr>
 <td>Amount of other Monthly Income and Source(s)</td><td></td>
 <td align="right" style="width:15%;">$<input type="text" class="bottom_border" style="width:120px;" name="cobuyer_other_income_monthly" value="<?php echo $info['cobuyer_other_income_monthly']; ?>" /></td>
 </tr>
 <tr>
 <td></td>
 <td><strong>TOTAL MONTHLY INCOME</strong></td>
 <td align="right">$<input type="text" style="width:120px;" class="bottom_border" name="cobuyer_total_income_monthly" value="<?php echo $info['cobuyer_total_income_monthly']; ?>" /></td>
 </tr>
...
<br />
       ...
       Rosemont, IL 60018</span>
          ...
          <div class="full" style="padding:0px;padding-left:10px;">
          <span class="six" style="width:19%"><strong>A-Z Financial Corporation</strong><br />
      P.O. Box 7965 <br />
        Suite 200
Long beach, CA 90807
         </span>
...
<br />
		San Diego, CA 92150</span>
         <span class="six" style="width:19%"><strong>Marine One Acceptance minha pica Corp.
</strong><br />
	5000 Quorum Dr Suite 200
<br />
		Dallas, TX 75254</span>

<?php if(AuthComponent::user('dealer_id') == 1224){ ?>
