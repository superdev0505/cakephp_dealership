			...
			<div class="row">
				<table width="70%" border="0" cellspacing="0" cellpadding="0" style="float:left;">
				  ...
				  <tr>
				   ...
				   <tr>
					<td style="font-size:14px; color:#000; font-weight:normal; padding-top:20px;">Unit Buying: <input name="unit_buying"  value="<?php echo isset($info['unit_buying']) ? $info['unit_buying'] : $info['condition'].",".$info['year'].','.$info['make'].','.$info['model'];  ?>"   type="text" class="fmrs_inp2" /></td>
				  </tr>
				  ...
				  <tr>
					<td style="font-size:14px; color:#000; font-weight:normal; padding-top:20px;">Color:    <input name="color1"  value="<?php echo isset($info['color1']) ? $info['color1'] : $info['usedunit_color']; ?>"   type="text" class="fmrs_inp3" /> Options: <input name="options"  value="<?php echo isset($info['options']) ? $info['options'] : "" ?>"   type="text" class="fmrs_inp" /> </td>
				  </tr>
				  
				  <tr>
					<td style="font-size:14px; color:#000; font-weight:normal; padding-top:20px;">License Plate:   <input name="license_plate"  value="<?php echo isset($info['license_plate']) ? $info['license_plate'] : "" ?>"   type="text" class="fmrs_inp3" /> Expires: <input name="expires"  value="<?php echo isset($info['expires']) ? $info['expires'] : "" ?>"   type="text" class="fmrs_inp4" /> State: <input name="state1"  value=""  type="text" class="fmrs_inp4" /></td>
				  </tr>
