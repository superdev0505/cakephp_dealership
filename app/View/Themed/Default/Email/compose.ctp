		...
		<div class="col-md-12">
			...
			<div class="col-separator col-separator-first box">
				...
				<div class="innerAll text-center">
					<a href="email.html?lang=en" class="btn btn-default"><i class="fa fa-fw icon-crossing"></i> Cancel</a>
					<a href="email.html?lang=en" class="btn btn-primary"><i class="fa fa-fw icon-outbox-fill"></i> Send email</a>
				</div>
			</div>
		</div>
