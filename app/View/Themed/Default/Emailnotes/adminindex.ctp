...
<li><a href="#" class="add_dev"><i class="fa fa-twitter" style="font-size:20px;"></i>&nbsp;<b>Add New Email</b></a><span class="divider"></span></li>
...
<!--<td>
  <?php 
  //echo $developer['Emailnote']['id'];
  ?>  
</td>-->
<td><?php 
  echo $developer['Emailnote']['name'];
  ?>   </td>
<td><?php 
  echo $developer['Emailnote']['email'];
  ?>  </td>
<td><?php 
if($developer['Emailnote']['status']==1)
  echo 'Active';
else
    echo 'Inactive';
  ?>  </td>
<td><?php echo $this->Html->link('Edit', '#', array('class'=>'edit_dev','id'=>$developer['Emailnote']['id'])); ?>&nbsp;</a>
<td><?php echo $this->Html->link('Active/Inactive', 'admindelete/' . $developer['Emailnote']['id'], array('class'=>'no-ajaxify'), 'Are you sure you?', false); ?>&nbsp;</a>
</td>
