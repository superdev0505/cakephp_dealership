	...
	<div class="widget">
		...
		<div class="wizard">
			<div class="widget-head bg-primary">
				<div class="pull-left"> <span class="heading strong-text-white "><i class="fa fa-group " style="font-size:20px;"></i>&nbsp;Add New Email</span> </div>
...
$script.ready('bundle', function() {
	...
	$("#EmailnoteAddForm").submit(function(){
