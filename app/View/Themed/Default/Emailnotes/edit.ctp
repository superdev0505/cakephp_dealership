	...
	<div class="widget">
		...
		<div class="wizard">
			<div class="widget-head bg-primary">
				<div class="pull-left"> <span class="heading strong-text-white "><i class="fa fa-group " style="font-size:20px;"></i>&nbsp;Update Email</span> </div>
...
<!--                                        - <i><span class="label label-white label">No Outages Reported</span></i>-->
			...
			<div class="widget-body">
				<div style="width: 100%;">
					...
					<?php echo $this->Form->create('Emailnote',array('class'=>'form-horizontal apply-nolazy','role'=>"form" )); ?>
...
$script.ready('bundle', function() {
	...
	$("#EmailnoteEditForm").submit(function(){
