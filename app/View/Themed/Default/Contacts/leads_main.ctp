				...
				<div class="widget-body">
					...
					<div class="row">
						...
						<div class="col-md-6 col-xs-5">
							...
							<button type="button" id="btn-other_lead-search" class="btn btn-warning no-ajaxify my_button" style='display: none;'>
			...
			<div class="modal-body">
				...
				<div class="collapse" id="collapse_bottom_search">
					...
					<div class="row">
						...
						<div class="col-md-3">
							<?php echo $this->Form->input('nsearch_make', array('type' => 'select', 'options' => $mk_optionsn,  'empty' => 'Make', 'label' => false, 'div' => false, 'class' => 'form-control','style'=>'width: 80%'));  ?>
