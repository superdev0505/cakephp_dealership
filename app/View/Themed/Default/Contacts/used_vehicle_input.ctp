            ...
            <div class="wizard">
                <div class="widget widget-tabs widget-tabs-responsive">
                    ...
                    <div class="widget-head">
                        <ul>
                            <li class="active" ><a href="#tab2-1" class="glyphicons road" data-toggle="tab"><i></i>Vehicle Info - Used</a></li>
                        </ul>
                    </div>
                    <!-- // Widget heading END -->
                    <div class="widget-body"> 
                        <?php echo $this->Form->create('Inventory', array('type'=>'post','class' => 'form-inline apply-nolazy', 'role' => "form")); 
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <a href="<?php echo $this->Html->url(array('action' => 'used_vehicle_input')); ?>" class="btn btn-danger" ><i class="fa fa-reply"></i> Cancel</a>
                                <button type="submit" class="btn btn-success"><i class="fa fa-save"></i> Save Vehicle</button>
                            </div>
        ...
        <div class="col-md-4">
            ...
            <div class="widget widget-heading-simple widget-body-white widget-employees">
                <div class="widget-body">
					...
					<div class="clearfix">
						<?php echo $this->Form->create('Inventory2', array('url'=>array('controller'=>'contacts','action'=>'used_vehicle_input'),'class' => 'form-inline apply-nolazy', 'role' => "form")); ?> 
					...
					<?php foreach($used_vehicles as $used_vehicle){ ?>
						<li class="border-bottom">
							<a href="/contacts/used_vehicle_input/<?php echo $used_vehicle['Inventory']['id']; ?>/">
...
<script>
	...
	$("#btn_search_used_vehicle").click(function(event){
		location.href = "/contacts/used_vehicle_input/Year:"+$("#Inventory2Year").val()+"/Make:"+$("#Inventory2Make").val()+"/Type:"+$("#Inventory2Type").val()+"/";
		return false;
	});	
