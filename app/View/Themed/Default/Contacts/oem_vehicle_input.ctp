                ...
                <div class="widget-body">
					...
					<?php foreach($oem_vehicles as $oem_vehicle){ ?>
						<li class="border-bottom">
							...
							&nbsp; &nbsp;
							<a class="btn btn-danger btn-xs no-ajaxify" onclick="return confirm('Do you want to delete the vehicle?')"  href="/contacts/oem_vehicle_delete/<?php echo $oem_vehicle['InventoryOem']['id']; ?>/"><i class="fa fa-trash-o"></i></a>
						</li>
					<?php } ?>
					</ul>
					<br />
