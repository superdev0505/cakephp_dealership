	...
	<div class="widget">
		...
		<div class="wizard">
			<div class="widget-head bg-primary">
				<div class="pull-left"> <span class="heading strong-text-white "><i class="fa fa-group " style="font-size:20px;"></i>&nbsp;Add New Developer</span> </div>
...
$script.ready('bundle', function() {
	...
	$("#DeveloperAddForm").submit(function(){
