...
&nbsp;&nbsp;&nbsp;Mobile#&nbsp; <?php echo $this->Form->input('mobile', array('class' => 'input-medium', 'readonly' => 'readonly')); ?></br></br>
           ...
           <!-- &nbsp;&nbsp;&nbsp; <?phpecho $this->Form->input('all_day', array('label' => 'Set Reminder?')); ?></br></br><?php echo $this->Form->input('Contact', array('type' => 'hidden')); ?>
                <?php echo $this->Form->input('User', array('type' => 'hidden')); ?> -->
