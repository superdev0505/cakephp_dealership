...
<div class="span3 view-eventtype-box">
	...
	<!--	<a class="btn btn-success btn-mini" href="<?php echo $this->Html->url(array('plugin' => 'full_calendar', 'action' => 'edit', $eventType['EventType']['id'])); ?>"><i class="icon-edit"></i> Edit</a> -->
		<a class="btn btn-success" href="<?php echo $this->Html->url(array('plugin' => 'full_calendar', 'controller' => 'full_calendar')); ?>"><i class="icon-calendar"></i> Back to Calendar View</a></br></br>

<a class="btn btn-success" href="<?php echo $this->Html->url(array('plugin' => 'full_calendar', 'controller' => 'events', 'action' => 'index')); ?>"><i class="icon-calendar"></i> Back to Events View</a>
